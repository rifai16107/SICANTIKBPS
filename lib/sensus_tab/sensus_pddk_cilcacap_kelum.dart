...
void main() => runApp(const PddkCilacapKelum());

class PddkCilacapKelum extends StatelessWidget {
  const PddkCilacapKelum({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Center(
            child: Column(
              children: const [
                Text(
                  'Penduduk Menurut Kelompok Umur dan Jenis Kelamin di Kabupaten Cilacap Hasil Sensus Penduduk 2020',
                  style: TextStyle(
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse(
    'https://bps-3301-asap.my.id/api/sensus-pddk-cilacap-kelum',
  );
...
class FixedColumnWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DataTable(
      columnSpacing: 5,
      dataRowMinHeight: screenHeight * 0.035,
      dataRowMaxHeight: screenHeight * 0.035,
