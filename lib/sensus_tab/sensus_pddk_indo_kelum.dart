...
void main() => runApp(const PddkIndoKelum());

class PddkIndoKelum extends StatelessWidget {
  const PddkIndoKelum({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Center(
            child: Column(
              children: const [
                Text(
                  'Penduduk Menurut Kelompok Umur dan Jenis Kelamin di Indonesia Hasil Sensus Penduduk 2020',
                  style: TextStyle(
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/sensus-pddk-indo-kelum');
