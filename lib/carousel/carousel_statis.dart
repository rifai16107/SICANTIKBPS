...
class carouselStatis extends StatefulWidget {
  const carouselStatis({super.key});

  @override
  State<carouselStatis> createState() => _carouselStatisState();
}

RepositoryIndikatorUtama repositoryindikatorutama = RepositoryIndikatorUtama();

class _carouselStatisState extends State<carouselStatis> {
  @override
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  //margin: const EdgeInsets.only(left: 2, top:5),
                                  child: Text(
                                    's.d. Trw $triwulanIpak $tahunIpak',
                                    style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.bold,
                                    ),
