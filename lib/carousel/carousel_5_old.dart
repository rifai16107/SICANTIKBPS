...
class carouselSlider5old extends StatefulWidget {
  const carouselSlider5old({super.key});

  @override
  State<carouselSlider5old> createState() => _carouselSlider5oldState();
}

RepositoryIndikatorUtama repositoryindikatorutama = RepositoryIndikatorUtama();

class _carouselSlider5oldState extends State<carouselSlider5old> {
  @override
