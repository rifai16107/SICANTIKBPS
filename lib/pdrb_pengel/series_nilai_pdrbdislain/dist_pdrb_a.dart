...
class DistPdrbAdhbA extends StatefulWidget {
  const DistPdrbAdhbA({Key? key}) : super(key: key);

  @override
  State<DistPdrbAdhbA> createState() => _DistPdrbAdhbAState();
}

RepositoryPdrbPengelDislain repositorypdrb = RepositoryPdrbPengelDislain();

class _DistPdrbAdhbAState extends State<DistPdrbAdhbA> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                //distribusi pdrb komp pengeluaran adhb 2019 (n-4)
                double kons_ruta_n4 =
                    double.parse(isipdrb[index = 4].kons_ruta);
                double kons_lnprt_n4 =
                    double.parse(isipdrb[index = 4].kons_lnprt);
                double kons_pem_n4 = double.parse(isipdrb[index = 4].kons_pem);
                double pmtb_n4 = double.parse(isipdrb[index = 4].pmtb);
                double inventori_n4 =
                    double.parse(isipdrb[index = 4].inventori);
                double ekspor_n4 = double.parse(isipdrb[index = 4].ekspor);
                double total_n4 = double.parse(isipdrb[index = 4].total);
                String tahun_n4 = isipdrb[index = 4].tahun;
