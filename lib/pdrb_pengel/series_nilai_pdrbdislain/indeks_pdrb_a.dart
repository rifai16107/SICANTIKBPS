...
class IndeksImplisitA extends StatefulWidget {
  const IndeksImplisitA({Key? key}) : super(key: key);

  @override
  State<IndeksImplisitA> createState() => _IndeksImplisitAState();
}

RepositoryPdrbPengelDislain repositorypdrb = RepositoryPdrbPengelDislain();

class _IndeksImplisitAState extends State<IndeksImplisitA> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                //indeks implisit pdrb komp pengeluaran 2019 (n-4)
                double kons_ruta_n4 =
                    double.parse(isipdrb[index = 14].kons_ruta);
                double kons_lnprt_n4 =
                    double.parse(isipdrb[index = 14].kons_lnprt);
                double kons_pem_n4 = double.parse(isipdrb[index = 14].kons_pem);
                double pmtb_n4 = double.parse(isipdrb[index = 14].pmtb);
                String inventori_n4 = isipdrb[index = 14].inventori;
                String ekspor_n4 = isipdrb[index = 14].ekspor;
