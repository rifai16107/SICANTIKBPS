import 'package:bps_cilacap/pdrb_pengel/series_nilai_pdrbdislain/laju_pdrb_adhk_a.dart';
import 'package:bps_cilacap/pdrb_pengel/series_nilai_pdrbdislain/laju_pdrb_adhk_b.dart';
import 'package:bps_cilacap/pdrb_pengel/series_nilai_pdrbdislain/laju_pdrb_adhk_c.dart';
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //tahun n-1 dan n
              String tahunN1N =
                  isipdrb[index = 6].tahun + "-" + isipdrb[index = 0].tahun;
