...
import 'package:bps_cilacap/pdrb_pengel/series_nilai_pdrb.dart';
import 'package:bps_cilacap/pdrb_pengel/series_nilai_pdrb_adhk.dart';
import 'package:bps_cilacap/pdrb_pengel/series_dist_pdrb.dart';
import 'package:bps_cilacap/pdrb_pengel/series_laju_pdrb.dart';
import 'package:bps_cilacap/pdrb_pengel/series_indeks_pdrb.dart';
                    ...
                    builder: (context) {
                      return ListView(children: [
                        ...
                        Container(
                          padding: const EdgeInsets.all(4),
                          alignment: Alignment.centerLeft,
                          child: const Text("(5) perubahan inventori, dan ",
                              textAlign: TextAlign.left),
                        ),
                        Container(
                          padding: const EdgeInsets.all(4),
