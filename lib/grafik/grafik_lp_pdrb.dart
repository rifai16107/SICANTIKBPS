...
class GrafikLPPdrb extends StatefulWidget {
  const GrafikLPPdrb({Key? key}) : super(key: key);

  @override
  _GrafikLPPdrbState createState() => _GrafikLPPdrbState();
}

class _GrafikLPPdrbState extends State<GrafikLPPdrb> {
            ...
            itemBuilder: (context, index) {
              ...
              return SizedBox(
                  ...
                  child: SfCartesianChart(
                      title: ChartTitle(
                          text:
                              'Pertumbuhan PDRB Kabupaten Cilacap ADHK , (Persen)',
