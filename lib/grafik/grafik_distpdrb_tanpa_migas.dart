        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              double pertanian = double.parse(isipdrb[index = 5].a);
              double industri = double.parse(isipdrb[index = 5].c);
              double perdagangan = double.parse(isipdrb[index = 5].g);
              double konstruksi = double.parse(isipdrb[index = 5].f);
              double lainnya =
                  100.00 - (pertanian + industri + perdagangan + konstruksi);
              lainnya = double.parse(lainnya.toStringAsFixed(2));

              String th1 = (isipdrb[index = 5].created_at[0] +
              ...
              data = [
                ...
                _ChartData(
                    "Lainnya", lainnya, const Color.fromARGB(255, 105, 58, 5)),
              ];
              ...
              return SizedBox(
                  ...
                  child: SfCircularChart(
                      title: ChartTitle(
                          text:
                              'Distribusi PDRB ADHB Kabupaten Cilacap Menurut Lapangan Usaha Tahun $th1, -Tanpa Migas (Persen)',
