...
class grafikPdrbAdhb extends StatefulWidget {
  const grafikPdrbAdhb({Key? key}) : super(key: key);

  @override
  _grafikPdrbAdhbState createState() => _grafikPdrbAdhbState();
}

class _grafikPdrbAdhbState extends State<grafikPdrbAdhb> {
            ...
            itemBuilder: (context, index) {
              ...
              return SizedBox(
                ...
                child: SfCartesianChart(
                  title: ChartTitle(
                    text:
                        'PDRB Kabupaten Cilacap ADHB Menurut Lapangan Usaha, (Trilyun Rupiah)',
