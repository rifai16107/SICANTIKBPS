...
import 'package:bps_cilacap/pdrb_adhb_kabkot/pdrbadhb_kabkot_a.dart';
import 'package:bps_cilacap/pdrb_adhb_kabkot/pdrbadhb_kabkot_bc.dart';
import 'package:bps_cilacap/pdrb_adhb_kabkot/pdrbadhb_kabkot_de.dart';
...
class BodySeriesPdrbadhbKabkot extends StatefulWidget {
  ...
  @override
  State<BodySeriesPdrbadhbKabkot> createState() => _BodySeriesPdrbadhbKabkotState();
}
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //tahun 2019-2023
              String thn1 =
                  isipdrbkabkot[index = 0].tahun.substring(0, 4);
              String thn23 =
