...
void main() => runApp(const UtpJk());

class UtpJk extends StatelessWidget {
  const UtpJk({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Center(
            child: Column(
              children: const [
                Text(
                  'Jumlah UTP Menurut Jenis Kelamin Pengelola UTP di Kabupaten Cilacap',
                  style: TextStyle(
                  ...
                  rows: List<DataRow>.generate(snapshot.data!.length, (index) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        DataCell(
                          Text(
                            (Format.convertTo(double.tryParse(data.utplk), 0)),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(double.tryParse(data.utppr), 0)),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
