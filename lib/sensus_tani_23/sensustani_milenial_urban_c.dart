...
class MilenialUrbanC extends StatefulWidget {
  const MilenialUrbanC({Key? key}) : super(key: key);

  @override
  State<MilenialUrbanC> createState() => _MilenialUrbanCState();
}
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                int jumlahUpb = int.parse(isisensustani[index = 2].jumlah_upb);
                int jumlahUtl = int.parse(isisensustani[index = 2].jumlah_utl);
