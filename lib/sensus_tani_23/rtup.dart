                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.pangan_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.horti_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.kebun_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.ternak_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.ikan_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.hutan_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.jasa_rtup),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
