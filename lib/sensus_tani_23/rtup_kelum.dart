...
void main() => runApp(const RtupKelum());

class RtupKelum extends StatelessWidget {
  const RtupKelum({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Center(
            child: Column(
              children: const [
                Text(
                  'Jumlah RTUP Menurut Kelompok Umur Kepala Rumah Tangga di Kabupaten Cilacap',
                  style: TextStyle(
                  ...
                  rows: List<DataRow>.generate(snapshot.data!.length, (index) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(double.tryParse(data.krt65), 0)),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(double.tryParse(data.rtup), 0)),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
