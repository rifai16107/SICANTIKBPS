...
class MilenialUrbanA extends StatefulWidget {
  const MilenialUrbanA({Key? key}) : super(key: key);

  @override
  State<MilenialUrbanA> createState() => _MilenialUrbanAState();
}

RepositorySensusTaniMilenial repositorysensustanimilenial =
    RepositorySensusTaniMilenial();

class _MilenialUrbanAState extends State<MilenialUrbanA> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                int petani = int.parse(isisensustani[index = 0].petani);
                int petaniPglahan =
                    int.parse(isisensustani[index = 0].petani_pg_lahan);
                int petaniGurem =
                    int.parse(isisensustani[index = 0].petani_gurem);
                int petaniMilenial1939 =
                    int.parse(isisensustani[index = 0].petani_milenial_1939);
                int urbanRtup = int.parse(isisensustani[index = 0].urban_rtup);
                int urbanUtp = int.parse(isisensustani[index = 0].urban_utp);
                int jumlahUtp = int.parse(isisensustani[index = 0].jumlah_utp);
                int jumlahUpb = int.parse(isisensustani[index = 0].jumlah_upb);
                int jumlahUtl = int.parse(isisensustani[index = 0].jumlah_utl);
                  ...
                  child: Column(
                    children: <Widget>[
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            'Usaha Pertanian Perorangan (UTP), Perusahaan Pertanian Berbadan Hukum (UPB), Usaha Pertanian Lainnya (UTL), Petani Milenial, Urban Farming dan Petani Pengguna Lahan Hasil Sensus Pertanian $thn di Kabupaten Cilacap: ',
