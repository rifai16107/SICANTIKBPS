...
class SensusTaniC extends StatefulWidget {
  const SensusTaniC({Key? key}) : super(key: key);

  @override
  State<SensusTaniC> createState() => _SensusTaniCState();
}

RepositorySensusTani repositorysensustani = RepositorySensusTani();

class _SensusTaniCState extends State<SensusTaniC> {
   @override
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int rtup = int.parse(isisensustani[index = 2].rtup);
              int panganRtup = int.parse(isisensustani[index = 2].padi_rtup);
              int hortiRtup = int.parse(isisensustani[index = 2].horti_rtup);
              int kebunRtup = int.parse(isisensustani[index = 2].kebun_rtup);
              int ternakRtup = int.parse(isisensustani[index = 2].ternak_rtup);
              int ikanRtup = int.parse(isisensustani[index = 2].ikan_rtup);
              int hutanRtup = int.parse(isisensustani[index = 2].hutan_rtup);
              int jasaRtup = int.parse(isisensustani[index = 2].jasa_rtup);
              ...
              int utp = int.parse(isisensustani[index = 2].utp);
              int panganUtp = int.parse(isisensustani[index = 2].padi_utp);
              int hortiUtp = int.parse(isisensustani[index = 2].horti_utp);
              int kebunUtp = int.parse(isisensustani[index = 2].kebun_utp);
              int ternakUtp = int.parse(isisensustani[index = 2].ternak_utp);
              int ikanUtp = int.parse(isisensustani[index = 2].ikan_utp);
              int hutanUtp = int.parse(isisensustani[index = 2].hutan_utp);
              int jasaUtp = int.parse(isisensustani[index = 2].jasa_utp);
                ...
                child: Column(
                  children: <Widget>[
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          'Sensus Pertanian $thn (ST$thn) mencatat jumlah Rumah Tangga Usaha Pertanian (RTUP) dan jumlah Usaha Pertanian Perorangan (UTP) di Indonesia sebanyak : ',
