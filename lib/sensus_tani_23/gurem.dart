...
Future<List<Data>> fetchData() async {
  var url =
      Uri.parse('https://bps-3301-asap.my.id/api/sensus-tani-lahan-gurem');
                      ...
                      return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.pglahan_rtup), 0)),
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.gurem_rtup), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.pglahan_utp), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.gurem_utp), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.pglahan_petani), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.gurem_petani), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
