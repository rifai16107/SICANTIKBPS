...
import 'package:bps_cilacap/pdrb_adhk_kabkot/pdrbadhk_kabkot_a.dart';
import 'package:bps_cilacap/pdrb_adhk_kabkot/pdrbadhk_kabkot_bc.dart';
import 'package:bps_cilacap/pdrb_adhk_kabkot/pdrbadhk_kabkot_de.dart';
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String thn23 = isipdrbkabkot[index = 0].tahun.substring(5, 9) +
                  "-" +
                  isipdrbkabkot[index = 0].tahun.substring(10, 14);
              String thn45 = isipdrbkabkot[index = 0].tahun.substring(15, 19) +
                  "-" +
