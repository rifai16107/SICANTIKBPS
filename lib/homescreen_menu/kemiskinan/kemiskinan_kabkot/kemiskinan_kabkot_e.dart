          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double pmk1 = double.parse(isikemiskinan[index = 0].pddk_mskn);
                double pmk2 = double.parse(isikemiskinan[index = 1].pddk_mskn);
                double pmk3 = double.parse(isikemiskinan[index = 2].pddk_mskn);
                double pmk4 = double.parse(isikemiskinan[index = 3].pddk_mskn);
                double pmk5 = double.parse(isikemiskinan[index = 4].pddk_mskn);
                double pmk6 = double.parse(isikemiskinan[index = 5].pddk_mskn);
                double pmk7 = double.parse(isikemiskinan[index = 6].pddk_mskn);
                double pmk8 = double.parse(isikemiskinan[index = 7].pddk_mskn);
                double pmk9 = double.parse(isikemiskinan[index = 8].pddk_mskn);
                double pmk10 = double.parse(isikemiskinan[index = 9].pddk_mskn);
