...
class kemiskinanKabkotC extends StatefulWidget {
  const kemiskinanKabkotC({Key? key}) : super(key: key);

  @override
  State<kemiskinanKabkotC> createState() => _kemiskinanKabkotCState();
}

RepositoryKemiskinanKota repositoryKemiskinanKota = RepositoryKemiskinanKota();

class _kemiskinanKabkotCState extends State<kemiskinanKabkotC> {
  @override
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double pmk1 = double.parse(
                isikemiskinan[index = 0].pddk_mskn_n3,
              );
              double pmk2 = double.parse(
                isikemiskinan[index = 1].pddk_mskn_n3,
              );
              double pmk3 = double.parse(
                isikemiskinan[index = 2].pddk_mskn_n3,
              );
              double pmk4 = double.parse(
                isikemiskinan[index = 3].pddk_mskn_n3,
              );
              double pmk5 = double.parse(
                isikemiskinan[index = 4].pddk_mskn_n3,
              );
              double pmk6 = double.parse(
                isikemiskinan[index = 5].pddk_mskn_n3,
              );
              double pmk7 = double.parse(
                isikemiskinan[index = 6].pddk_mskn_n3,
              );
              double pmk8 = double.parse(
                isikemiskinan[index = 7].pddk_mskn_n3,
              );
              double pmk9 = double.parse(
                isikemiskinan[index = 8].pddk_mskn_n3,
              );
              double pmk10 = double.parse(
                isikemiskinan[index = 9].pddk_mskn_n3,
              );
              double pmk11 = double.parse(
                isikemiskinan[index = 10].pddk_mskn_n3,
              );
              double pmk12 = double.parse(
                isikemiskinan[index = 11].pddk_mskn_n3,
              );
              double pmk13 = double.parse(
                isikemiskinan[index = 12].pddk_mskn_n3,
              );
              double pmk14 = double.parse(
                isikemiskinan[index = 13].pddk_mskn_n3,
              );
              double pmk15 = double.parse(
                isikemiskinan[index = 14].pddk_mskn_n3,
              );
              double pmk16 = double.parse(
                isikemiskinan[index = 15].pddk_mskn_n3,
              );
              double pmk17 = double.parse(
                isikemiskinan[index = 16].pddk_mskn_n3,
              );
              double pmk18 = double.parse(
                isikemiskinan[index = 17].pddk_mskn_n3,
              );
              double pmk19 = double.parse(
                isikemiskinan[index = 18].pddk_mskn_n3,
              );
              double pmk20 = double.parse(
                isikemiskinan[index = 19].pddk_mskn_n3,
              );
              double pmk21 = double.parse(
                isikemiskinan[index = 20].pddk_mskn_n3,
              );
              double pmk22 = double.parse(
                isikemiskinan[index = 21].pddk_mskn_n3,
              );
              double pmk23 = double.parse(
                isikemiskinan[index = 22].pddk_mskn_n3,
              );
              double pmk24 = double.parse(
                isikemiskinan[index = 23].pddk_mskn_n3,
              );
              double pmk25 = double.parse(
                isikemiskinan[index = 24].pddk_mskn_n3,
              );
              double pmk26 = double.parse(
                isikemiskinan[index = 25].pddk_mskn_n3,
              );
              double pmk27 = double.parse(
                isikemiskinan[index = 26].pddk_mskn_n3,
              );
              double pmk28 = double.parse(
                isikemiskinan[index = 27].pddk_mskn_n3,
              );
              double pmk29 = double.parse(
                isikemiskinan[index = 28].pddk_mskn_n3,
              );
              double pmk30 = double.parse(
                isikemiskinan[index = 29].pddk_mskn_n3,
              );
              double pmk31 = double.parse(
                isikemiskinan[index = 30].pddk_mskn_n3,
              );
              double pmk32 = double.parse(
                isikemiskinan[index = 31].pddk_mskn_n3,
              );
              double pmk33 = double.parse(
                isikemiskinan[index = 32].pddk_mskn_n3,
              );
              double pmk34 = double.parse(
                isikemiskinan[index = 33].pddk_mskn_n3,
              );
              double pmk35 = double.parse(
                isikemiskinan[index = 34].pddk_mskn_n3,
              );
              double pmk36 = double.parse(
                isikemiskinan[index = 35].pddk_mskn_n3,
              );

              double p0_1 = double.parse(
                isikemiskinan[index = 0].p0_n3,
              );
              double p0_2 = double.parse(
                isikemiskinan[index = 1].p0_n3,
              );
              double p0_3 = double.parse(
                isikemiskinan[index = 2].p0_n3,
              );
              double p0_4 = double.parse(
                isikemiskinan[index = 3].p0_n3,
              );
              double p0_5 = double.parse(
                isikemiskinan[index = 4].p0_n3,
              );
              double p0_6 = double.parse(
                isikemiskinan[index = 5].p0_n3,
              );
              double p0_7 = double.parse(
                isikemiskinan[index = 6].p0_n3,
              );
              double p0_8 = double.parse(
                isikemiskinan[index = 7].p0_n3,
              );
              double p0_9 = double.parse(
                isikemiskinan[index = 8].p0_n3,
              );
              double p0_10 = double.parse(
                isikemiskinan[index = 9].p0_n3,
              );
              double p0_11 = double.parse(
                isikemiskinan[index = 10].p0_n3,
              );
              double p0_12 = double.parse(
                isikemiskinan[index = 11].p0_n3,
              );
              double p0_13 = double.parse(
                isikemiskinan[index = 12].p0_n3,
              );
              double p0_14 = double.parse(
                isikemiskinan[index = 13].p0_n3,
              );
              double p0_15 = double.parse(
                isikemiskinan[index = 14].p0_n3,
              );
              double p0_16 = double.parse(
                isikemiskinan[index = 15].p0_n3,
              );
              double p0_17 = double.parse(
                isikemiskinan[index = 16].p0_n3,
              );
              double p0_18 = double.parse(
                isikemiskinan[index = 17].p0_n3,
              );
              double p0_19 = double.parse(
                isikemiskinan[index = 18].p0_n3,
              );
              double p0_20 = double.parse(
                isikemiskinan[index = 19].p0_n3,
              );
              double p0_21 = double.parse(
                isikemiskinan[index = 20].p0_n3,
              );
              double p0_22 = double.parse(
                isikemiskinan[index = 21].p0_n3,
              );
              double p0_23 = double.parse(
                isikemiskinan[index = 22].p0_n3,
              );
              double p0_24 = double.parse(
                isikemiskinan[index = 23].p0_n3,
              );
              double p0_25 = double.parse(
                isikemiskinan[index = 24].p0_n3,
              );
              double p0_26 = double.parse(
                isikemiskinan[index = 25].p0_n3,
              );
              double p0_27 = double.parse(
                isikemiskinan[index = 26].p0_n3,
              );
              double p0_28 = double.parse(
                isikemiskinan[index = 27].p0_n3,
              );
              double p0_29 = double.parse(
                isikemiskinan[index = 28].p0_n3,
              );
              double p0_30 = double.parse(
                isikemiskinan[index = 29].p0_n3,
              );
              double p0_31 = double.parse(
                isikemiskinan[index = 30].p0_n3,
              );
              double p0_32 = double.parse(
                isikemiskinan[index = 31].p0_n3,
              );
              double p0_33 = double.parse(
                isikemiskinan[index = 32].p0_n3,
              );
              double p0_34 = double.parse(
                isikemiskinan[index = 33].p0_n3,
              );
              double p0_35 = double.parse(
                isikemiskinan[index = 34].p0_n3,
              );
              double p0_36 = double.parse(
                isikemiskinan[index = 35].p0_n3,
              );

              double gk1 = double.parse(
                isikemiskinan[index = 0].gk_n3,
              );
              double gk2 = double.parse(
                isikemiskinan[index = 1].gk_n3,
              );
              double gk3 = double.parse(
                isikemiskinan[index = 2].gk_n3,
              );
              double gk4 = double.parse(
                isikemiskinan[index = 3].gk_n3,
              );
              double gk5 = double.parse(
                isikemiskinan[index = 4].gk_n3,
              );
              double gk6 = double.parse(
                isikemiskinan[index = 5].gk_n3,
              );
              double gk7 = double.parse(
                isikemiskinan[index = 6].gk_n3,
              );
              double gk8 = double.parse(
                isikemiskinan[index = 7].gk_n3,
              );
              double gk9 = double.parse(
                isikemiskinan[index = 8].gk_n3,
              );
              double gk10 = double.parse(
                isikemiskinan[index = 9].gk_n3,
              );
              double gk11 = double.parse(
                isikemiskinan[index = 10].gk_n3,
              );
              double gk12 = double.parse(
                isikemiskinan[index = 11].gk_n3,
              );
              double gk13 = double.parse(
                isikemiskinan[index = 12].gk_n3,
              );
              double gk14 = double.parse(
                isikemiskinan[index = 13].gk_n3,
              );
              double gk15 = double.parse(
                isikemiskinan[index = 14].gk_n3,
              );
              double gk16 = double.parse(
                isikemiskinan[index = 15].gk_n3,
              );
              double gk17 = double.parse(
                isikemiskinan[index = 16].gk_n3,
              );
              double gk18 = double.parse(
                isikemiskinan[index = 17].gk_n3,
              );
              double gk19 = double.parse(
                isikemiskinan[index = 18].gk_n3,
              );
              double gk20 = double.parse(
                isikemiskinan[index = 19].gk_n3,
              );
              double gk21 = double.parse(
                isikemiskinan[index = 20].gk_n3,
              );
              double gk22 = double.parse(
                isikemiskinan[index = 21].gk_n3,
              );
              double gk23 = double.parse(
                isikemiskinan[index = 22].gk_n3,
              );
              double gk24 = double.parse(
                isikemiskinan[index = 23].gk_n3,
              );
              double gk25 = double.parse(
                isikemiskinan[index = 24].gk_n3,
              );
              double gk26 = double.parse(
                isikemiskinan[index = 25].gk_n3,
              );
              double gk27 = double.parse(
                isikemiskinan[index = 26].gk_n3,
              );
              double gk28 = double.parse(
                isikemiskinan[index = 27].gk_n3,
              );
              double gk29 = double.parse(
                isikemiskinan[index = 28].gk_n3,
              );
              double gk30 = double.parse(
                isikemiskinan[index = 29].gk_n3,
              );
              double gk31 = double.parse(
                isikemiskinan[index = 30].gk_n3,
              );
              double gk32 = double.parse(
                isikemiskinan[index = 31].gk_n3,
              );
              double gk33 = double.parse(
                isikemiskinan[index = 32].gk_n3,
              );
              double gk34 = double.parse(
                isikemiskinan[index = 33].gk_n3,
              );
              double gk35 = double.parse(
                isikemiskinan[index = 34].gk_n3,
              );
              double gk36 = double.parse(
                isikemiskinan[index = 35].gk_n3,
              );

              double p1_1 = double.parse(
                isikemiskinan[index = 0].p1_n3,
              );
              double p1_2 = double.parse(
                isikemiskinan[index = 1].p1_n3,
              );
              double p1_3 = double.parse(
                isikemiskinan[index = 2].p1_n3,
              );
              double p1_4 = double.parse(
                isikemiskinan[index = 3].p1_n3,
              );
              double p1_5 = double.parse(
                isikemiskinan[index = 4].p1_n3,
              );
              double p1_6 = double.parse(
                isikemiskinan[index = 5].p1_n3,
              );
              double p1_7 = double.parse(
                isikemiskinan[index = 6].p1_n3,
              );
              double p1_8 = double.parse(
                isikemiskinan[index = 7].p1_n3,
              );
              double p1_9 = double.parse(
                isikemiskinan[index = 8].p1_n3,
              );
              double p1_10 = double.parse(
                isikemiskinan[index = 9].p1_n3,
              );
              double p1_11 = double.parse(
                isikemiskinan[index = 10].p1_n3,
              );
              double p1_12 = double.parse(
                isikemiskinan[index = 11].p1_n3,
              );
              double p1_13 = double.parse(
                isikemiskinan[index = 12].p1_n3,
              );
              double p1_14 = double.parse(
                isikemiskinan[index = 13].p1_n3,
              );
              double p1_15 = double.parse(
                isikemiskinan[index = 14].p1_n3,
              );
              double p1_16 = double.parse(
                isikemiskinan[index = 15].p1_n3,
              );
              double p1_17 = double.parse(
                isikemiskinan[index = 16].p1_n3,
              );
              double p1_18 = double.parse(
                isikemiskinan[index = 17].p1_n3,
              );
              double p1_19 = double.parse(
                isikemiskinan[index = 18].p1_n3,
              );
              double p1_20 = double.parse(
                isikemiskinan[index = 19].p1_n3,
              );
              double p1_21 = double.parse(
                isikemiskinan[index = 20].p1_n3,
              );
              double p1_22 = double.parse(
                isikemiskinan[index = 21].p1_n3,
              );
              double p1_23 = double.parse(
                isikemiskinan[index = 22].p1_n3,
              );
              double p1_24 = double.parse(
                isikemiskinan[index = 23].p1_n3,
              );
              double p1_25 = double.parse(
                isikemiskinan[index = 24].p1_n3,
              );
              double p1_26 = double.parse(
                isikemiskinan[index = 25].p1_n3,
              );
              double p1_27 = double.parse(
                isikemiskinan[index = 26].p1_n3,
              );
              double p1_28 = double.parse(
                isikemiskinan[index = 27].p1_n3,
              );
              double p1_29 = double.parse(
                isikemiskinan[index = 28].p1_n3,
              );
              double p1_30 = double.parse(
                isikemiskinan[index = 29].p1_n3,
              );
              double p1_31 = double.parse(
                isikemiskinan[index = 30].p1_n3,
              );
              double p1_32 = double.parse(
                isikemiskinan[index = 31].p1_n3,
              );
              double p1_33 = double.parse(
                isikemiskinan[index = 32].p1_n3,
              );
              double p1_34 = double.parse(
                isikemiskinan[index = 33].p1_n3,
              );
              double p1_35 = double.parse(
                isikemiskinan[index = 34].p1_n3,
              );
              double p1_36 = double.parse(
                isikemiskinan[index = 35].p1_n3,
              );

              double p2_1 = double.parse(
                isikemiskinan[index = 0].p2_n3,
              );
              double p2_2 = double.parse(
                isikemiskinan[index = 1].p2_n3,
              );
              double p2_3 = double.parse(
                isikemiskinan[index = 2].p2_n3,
              );
              double p2_4 = double.parse(
                isikemiskinan[index = 3].p2_n3,
              );
              double p2_5 = double.parse(
                isikemiskinan[index = 4].p2_n3,
              );
              double p2_6 = double.parse(
                isikemiskinan[index = 5].p2_n3,
              );
              double p2_7 = double.parse(
                isikemiskinan[index = 6].p2_n3,
              );
              double p2_8 = double.parse(
                isikemiskinan[index = 7].p2_n3,
              );
              double p2_9 = double.parse(
                isikemiskinan[index = 8].p2_n3,
              );
              double p2_10 = double.parse(
                isikemiskinan[index = 9].p2_n3,
              );
              double p2_11 = double.parse(
                isikemiskinan[index = 10].p2_n3,
              );
              double p2_12 = double.parse(
                isikemiskinan[index = 11].p2_n3,
              );
              double p2_13 = double.parse(
                isikemiskinan[index = 12].p2_n3,
              );
              double p2_14 = double.parse(
                isikemiskinan[index = 13].p2_n3,
              );
              double p2_15 = double.parse(
                isikemiskinan[index = 14].p2_n3,
              );
              double p2_16 = double.parse(
                isikemiskinan[index = 15].p2_n3,
              );
              double p2_17 = double.parse(
                isikemiskinan[index = 16].p2_n3,
              );
              double p2_18 = double.parse(
                isikemiskinan[index = 17].p2_n3,
              );
              double p2_19 = double.parse(
                isikemiskinan[index = 18].p2_n3,
              );
              double p2_20 = double.parse(
                isikemiskinan[index = 19].p2_n3,
              );
              double p2_21 = double.parse(
                isikemiskinan[index = 20].p2_n3,
              );
              double p2_22 = double.parse(
                isikemiskinan[index = 21].p2_n3,
              );
              double p2_23 = double.parse(
                isikemiskinan[index = 22].p2_n3,
              );
              double p2_24 = double.parse(
                isikemiskinan[index = 23].p2_n3,
              );
              double p2_25 = double.parse(
                isikemiskinan[index = 24].p2_n3,
              );
              double p2_26 = double.parse(
                isikemiskinan[index = 25].p2_n3,
              );
              double p2_27 = double.parse(
                isikemiskinan[index = 26].p2_n3,
              );
              double p2_28 = double.parse(
                isikemiskinan[index = 27].p2_n3,
              );
              double p2_29 = double.parse(
                isikemiskinan[index = 28].p2_n3,
              );
              double p2_30 = double.parse(
                isikemiskinan[index = 29].p2_n3,
              );
              double p2_31 = double.parse(
                isikemiskinan[index = 30].p2_n3,
              );
              double p2_32 = double.parse(
                isikemiskinan[index = 31].p2_n3,
              );
              double p2_33 = double.parse(
                isikemiskinan[index = 32].p2_n3,
              );
              double p2_34 = double.parse(
                isikemiskinan[index = 33].p2_n3,
              );
              double p2_35 = double.parse(
                isikemiskinan[index = 34].p2_n3,
              );
              double p2_36 = double.parse(
                isikemiskinan[index = 35].p2_n3,
              );
