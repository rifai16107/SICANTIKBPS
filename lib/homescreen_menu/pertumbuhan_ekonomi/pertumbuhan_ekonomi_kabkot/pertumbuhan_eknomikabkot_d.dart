...
class PertumbuhanEknomiKabkotD extends StatefulWidget {
  const PertumbuhanEknomiKabkotD({Key? key}) : super(key: key);

  @override
  State<PertumbuhanEknomiKabkotD> createState() =>
      _PertumbuhanEknomiKabkotDState();
}

RepositoryPdrbKabkot repositorypdrb = RepositoryPdrbKabkot();

class _PertumbuhanEknomiKabkotDState extends State<PertumbuhanEknomiKabkotD> {
  @override
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double pdrb1 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 0].pdrb_adhk4,
                );
                double pdrb2 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 1].pdrb_adhk4,
                );
                double pdrb3 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 2].pdrb_adhk4,
                );
                double pdrb4 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 3].pdrb_adhk4,
                );
                double pdrb5 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 4].pdrb_adhk4,
                );
                double pdrb6 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 5].pdrb_adhk4,
                );
                double pdrb7 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 6].pdrb_adhk4,
                );
                double pdrb8 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 7].pdrb_adhk4,
                );
                double pdrb9 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 8].pdrb_adhk4,
                );
                double pdrb10 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 9].pdrb_adhk4,
                );
                double pdrb11 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 10].pdrb_adhk4,
                );
                double pdrb12 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 11].pdrb_adhk4,
                );
                double pdrb13 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 12].pdrb_adhk4,
                );
                double pdrb14 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 13].pdrb_adhk4,
                );
                double pdrb15 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 14].pdrb_adhk4,
                );
                double pdrb16 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 15].pdrb_adhk4,
                );
                double pdrb17 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 16].pdrb_adhk4,
                );
                double pdrb18 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 17].pdrb_adhk4,
                );
                double pdrb19 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 18].pdrb_adhk4,
                );
                double pdrb20 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 19].pdrb_adhk4,
                );
                double pdrb21 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 20].pdrb_adhk4,
                );
                double pdrb22 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 21].pdrb_adhk4,
                );
                double pdrb23 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 22].pdrb_adhk4,
                );
                double pdrb24 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 23].pdrb_adhk4,
                );
                double pdrb25 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 24].pdrb_adhk4,
                );
                double pdrb26 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 25].pdrb_adhk4,
                );
                double pdrb27 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 26].pdrb_adhk4,
                );
                double pdrb28 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 27].pdrb_adhk4,
                );
                double pdrb29 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 28].pdrb_adhk4,
                );
                double pdrb30 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 29].pdrb_adhk4,
                );
                double pdrb31 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 30].pdrb_adhk4,
                );
                double pdrb32 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 31].pdrb_adhk4,
                );
                double pdrb33 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 32].pdrb_adhk4,
                );
                double pdrb34 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 33].pdrb_adhk4,
                );
                double pdrb35 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 34].pdrb_adhk4,
                );
                double pdrb36 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 35].pdrb_adhk4,
                );

                double pe1 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 0].pe4,
                );
                double pe2 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 1].pe4,
                );
                double pe3 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 2].pe4,
                );
                double pe4 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 3].pe4,
                );
                double pe5 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 4].pe4,
                );
                double pe6 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 5].pe4,
                );
                double pe7 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 6].pe4,
                );
                double pe8 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 7].pe4,
                );
                double pe9 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 8].pe4,
                );
                double pe10 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 9].pe4,
                );
                double pe11 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 10].pe4,
                );
                double pe12 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 11].pe4,
                );
                double pe13 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 12].pe4,
                );
                double pe14 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 13].pe4,
                );
                double pe15 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 14].pe4,
                );
                double pe16 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 15].pe4,
                );
                double pe17 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 16].pe4,
                );
                double pe18 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 17].pe4,
                );
                double pe19 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 18].pe4,
                );
                double pe20 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 19].pe4,
                );
                double pe21 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 20].pe4,
                );
                double pe22 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 21].pe4,
                );
                double pe23 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 22].pe4,
                );
                double pe24 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 23].pe4,
                );
                double pe25 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 24].pe4,
                );
                double pe26 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 25].pe4,
                );
                double pe27 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 26].pe4,
                );
                double pe28 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 27].pe4,
                );
                double pe29 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 28].pe4,
                );
                double pe30 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 29].pe4,
                );
                double pe31 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 30].pe4,
                );
                double pe32 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 31].pe4,
                );
                double pe33 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 32].pe4,
                );
                double pe34 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 33].pe4,
                );
                double pe35 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 34].pe4,
                );
                double pe36 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 35].pe4,
                );
