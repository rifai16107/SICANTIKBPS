...
import 'package:bps_cilacap/homescreen_menu/pertumbuhan_ekonomi/pertumbuhan_ekonomi_kabkot/body_grafik_pdrbadhk_kabkota.dart';
import 'package:bps_cilacap/homescreen_menu/pertumbuhan_ekonomi/pertumbuhan_ekonomi_kabkot/body_grafik_pertumb_ekonomi_kabkota.dart';

class PertumbuhanEknomiKabkotE extends StatefulWidget {
  const PertumbuhanEknomiKabkotE({Key? key}) : super(key: key);

  @override
  State<PertumbuhanEknomiKabkotE> createState() =>
      _PertumbuhanEknomiKabkotEState();
}

RepositoryPdrbKabkot repositorypdrb = RepositoryPdrbKabkot();

class _PertumbuhanEknomiKabkotEState extends State<PertumbuhanEknomiKabkotE> {
  @override
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double pdrb1 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 0].pdrb_adhk5,
                );
                double pdrb2 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 1].pdrb_adhk5,
                );
                double pdrb3 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 2].pdrb_adhk5,
                );
                double pdrb4 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 3].pdrb_adhk5,
                );
                double pdrb5 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 4].pdrb_adhk5,
                );
                double pdrb6 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 5].pdrb_adhk5,
                );
                double pdrb7 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 6].pdrb_adhk5,
                );
                double pdrb8 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 7].pdrb_adhk5,
                );
                double pdrb9 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 8].pdrb_adhk5,
                );
                double pdrb10 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 9].pdrb_adhk5,
                );
                double pdrb11 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 10].pdrb_adhk5,
                );
                double pdrb12 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 11].pdrb_adhk5,
                );
                double pdrb13 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 12].pdrb_adhk5,
                );
                double pdrb14 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 13].pdrb_adhk5,
                );
                double pdrb15 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 14].pdrb_adhk5,
                );
                double pdrb16 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 15].pdrb_adhk5,
                );
                double pdrb17 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 16].pdrb_adhk5,
                );
                double pdrb18 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 17].pdrb_adhk5,
                );
                double pdrb19 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 18].pdrb_adhk5,
                );
                double pdrb20 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 19].pdrb_adhk5,
                );
                double pdrb21 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 20].pdrb_adhk5,
                );
                double pdrb22 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 21].pdrb_adhk5,
                );
                double pdrb23 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 22].pdrb_adhk5,
                );
                double pdrb24 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 23].pdrb_adhk5,
                );
                double pdrb25 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 24].pdrb_adhk5,
                );
                double pdrb26 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 25].pdrb_adhk5,
                );
                double pdrb27 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 26].pdrb_adhk5,
                );
                double pdrb28 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 27].pdrb_adhk5,
                );
                double pdrb29 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 28].pdrb_adhk5,
                );
                double pdrb30 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 29].pdrb_adhk5,
                );
                double pdrb31 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 30].pdrb_adhk5,
                );
                double pdrb32 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 31].pdrb_adhk5,
                );
                double pdrb33 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 32].pdrb_adhk5,
                );
                double pdrb34 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 33].pdrb_adhk5,
                );
                double pdrb35 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 34].pdrb_adhk5,
                );
                double pdrb36 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 35].pdrb_adhk5,
                );

                double pe1 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 0].pe5,
                );
                double pe2 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 1].pe5,
                );
                double pe3 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 2].pe5,
                );
                double pe4 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 3].pe5,
                );
                double pe5 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 4].pe5,
                );
                double pe6 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 5].pe5,
                );
                double pe7 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 6].pe5,
                );
                double pe8 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 7].pe5,
                );
                double pe9 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 8].pe5,
                );
                double pe10 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 9].pe5,
                );
                double pe11 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 10].pe5,
                );
                double pe12 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 11].pe5,
                );
                double pe13 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 12].pe5,
                );
                double pe14 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 13].pe5,
                );
                double pe15 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 14].pe5,
                );
                double pe16 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 15].pe5,
                );
                double pe17 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 16].pe5,
                );
                double pe18 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 17].pe5,
                );
                double pe19 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 18].pe5,
                );
                double pe20 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 19].pe5,
                );
                double pe21 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 20].pe5,
                );
                double pe22 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 21].pe5,
                );
                double pe23 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 22].pe5,
                );
                double pe24 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 23].pe5,
                );
                double pe25 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 24].pe5,
                );
                double pe26 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 25].pe5,
                );
                double pe27 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 26].pe5,
                );
                double pe28 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 27].pe5,
                );
                double pe29 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 28].pe5,
                );
                double pe30 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 29].pe5,
                );
                double pe31 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 30].pe5,
                );
                double pe32 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 31].pe5,
                );
                double pe33 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 32].pe5,
                );
                double pe34 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 33].pe5,
                );
                double pe35 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 34].pe5,
                );
                double pe36 = double.parse(
                  isiPertumbuhanEknomikabkot[index = 35].pe5,
                );
