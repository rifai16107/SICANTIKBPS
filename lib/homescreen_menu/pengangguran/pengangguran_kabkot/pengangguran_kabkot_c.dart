...
class PengangguranKabkotC extends StatefulWidget {
  const PengangguranKabkotC({Key? key}) : super(key: key);

  @override
  State<PengangguranKabkotC> createState() => _PengangguranKabkotCState();
}

RepositoryPengangguranKabkot PengangguranKabkot =
    RepositoryPengangguranKabkot();

class _PengangguranKabkotCState extends State<PengangguranKabkotC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double tpt1 =
                  double.parse(isipenganggurankabkot[index = 0].tpt_n3);
              double tpt2 =
                  double.parse(isipenganggurankabkot[index = 1].tpt_n3);
              double tpt3 =
                  double.parse(isipenganggurankabkot[index = 2].tpt_n3);
              double tpt4 =
                  double.parse(isipenganggurankabkot[index = 3].tpt_n3);
              double tpt5 =
                  double.parse(isipenganggurankabkot[index = 4].tpt_n3);
              double tpt6 =
                  double.parse(isipenganggurankabkot[index = 5].tpt_n3);
              double tpt7 =
                  double.parse(isipenganggurankabkot[index = 6].tpt_n3);
              double tpt8 =
                  double.parse(isipenganggurankabkot[index = 7].tpt_n3);
              double tpt9 =
                  double.parse(isipenganggurankabkot[index = 8].tpt_n3);
              double tpt10 =
                  double.parse(isipenganggurankabkot[index = 9].tpt_n3);
              double tpt11 =
                  double.parse(isipenganggurankabkot[index = 10].tpt_n3);
              double tpt12 =
                  double.parse(isipenganggurankabkot[index = 11].tpt_n3);
              double tpt13 =
                  double.parse(isipenganggurankabkot[index = 12].tpt_n3);
              double tpt14 =
                  double.parse(isipenganggurankabkot[index = 13].tpt_n3);
              double tpt15 =
                  double.parse(isipenganggurankabkot[index = 14].tpt_n3);
              double tpt16 =
                  double.parse(isipenganggurankabkot[index = 15].tpt_n3);
              double tpt17 =
                  double.parse(isipenganggurankabkot[index = 16].tpt_n3);
              double tpt18 =
                  double.parse(isipenganggurankabkot[index = 17].tpt_n3);
              double tpt19 =
                  double.parse(isipenganggurankabkot[index = 18].tpt_n3);
              double tpt20 =
                  double.parse(isipenganggurankabkot[index = 19].tpt_n3);
              double tpt21 =
                  double.parse(isipenganggurankabkot[index = 20].tpt_n3);
              double tpt22 =
                  double.parse(isipenganggurankabkot[index = 21].tpt_n3);
              double tpt23 =
                  double.parse(isipenganggurankabkot[index = 22].tpt_n3);
              double tpt24 =
                  double.parse(isipenganggurankabkot[index = 23].tpt_n3);
              double tpt25 =
                  double.parse(isipenganggurankabkot[index = 24].tpt_n3);
              double tpt26 =
                  double.parse(isipenganggurankabkot[index = 25].tpt_n3);
              double tpt27 =
                  double.parse(isipenganggurankabkot[index = 26].tpt_n3);
              double tpt28 =
                  double.parse(isipenganggurankabkot[index = 27].tpt_n3);
              double tpt29 =
                  double.parse(isipenganggurankabkot[index = 28].tpt_n3);
              double tpt30 =
                  double.parse(isipenganggurankabkot[index = 29].tpt_n3);
              double tpt31 =
                  double.parse(isipenganggurankabkot[index = 30].tpt_n3);
              double tpt32 =
                  double.parse(isipenganggurankabkot[index = 31].tpt_n3);
              double tpt33 =
                  double.parse(isipenganggurankabkot[index = 32].tpt_n3);
              double tpt34 =
                  double.parse(isipenganggurankabkot[index = 33].tpt_n3);
              double tpt35 =
                  double.parse(isipenganggurankabkot[index = 34].tpt_n3);
              double tptTotal =
                  double.parse(isipenganggurankabkot[index = 35].tpt_n3);

              double tpak1 =
                  double.parse(isipenganggurankabkot[index = 0].tpak_n3);
              double tpak2 =
                  double.parse(isipenganggurankabkot[index = 1].tpak_n3);
              double tpak3 =
                  double.parse(isipenganggurankabkot[index = 2].tpak_n3);
              double tpak4 =
                  double.parse(isipenganggurankabkot[index = 3].tpak_n3);
              double tpak5 =
                  double.parse(isipenganggurankabkot[index = 4].tpak_n3);
              double tpak6 =
                  double.parse(isipenganggurankabkot[index = 5].tpak_n3);
              double tpak7 =
                  double.parse(isipenganggurankabkot[index = 6].tpak_n3);
              double tpak8 =
                  double.parse(isipenganggurankabkot[index = 7].tpak_n3);
              double tpak9 =
                  double.parse(isipenganggurankabkot[index = 8].tpak_n3);
              double tpak10 =
                  double.parse(isipenganggurankabkot[index = 9].tpak_n3);
              double tpak11 =
                  double.parse(isipenganggurankabkot[index = 10].tpak_n3);
              double tpak12 =
                  double.parse(isipenganggurankabkot[index = 11].tpak_n3);
              double tpak13 =
                  double.parse(isipenganggurankabkot[index = 12].tpak_n3);
              double tpak14 =
                  double.parse(isipenganggurankabkot[index = 13].tpak_n3);
              double tpak15 =
                  double.parse(isipenganggurankabkot[index = 14].tpak_n3);
              double tpak16 =
                  double.parse(isipenganggurankabkot[index = 15].tpak_n3);
              double tpak17 =
                  double.parse(isipenganggurankabkot[index = 16].tpak_n3);
              double tpak18 =
                  double.parse(isipenganggurankabkot[index = 17].tpak_n3);
              double tpak19 =
                  double.parse(isipenganggurankabkot[index = 18].tpak_n3);
              double tpak20 =
                  double.parse(isipenganggurankabkot[index = 19].tpak_n3);
              double tpak21 =
                  double.parse(isipenganggurankabkot[index = 20].tpak_n3);
              double tpak22 =
                  double.parse(isipenganggurankabkot[index = 21].tpak_n3);
              double tpak23 =
                  double.parse(isipenganggurankabkot[index = 22].tpak_n3);
              double tpak24 =
                  double.parse(isipenganggurankabkot[index = 23].tpak_n3);
              double tpak25 =
                  double.parse(isipenganggurankabkot[index = 24].tpak_n3);
              double tpak26 =
                  double.parse(isipenganggurankabkot[index = 25].tpak_n3);
              double tpak27 =
                  double.parse(isipenganggurankabkot[index = 26].tpak_n3);
              double tpak28 =
                  double.parse(isipenganggurankabkot[index = 27].tpak_n3);
              double tpak29 =
                  double.parse(isipenganggurankabkot[index = 28].tpak_n3);
              double tpak30 =
                  double.parse(isipenganggurankabkot[index = 29].tpak_n3);
              double tpak31 =
                  double.parse(isipenganggurankabkot[index = 30].tpak_n3);
              double tpak32 =
                  double.parse(isipenganggurankabkot[index = 31].tpak_n3);
              double tpak33 =
                  double.parse(isipenganggurankabkot[index = 32].tpak_n3);
              double tpak34 =
                  double.parse(isipenganggurankabkot[index = 33].tpak_n3);
              double tpak35 =
                  double.parse(isipenganggurankabkot[index = 34].tpak_n3);
              double tpakTotal =
                  double.parse(isipenganggurankabkot[index = 35].tpak_n3);
