...
import 'package:bps_cilacap/homescreen_menu/pengangguran/pengangguran_kabkot/body_grafik_tpt_kabkota.dart';
import 'package:bps_cilacap/homescreen_menu/pengangguran/pengangguran_kabkot/body_grafik_tpak_kabkota.dart';
import 'package:flutter/material.dart';
import 'package:flutter_speed_dial/flutter_speed_dial.dart';
import 'package:bps_cilacap/format_angka.dart';

class PengangguranKabkotE extends StatefulWidget {
  const PengangguranKabkotE({Key? key}) : super(key: key);

  @override
  State<PengangguranKabkotE> createState() => _PengangguranKabkotEState();
}

RepositoryPengangguranKabkot PengangguranKabkot =
    RepositoryPengangguranKabkot();

class _PengangguranKabkotEState extends State<PengangguranKabkotE> {
  @override
            ...
            if (snapshot.hasData) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  String kab1 =
                      "01. " + isipenganggurankabkot[index = 0].kab_kota;
                  String kab2 =
                      "02. " + isipenganggurankabkot[index = 1].kab_kota;
                  String kab3 =
                      "03. " + isipenganggurankabkot[index = 2].kab_kota;
                  String kab4 =
                      "04. " + isipenganggurankabkot[index = 3].kab_kota;
                  String kab5 =
                      "05. " + isipenganggurankabkot[index = 4].kab_kota;
                  String kab6 =
                      "06. " + isipenganggurankabkot[index = 5].kab_kota;
                  String kab7 =
                      "07. " + isipenganggurankabkot[index = 6].kab_kota;
                  String kab8 =
                      "08. " + isipenganggurankabkot[index = 7].kab_kota;
                  String kab9 =
                      "09. " + isipenganggurankabkot[index = 8].kab_kota;
                  String kab10 =
                      "10. " + isipenganggurankabkot[index = 9].kab_kota;
                  String kab11 =
                  ...
                  String prov =
                      " " + isipenganggurankabkot[index = 35].kab_kota;
            ...
            SpeedDialChild(
              ...
              onTap: () {
                  Navigator.push(
                      context,
                      CustomPageRoute(
                          child: const BodyGrafikTpakKabkot(),
            ...
            SpeedDialChild(
              ...
              onTap: () {
                  Navigator.push(
                      context,
                      CustomPageRoute(
                          child: const BodyGrafikTptKabkot(),
                          direction: AxisDirection.left));
                },
              label: 'TPT',
              labelBackgroundColor: Colors.black,
