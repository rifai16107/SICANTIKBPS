...
import 'package:bps_cilacap/homescreen_menu/perumahan/body_grafik_rumah_lantai.dart';
            ...
            if (snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  //tahun n-2
                  double persentase_1 = double.parse(isilantai[index = 0].persentase);
                  double persentase_2 = double.parse(isilantai[index = 1].persentase);
                  double persentase_3 = double.parse(isilantai[index = 2].persentase);
                  double persentase_4 = double.parse(isilantai[index = 3].persentase);
                  double persentase_5 = double.parse(isilantai[index = 4].persentase);
                  double persentase_6 = double.parse(isilantai[index = 5].persentase);
                  double persentase_7 = double.parse(isilantai[index = 6].persentase);
                  double persentase_8 = double.parse(isilantai[index = 7].persentase);
                  double persentase_9 = double.parse(isilantai[index = 8].persentase);

                  //tahun n-1
                  double persentase_10 = double.parse(isilantai[index = 9].persentase);
                  double persentase_11 = double.parse(isilantai[index = 10].persentase);
                  double persentase_12 = double.parse(isilantai[index = 11].persentase);
                  double persentase_13 = double.parse(isilantai[index = 12].persentase);
                  double persentase_14 = double.parse(isilantai[index = 13].persentase);
                  double persentase_15 = double.parse(isilantai[index = 14].persentase);
                  double persentase_16 = double.parse(isilantai[index = 15].persentase);
                  double persentase_17 = double.parse(isilantai[index = 16].persentase);
                  double persentase_18 = double.parse(isilantai[index = 17].persentase);
                  
                  

                  //tahun n
                  double persentase_19 = double.parse(isilantai[index = 18].persentase);
                  double persentase_20 = double.parse(isilantai[index = 19].persentase);
                  double persentase_21 = double.parse(isilantai[index = 20].persentase);
                  double persentase_22 = double.parse(isilantai[index = 21].persentase);
                  double persentase_23 = double.parse(isilantai[index = 22].persentase);
                  double persentase_24 = double.parse(isilantai[index = 23].persentase);
                  double persentase_25 = double.parse(isilantai[index = 24].persentase);
                  double persentase_26 = double.parse(isilantai[index = 25].persentase);
                  double persentase_27 = double.parse(isilantai[index = 26].persentase);
