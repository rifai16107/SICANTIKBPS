...
void main() => runApp(const RumahkabkotAtapA());

class RumahkabkotAtapA extends StatelessWidget {
  const RumahkabkotAtapA({super.key});
...
class Data {
  ...
  final String beton_n1;
  final String genteng_n1;
  final String seng_n1;
  final String asbes_n1;
  final String sirap_kayu_n1;
  final String jerami_ijuk_n1;
  ...
  Data({
    ...
    required this.beton_n1,
    required this.genteng_n1,
    required this.seng_n1,
    required this.asbes_n1,
    required this.sirap_kayu_n1,
    required this.jerami_ijuk_n1,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      beton_n1: json['beton_n1'],
      genteng_n1: json['genteng_n1'],
      seng_n1: json['seng_n1'],
      asbes_n1: json['asbes_n1'],
      sirap_kayu_n1: json['sirap_kayu_n1'],
      jerami_ijuk_n1: json['jerami_ijuk_n1'],
