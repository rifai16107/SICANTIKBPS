...
void main() => runApp(const RumahkabkotBahanbakarB());

class RumahkabkotBahanbakarB extends StatelessWidget {
  const RumahkabkotBahanbakarB({super.key});
...
class Data {
  ...
  final String listrik_n2;
  final String gas_n2;
  final String minyak_kayu_n2;
  final String lainnya_n2;
  final String tdkmasak_n2;
  ...
  Data({
    ...
    required this.listrik_n2,
    required this.gas_n2,
    required this.minyak_kayu_n2,
    required this.lainnya_n2,
    required this.tdkmasak_n2,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      listrik_n2: json['listrik_n2'],
      gas_n2: json['gas_n2'],
      minyak_kayu_n2: json['minyak_kayu_n2'],
      lainnya_n2: json['lainnya_n2'],
      tdkmasak_n2: json['tdkmasak_n2'],
