...
void main() => runApp(const RumahkabkotBahanbakarC());

class RumahkabkotBahanbakarC extends StatelessWidget {
  const RumahkabkotBahanbakarC({super.key});
...
class Data {
  ...
  final String listrik_n3;
  final String gas_n3;
  final String minyak_kayu_n3;
  final String lainnya_n3;
  final String tdkmasak_n3;
  ...
  Data({
    ...
    required this.listrik_n3,
    required this.gas_n3,
    required this.minyak_kayu_n3,
    required this.lainnya_n3,
    required this.tdkmasak_n3,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      listrik_n3: json['listrik_n3'],
      gas_n3: json['gas_n3'],
      minyak_kayu_n3: json['minyak_kayu_n3'],
      lainnya_n3: json['lainnya_n3'],
      tdkmasak_n3: json['tdkmasak_n3'],
