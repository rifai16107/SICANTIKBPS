...
void main() => runApp(const RumahkabkotLantaiA());

class RumahkabkotLantaiA extends StatelessWidget {
  const RumahkabkotLantaiA({super.key});
...
class Data {
  ...
  final String marmer_granit_n1;
  final String keramik_n1;
  final String parket_vinil_n1;
  final String kayu_papan_n1;
  final String semen_bata_n1;
  final String bambu_n1;
  final String tanah_n1;
  ...
  Data({
    ...
    required this.marmer_granit_n1,
    required this.keramik_n1,
    required this.parket_vinil_n1,
    required this.kayu_papan_n1,
    required this.semen_bata_n1,
    required this.bambu_n1,
    required this.tanah_n1,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      marmer_granit_n1: json['marmer_granit_n1'],
      keramik_n1: json['keramik_n1'],
      parket_vinil_n1: json['parket_vinil_n1'],
      kayu_papan_n1: json['kayu_papan_n1'],
      semen_bata_n1: json['semen_bata_n1'],
      bambu_n1: json['bambu_n1'],
      tanah_n1: json['tanah_n1'],
