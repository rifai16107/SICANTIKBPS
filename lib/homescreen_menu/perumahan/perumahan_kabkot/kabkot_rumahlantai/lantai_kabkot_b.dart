...
void main() => runApp(const RumahkabkotLantaiB());

class RumahkabkotLantaiB extends StatelessWidget {
  const RumahkabkotLantaiB({super.key});
...
class Data {
  ...
  final String marmer_granit_n2;
  final String keramik_n2;
  final String parket_vinil_n2;
  final String kayu_papan_n2;
  final String semen_bata_n2;
  final String bambu_n2;
  final String tanah_n2;
  ...
  Data({
    ...
    required this.marmer_granit_n2,
    required this.keramik_n2,
    required this.parket_vinil_n2,
    required this.kayu_papan_n2,
    required this.semen_bata_n2,
    required this.bambu_n2,
    required this.tanah_n2,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      marmer_granit_n2: json['marmer_granit_n2'],
      keramik_n2: json['keramik_n2'],
      parket_vinil_n2: json['parket_vinil_n2'],
      kayu_papan_n2: json['kayu_papan_n2'],
      semen_bata_n2: json['semen_bata_n2'],
      bambu_n2: json['bambu_n2'],
      tanah_n2: json['tanah_n2'],
