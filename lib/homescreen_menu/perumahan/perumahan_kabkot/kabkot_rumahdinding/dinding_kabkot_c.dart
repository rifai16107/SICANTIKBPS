...
void main() => runApp(const RumahkabkotDindingC());

class RumahkabkotDindingC extends StatelessWidget {
  const RumahkabkotDindingC({super.key});
...
class Data {
  ...
  final String tembok_n3;
  final String plesteranyamanbambu_n3;
  final String kayu_n3;
  final String bambu_anyaman_n3;
  ...
  Data({
    ...
    required this.tembok_n3,
    required this.plesteranyamanbambu_n3,
    required this.kayu_n3,
    required this.bambu_anyaman_n3,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      tembok_n3: json['tembok_n3'],
      plesteranyamanbambu_n3: json['plesteranyamanbambu_n3'],
      kayu_n3: json['kayu_n3'],
      bambu_anyaman_n3: json['bambu_anyaman_n3'],
