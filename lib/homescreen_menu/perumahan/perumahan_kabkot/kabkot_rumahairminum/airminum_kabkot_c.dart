...
void main() => runApp(const RumahkabkotAirminumC());

class RumahkabkotAirminumC extends StatelessWidget {
  const RumahkabkotAirminumC({super.key});
...
class Data {
  ...
  final String kemasan_n3;
  final String leding_n3;
  final String sumurbor_n3;
  final String sumur_n3;
  final String mataair_n3;
  final String permukaan_hujan_lainnya_n3;
  ...
  Data({
    ...
    required this.kemasan_n3,
    required this.leding_n3,
    required this.sumurbor_n3,
    required this.sumur_n3,
    required this.mataair_n3,
    required this.permukaan_hujan_lainnya_n3,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      kemasan_n3: json['kemasan_n3'],
      leding_n3: json['leding_n3'],
      sumurbor_n3: json['sumurbor_n3'],
      sumur_n3: json['sumur_n3'],
      mataair_n3: json['mataair_n3'],
      permukaan_hujan_lainnya_n3: json['permukaan_hujan_lainnya_n3'],
                  ...
                  rows: List<DataRow>.generate(snapshot.data!.length, (index) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                          Text(
                            data.permukaan_hujan_lainnya_n3,
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
