...
void main() => runApp(const RumahkabkotAirminumB());

class RumahkabkotAirminumB extends StatelessWidget {
  const RumahkabkotAirminumB({super.key});
...
class Data {
  ...
  final String kemasan_n2;
  final String leding_n2;
  final String sumurbor_n2;
  final String sumur_n2;
  final String mataair_n2;
  final String permukaan_hujan_lainnya_n2;
  ...
  Data({
    ...
    required this.kemasan_n2,
    required this.leding_n2,
    required this.sumurbor_n2,
    required this.sumur_n2,
    required this.mataair_n2,
    required this.permukaan_hujan_lainnya_n2,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      kemasan_n2: json['kemasan_n2'],
      leding_n2: json['leding_n2'],
      sumurbor_n2: json['sumurbor_n2'],
      sumur_n2: json['sumur_n2'],
      mataair_n2: json['mataair_n2'],
      permukaan_hujan_lainnya_n2: json['permukaan_hujan_lainnya_n2'],
                  ...
                  rows: List<DataRow>.generate(snapshot.data!.length, (index) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                          Text(
                            data.permukaan_hujan_lainnya_n2,
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
