...
void main() => runApp(const RumahkabkotPeneranganC());

class RumahkabkotPeneranganC extends StatelessWidget {
  const RumahkabkotPeneranganC({super.key});
...
class Data {
  ...
  final String pln_n3;
  final String nonpln_n3;
  final String bukan_listrik_n3;
  ...
  Data({
    ...
    required this.pln_n3,
    required this.nonpln_n3,
    required this.bukan_listrik_n3,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      pln_n3: json['pln_n3'],
      nonpln_n3: json['nonpln_n3'],
      bukan_listrik_n3: json['bukan_listrik_n3'],
