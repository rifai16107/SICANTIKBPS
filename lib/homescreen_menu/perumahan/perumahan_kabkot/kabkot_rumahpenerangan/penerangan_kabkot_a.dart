...
void main() => runApp(const RumahkabkotPeneranganA());

class RumahkabkotPeneranganA extends StatelessWidget {
  const RumahkabkotPeneranganA({super.key});
...
class Data {
  ...
  final String pln_n1;
  final String nonpln_n1;
  final String bukan_listrik_n1;
  ...
  Data({
    ...
    required this.pln_n1,
    required this.nonpln_n1,
    required this.bukan_listrik_n1,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      pln_n1: json['pln_n1'],
      nonpln_n1: json['nonpln_n1'],
      bukan_listrik_n1: json['bukan_listrik_n1'],
