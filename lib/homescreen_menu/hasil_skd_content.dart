...
class hasilSKDContent extends StatefulWidget {
  const hasilSKDContent({Key? key}) : super(key: key);

  @override
  State<hasilSKDContent> createState() => _hasilSKDContentState();
}

class _hasilSKDContentState extends State<hasilSKDContent> {
  @override
                      ...
                      Column(
                        children: [
                          Container(
                            ...
                            child: const Text(
                              "BEBERAPA PENJELASAN DALAM SURVEI KEBUTUHAN DATA",
                              style: TextStyle(
              ...
              child: Container(
                ...
                child: const Center(
                  child: Padding(
                    ...
                    child: Text(
                      'Hasil Survei Kebutuhan Data (SKD) di\n'
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            'Hasil Survei Kebutuhan Data (SKD) Tahunan\n'
                            'di BPS Kabupaten/Kota di Jawa Tengah',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 13.5,
                              fontWeight: FontWeight.normal,
