                      ...
                      return DataRow(
                          ...
                          cells: [
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.genteng), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.bambu_kayu_sirap), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
