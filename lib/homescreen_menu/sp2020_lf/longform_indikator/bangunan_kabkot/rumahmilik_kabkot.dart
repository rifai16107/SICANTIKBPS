...
void main() => runApp(const RumahmilikKabkot());

class RumahmilikKabkot extends StatelessWidget {
  const RumahmilikKabkot({super.key});
        ...
        appBar: AppBar(
          ...
          flexibleSpace: Center(
            child: Column(
              children: const [
                Text(
                  'Jumlah Rumah Tangga Menurut Status Kepemilikan Tanah dan Bangunan Di Jawa Tengah, Hasil Pendataan Long Form SP2020',
                  style: TextStyle(
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/longform-rumahmilik');
                      ...
                      return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.milik_sendiri), 0)),
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.kontrak), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.bebas_sewa), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
