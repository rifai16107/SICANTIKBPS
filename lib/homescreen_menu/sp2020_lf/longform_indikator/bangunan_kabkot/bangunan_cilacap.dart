            ...
            if (snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  double tahanBangunanlfClp = double.parse(isilongform[index = 60].clp);
                  double tahanAtaplfClp = double.parse(isilongform[index = 61].clp);
                  double tahanDindinglfClp = double.parse(isilongform[index = 62].clp);
                  double tahanLantailfClp = double.parse(isilongform[index = 63].clp);
                  
                  double tahanBangunanlfJateng = double.parse(isilongform[index = 60].jateng);
                  double tahanAtaplfJateng = double.parse(isilongform[index = 61].jateng);
                  double tahanDindinglfJateng = double.parse(isilongform[index = 62].jateng);
                  double tahanLantailfJateng = double.parse(isilongform[index = 63].jateng);
                

                  //Grafik Ketahanan Bangunan Clp dan Jateng
                  data = [
                    _ChartData("Cilacap", tahanAtaplfClp, tahanDindinglfClp, tahanLantailfClp,  tahanBangunanlfClp),
                    _ChartData("Jawa Tengah", tahanAtaplfJateng, tahanDindinglfJateng, tahanLantailfJateng, tahanBangunanlfJateng),
                  ];
                    ...
                    child: Column(
                      children: [
                                      ...
                                      Flexible(
                                        ...
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 20, vertical: 10),
                                          child: Text(
                                            Format.convertTo(tahanDindinglfJateng, 2),
                                            textAlign: TextAlign.right,
                                            style: const TextStyle(
                                              fontSize: 13,
                                            ),
                                    ...
                                    Flexible(
                                      ...
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 20, vertical: 10),
                                        child: Text(
                                          Format.convertTo(tahanLantailfJateng, 2),
                                          textAlign: TextAlign.right,
                                          style: const TextStyle(
                                            fontSize: 13,
                                          ),
                                    ...
                                    Flexible(
                                      ...
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 20, vertical: 10),
                                        child: Text(
                                          Format.convertTo(tahanBangunanlfJateng, 2),
                                          textAlign: TextAlign.right,
                                          style: const TextStyle(
                                            fontSize: 13, fontWeight: FontWeight.bold, color: Colors.white,
                                          ),
                        ...
                        const SizedBox(
                          ...
                          style: TextStyle(fontSize: 10, color: Color.fromRGBO(6, 47, 230, 1)),
                          textAlign: TextAlign.center,
                        )),
                        SizedBox(
