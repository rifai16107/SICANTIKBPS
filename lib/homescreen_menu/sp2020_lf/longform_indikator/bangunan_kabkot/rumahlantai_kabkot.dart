                    ...
                    return DataRow(
                      ...
                      cells: [
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.marmer_granit),
                              0,
                            )),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.parket_vinil_karpet_ubin),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(
                              double.tryParse(data.semen_bata),
                              0,
                            )),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                        ...
                        DataCell(
                          Text(
                            (Format.convertTo(double.tryParse(data.tanah), 0)),
                            style: const TextStyle(
                              color: Color.fromARGB(255, 17, 17, 17),
                              fontWeight: FontWeight.normal,
                              fontSize: 12,
