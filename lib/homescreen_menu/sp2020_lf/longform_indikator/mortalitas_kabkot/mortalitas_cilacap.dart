            ...
            if (snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  double cmrlfJateng =
                      double.parse(isilongform[index = 10].jateng);
                  double u5mrlfJateng =
                      double.parse(isilongform[index = 11].jateng);

                  double imrsp2010Clp =
                      double.parse(isilongform[index = 9].clp_sp2010);
                  double imrsp2010Jateng =
                      double.parse(isilongform[index = 9].jateng_sp2010);
                  ...
                  data1 = [
                    ...
                    _ChartData1(
                        "Jawa Tengah", imrlfJateng, cmrlfJateng, u5mrlfJateng),
                  ];
