          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                //Migrasi Lifetime
                double migrasiLtclp = double.parse(isilongform[index = 12].clp);
                double migrasiLtclpPostz = double.parse(
                  isilongform[index = 13].clp,
                );
                double migrasiLtclpZ = double.parse(
                  isilongform[index = 14].clp,
                );
                double migrasiLtclpMilenial = double.parse(
                  isilongform[index = 15].clp,
                );
                double migrasiLtclpX = double.parse(
                  isilongform[index = 16].clp,
                );
                double migrasiLtclpBoomer = double.parse(
                  isilongform[index = 17].clp,
                );

                double migrasiLtjateng = double.parse(
                  isilongform[index = 12].jateng,
                );
                double migrasiLtjatengPostz = double.parse(
                  isilongform[index = 13].jateng,
                );
                double migrasiLtjatengZ = double.parse(
                  isilongform[index = 14].jateng,
                );
                double migrasiLtjatengMilenial = double.parse(
                  isilongform[index = 15].jateng,
                );
                double migrasiLtjatengX = double.parse(
                  isilongform[index = 16].jateng,
                );
                double migrasiLtjatengBoomer = double.parse(
                  isilongform[index = 17].jateng,
                );
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        Format.convertTo(migrasiLtclpPostz, 2),
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        Format.convertTo(migrasiLtjatengZ, 2),
                                        textAlign: TextAlign.right,
                                        style: const TextStyle(fontSize: 13),
                                      ),
                                    ),
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        Format.convertTo(migrasiLtclpBoomer, 2),
                                        textAlign: TextAlign.right,
                                        style: const TextStyle(fontSize: 13),
                                      ),
                                    ),
