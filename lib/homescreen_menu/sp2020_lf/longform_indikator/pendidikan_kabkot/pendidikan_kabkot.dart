...
void main() => runApp(const PendidikanKabkot());

class PendidikanKabkot extends StatelessWidget {
  const PendidikanKabkot({super.key});
                      ...
                      return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.tdk_blm_sekolah), 0)),
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.tdk_blm_tamat_sd), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.sd_sederajat), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.smp_sederajat), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.sma_sederajat), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.profesi), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
