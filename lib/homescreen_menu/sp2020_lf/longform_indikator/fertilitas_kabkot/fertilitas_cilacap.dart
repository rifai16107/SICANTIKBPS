          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double tfrsp2010Clp = double.parse(
                  isilongform[index = 0].clp_sp2010,
                );
                double tfrsp2010Jateng = double.parse(
                  isilongform[index = 0].jateng_sp2010,
                );

                double cbrlfClp = double.parse(isilongform[index = 1].clp);
                double cbrlfJateng = double.parse(
                  isilongform[index = 1].jateng,
                );

                double asfrClp_1519 = double.parse(isilongform[index = 2].clp);
                double asfrClp_2024 = double.parse(isilongform[index = 3].clp);
                double asfrClp_2529 = double.parse(isilongform[index = 4].clp);
                double asfrClp_3034 = double.parse(isilongform[index = 5].clp);
                double asfrClp_3539 = double.parse(isilongform[index = 6].clp);
                double asfrClp_4044 = double.parse(isilongform[index = 7].clp);
                double asfrClp_4549 = double.parse(isilongform[index = 8].clp);

                double asfrJateng_1519 = double.parse(
                  isilongform[index = 2].jateng,
                );
                double asfrJateng_2024 = double.parse(
                  isilongform[index = 3].jateng,
                );
                double asfrJateng_2529 = double.parse(
                  isilongform[index = 4].jateng,
                );
                double asfrJateng_3034 = double.parse(
                  isilongform[index = 5].jateng,
                );
                double asfrJateng_3539 = double.parse(
                  isilongform[index = 6].jateng,
                );
                double asfrJateng_4044 = double.parse(
                  isilongform[index = 7].jateng,
                );
                double asfrJateng_4549 = double.parse(
                  isilongform[index = 8].jateng,
                );
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        alignment: Alignment.centerLeft,
                        child: Text(
                          "Fertilitas Kabupaten Cilacap menurun dalam sepuluh tahun terakhir. Sensus Penduduk 2010 mencatat angka TFR sebesar " +
                              Format.convertTo(tfrsp2010Clp, 2) +
                              " yang berarti seorang perempuan melahirkan sekitar 2-3 anak selama masa reproduksinya. Sementara Long Form SP2020 mencatat TFR sebesar " +
                              Format.convertTo(tfrlfClp, 2) +
                              " yang berarti hanya sekitar 2 anak yang dilahirkan perempuan selama masa reprodukasinya.",
                      ...
                      Container(
                        ...
                        alignment: Alignment.centerLeft,
                        child: Text(
                          "Hasil Long Form SP2020 mencatat terdapat " +
                              Format.convertTo(cbrlfClp, 2) +
                              " kelahiran hidup diantara 1.000 penduduk Kabupaten Cilacap. Sementara untuk Provinsi Jawa Tengah tercatat " +
                              Format.convertTo(cbrlfJateng, 2) +
                              " kelahiran hidup diantara 1.000 penduduk Jawa Tengah.",
                          style: const TextStyle(
                            fontWeight: FontWeight.normal,
                            fontSize: 12,
                          ),
                        ...
                        child: SfCartesianChart(
                          ...
                          series: <CartesianSeries>[
                            ColumnSeries<_ChartData2, String>(
                              ...
                              spacing: 0.05,
                              name: 'Cilacap',
                              color: const Color.fromARGB(255, 121, 247, 109),
                            ),
                            ColumnSeries<_ChartData2, String>(
                              dataSource: data2,
                              xValueMapper: (_ChartData2 data2, _) => data2.x,
