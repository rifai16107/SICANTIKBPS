...
class PertanianPanganA extends StatefulWidget {
  ...
  @override
  State<PertanianPanganA> createState() => _PertanianPanganAState();
}
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double produktivitas1 = double.parse(
                  isipertanian[index = 0].produktivitas,
                );
                double produktivitas2 = double.parse(
                  isipertanian[index = 1].produktivitas,
                );
                double produktivitas3 = double.parse(
                  isipertanian[index = 2].produktivitas,
                );
                double produktivitas4 = double.parse(
                  isipertanian[index = 3].produktivitas,
                );
                double produktivitas5 = double.parse(
                  isipertanian[index = 4].produktivitas,
                );
                double produktivitas6 = double.parse(
                  isipertanian[index = 5].produktivitas,
                );
                double produktivitas7 = double.parse(
                  isipertanian[index = 6].produktivitas,
                );
                double produktivitas8 = double.parse(
                  isipertanian[index = 7].produktivitas,
                );

                double produksi1 = double.parse(
                  isipertanian[index = 0].produksi,
                );
                double produksi2 = double.parse(
                  isipertanian[index = 1].produksi,
                );
                double produksi3 = double.parse(
                  isipertanian[index = 2].produksi,
                );
                double produksi4 = double.parse(
                  isipertanian[index = 3].produksi,
                );
                double produksi5 = double.parse(
                  isipertanian[index = 4].produksi,
                );
                double produksi6 = double.parse(
                  isipertanian[index = 5].produksi,
                );
                double produksi7 = double.parse(
                  isipertanian[index = 6].produksi,
                );
                double produksi8 = double.parse(
                  isipertanian[index = 7].produksi,
                );
