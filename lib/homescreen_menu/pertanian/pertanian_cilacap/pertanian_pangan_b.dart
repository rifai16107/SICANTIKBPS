...
class PertanianPanganB extends StatefulWidget {
  ...
  @override
  State<PertanianPanganB> createState() => _PertanianPanganBState();
}
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                String tanaman1 =
                    "  1. " + isipertanian[index = 8].jenis_tanaman;
                String tanaman2 =
                    "  2. " + isipertanian[index = 9].jenis_tanaman;
                String tanaman3 =
                    "  3. " + isipertanian[index = 10].jenis_tanaman;
                String tanaman4 =
                    "  4. " + isipertanian[index = 11].jenis_tanaman;
                String tanaman5 =
                    "  5. " + isipertanian[index = 12].jenis_tanaman;
                String tanaman6 =
                    "  6. " + isipertanian[index = 13].jenis_tanaman;
                String tanaman7 =
                    "  7. " + isipertanian[index = 14].jenis_tanaman;
                String tanaman8 =
                    "  8. " + isipertanian[index = 15].jenis_tanaman;
                ...
                double produktivitas1 = double.parse(
                  isipertanian[index = 8].produktivitas,
                );
                double produktivitas2 = double.parse(
                  isipertanian[index = 9].produktivitas,
                );
                double produktivitas3 = double.parse(
                  isipertanian[index = 10].produktivitas,
                );
                double produktivitas4 = double.parse(
                  isipertanian[index = 11].produktivitas,
                );
                double produktivitas5 = double.parse(
                  isipertanian[index = 12].produktivitas,
                );
                double produktivitas6 = double.parse(
                  isipertanian[index = 13].produktivitas,
                );
                double produktivitas7 = double.parse(
                  isipertanian[index = 14].produktivitas,
                );
                double produktivitas8 = double.parse(
                  isipertanian[index = 15].produktivitas,
                );

                double produksi1 = double.parse(
                  isipertanian[index = 8].produksi,
                );
                double produksi2 = double.parse(
                  isipertanian[index = 9].produksi,
                );
                double produksi3 = double.parse(
                  isipertanian[index = 10].produksi,
                );
                double produksi4 = double.parse(
                  isipertanian[index = 11].produksi,
                );
                double produksi5 = double.parse(
                  isipertanian[index = 12].produksi,
                );
                double produksi6 = double.parse(
                  isipertanian[index = 13].produksi,
                );
                double produksi7 = double.parse(
                  isipertanian[index = 14].produksi,
                );
                double produksi8 = double.parse(
                  isipertanian[index = 15].produksi,
                );
