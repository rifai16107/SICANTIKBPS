...
class PertanianHortiSemusimB extends StatefulWidget {
  const PertanianHortiSemusimB({Key? key}) : super(key: key);

  @override
  State<PertanianHortiSemusimB> createState() => _PertanianHortiSemusimBState();
}

RepositoryPertanianHortiSemusim repositorypertanian =
    RepositoryPertanianHortiSemusim();

class _PertanianHortiSemusimBState extends State<PertanianHortiSemusimB> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String produksi_satuan1 = isipertanian[index = 0].produksi_satuan;
              String produksi_satuan2 = isipertanian[index = 1].produksi_satuan;
              String produksi_satuan3 = isipertanian[index = 2].produksi_satuan;
              String produksi_satuan4 = isipertanian[index = 3].produksi_satuan;
              String produksi_satuan5 = isipertanian[index = 4].produksi_satuan;
              String produksi_satuan6 = isipertanian[index = 5].produksi_satuan;
              String produksi_satuan7 = isipertanian[index = 6].produksi_satuan;
              String produksi_satuan8 = isipertanian[index = 7].produksi_satuan;
              String produksi_satuan9 = isipertanian[index = 8].produksi_satuan;
              ...
              String produksi_satuan26 =
                  isipertanian[index = 25].produksi_satuan;
              ...
              double prod_thn1_16 =
                  double.parse(isipertanian[index = 15].prod_thn1);
              double prod_thn1_17 =
                  double.parse(isipertanian[index = 16].prod_thn1);
              double prod_thn1_18 =
                  double.parse(isipertanian[index = 17].prod_thn1);
              double prod_thn1_19 =
                  double.parse(isipertanian[index = 18].prod_thn1);
              double prod_thn1_20 =
                  double.parse(isipertanian[index = 19].prod_thn1);
              double prod_thn1_21 =
                  double.parse(isipertanian[index = 20].prod_thn1);
              double prod_thn1_22 =
                  double.parse(isipertanian[index = 21].prod_thn1);
              double prod_thn1_23 =
                  double.parse(isipertanian[index = 22].prod_thn1);
              double prod_thn1_24 =
                  double.parse(isipertanian[index = 23].prod_thn1);
              double prod_thn1_25 =
                  double.parse(isipertanian[index = 24].prod_thn1);
              double prod_thn1_26 =
                  double.parse(isipertanian[index = 25].prod_thn1);
              ...
              double prod_thn2_16 =
                  double.parse(isipertanian[index = 15].prod_thn2);
              double prod_thn2_17 =
                  double.parse(isipertanian[index = 16].prod_thn2);
              double prod_thn2_18 =
                  double.parse(isipertanian[index = 17].prod_thn2);
              double prod_thn2_19 =
                  double.parse(isipertanian[index = 18].prod_thn2);
              double prod_thn2_20 =
                  double.parse(isipertanian[index = 19].prod_thn2);
              double prod_thn2_21 =
                  double.parse(isipertanian[index = 20].prod_thn2);
              double prod_thn2_22 =
                  double.parse(isipertanian[index = 21].prod_thn2);
              double prod_thn2_23 =
                  double.parse(isipertanian[index = 22].prod_thn2);
              double prod_thn2_24 =
                  double.parse(isipertanian[index = 23].prod_thn2);
              double prod_thn2_25 =
                  double.parse(isipertanian[index = 24].prod_thn2);
              double prod_thn2_26 =
                  double.parse(isipertanian[index = 25].prod_thn2);
              ...
              double prod_thn3_16 =
                  double.parse(isipertanian[index = 15].prod_thn3);
              double prod_thn3_17 =
                  double.parse(isipertanian[index = 16].prod_thn3);
              double prod_thn3_18 =
                  double.parse(isipertanian[index = 17].prod_thn3);
              double prod_thn3_19 =
                  double.parse(isipertanian[index = 18].prod_thn3);
              double prod_thn3_20 =
                  double.parse(isipertanian[index = 19].prod_thn3);
              double prod_thn3_21 =
                  double.parse(isipertanian[index = 20].prod_thn3);
              double prod_thn3_22 =
                  double.parse(isipertanian[index = 21].prod_thn3);
              double prod_thn3_23 =
                  double.parse(isipertanian[index = 22].prod_thn3);
              double prod_thn3_24 =
                  double.parse(isipertanian[index = 23].prod_thn3);
              double prod_thn3_25 =
                  double.parse(isipertanian[index = 24].prod_thn3);
              double prod_thn3_26 =
                  double.parse(isipertanian[index = 25].prod_thn3);
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_26, 0),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_26, 0),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_26, 0),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                              ],
