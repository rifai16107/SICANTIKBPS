          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double prod_thn1_26 = double.parse(
                  isipertanian[index = 25].prod_thn1,
                );
                ...
                double prod_thn2_26 = double.parse(
                  isipertanian[index = 25].prod_thn2,
                );
                ...
                double prod_thn3_26 = double.parse(
                  isipertanian[index = 25].prod_thn3,
                );
