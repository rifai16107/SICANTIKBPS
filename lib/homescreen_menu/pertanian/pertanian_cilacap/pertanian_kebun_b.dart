...
class PertanianKebunB extends StatefulWidget {
  const PertanianKebunB({Key? key}) : super(key: key);

  @override
  State<PertanianKebunB> createState() => _PertanianKebunBState();
}

RepositoryPertanianKebun repositorypertanian = RepositoryPertanianKebun();

class _PertanianKebunBState extends State<PertanianKebunB> {
  @override
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_1, 2),
                                    style: const TextStyle(fontSize: 13),
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_1, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_1, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_2, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_2, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_2, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_3, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_3, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_3, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_4, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_4, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_4, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_5, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_5, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_5, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_6, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_6, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_6, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_7, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_7, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_7, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_8, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_8, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_8, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_9, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_9, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_9, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_10, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_10, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_10, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_11, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_11, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_11, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_12, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_12, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_12, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn1_13, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn2_13, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
                                Flexible(
                                  ...
                                  flex: 2,
                                  child: Text(
                                    Format.convertTo(prod_thn3_13, 2),
                                    style: const TextStyle(fontSize: 13),
                                    textAlign: TextAlign.right,
                                  ),
                                ),
