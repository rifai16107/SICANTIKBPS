...
class JumlahPendudukKabkotC extends StatefulWidget {
  const JumlahPendudukKabkotC({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKabkotC> createState() => _JumlahPendudukKabkotCState();
}

RepositoryJumlahPendudukKabkot jumlahPendudukKabkot =
    RepositoryJumlahPendudukKabkot();

class _JumlahPendudukKabkotCState extends State<JumlahPendudukKabkotC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkabkot[index = 0].lk3);
              int lk2 = int.parse(isipendudukkabkot[index = 1].lk3);
              int lk3 = int.parse(isipendudukkabkot[index = 2].lk3);
              int lk4 = int.parse(isipendudukkabkot[index = 3].lk3);
              int lk5 = int.parse(isipendudukkabkot[index = 4].lk3);
              int lk6 = int.parse(isipendudukkabkot[index = 5].lk3);
              int lk7 = int.parse(isipendudukkabkot[index = 6].lk3);
              int lk8 = int.parse(isipendudukkabkot[index = 7].lk3);
              int lk9 = int.parse(isipendudukkabkot[index = 8].lk3);
              int lk10 = int.parse(isipendudukkabkot[index = 9].lk3);
              int lk11 = int.parse(isipendudukkabkot[index = 10].lk3);
              int lk12 = int.parse(isipendudukkabkot[index = 11].lk3);
              int lk13 = int.parse(isipendudukkabkot[index = 12].lk3);
              int lk14 = int.parse(isipendudukkabkot[index = 13].lk3);
              int lk15 = int.parse(isipendudukkabkot[index = 14].lk3);
              int lk16 = int.parse(isipendudukkabkot[index = 15].lk3);
              int lk17 = int.parse(isipendudukkabkot[index = 16].lk3);
              int lk18 = int.parse(isipendudukkabkot[index = 17].lk3);
              int lk19 = int.parse(isipendudukkabkot[index = 18].lk3);
              int lk20 = int.parse(isipendudukkabkot[index = 19].lk3);
              int lk21 = int.parse(isipendudukkabkot[index = 20].lk3);
              int lk22 = int.parse(isipendudukkabkot[index = 21].lk3);
              int lk23 = int.parse(isipendudukkabkot[index = 22].lk3);
              int lk24 = int.parse(isipendudukkabkot[index = 23].lk3);
              int lk25 = int.parse(isipendudukkabkot[index = 24].lk3);
              int lk26 = int.parse(isipendudukkabkot[index = 25].lk3);
              int lk27 = int.parse(isipendudukkabkot[index = 26].lk3);
              int lk28 = int.parse(isipendudukkabkot[index = 27].lk3);
              int lk29 = int.parse(isipendudukkabkot[index = 28].lk3);
              int lk30 = int.parse(isipendudukkabkot[index = 29].lk3);
              int lk31 = int.parse(isipendudukkabkot[index = 30].lk3);
              int lk32 = int.parse(isipendudukkabkot[index = 31].lk3);
              int lk33 = int.parse(isipendudukkabkot[index = 32].lk3);
              int lk34 = int.parse(isipendudukkabkot[index = 33].lk3);
              int lk35 = int.parse(isipendudukkabkot[index = 34].lk3);
              int lkTotal = int.parse(isipendudukkabkot[index = 35].lk3);

              int pr1 = int.parse(isipendudukkabkot[index = 0].pr3);
              int pr2 = int.parse(isipendudukkabkot[index = 1].pr3);
              int pr3 = int.parse(isipendudukkabkot[index = 2].pr3);
              int pr4 = int.parse(isipendudukkabkot[index = 3].pr3);
              int pr5 = int.parse(isipendudukkabkot[index = 4].pr3);
              int pr6 = int.parse(isipendudukkabkot[index = 5].pr3);
              int pr7 = int.parse(isipendudukkabkot[index = 6].pr3);
              int pr8 = int.parse(isipendudukkabkot[index = 7].pr3);
              int pr9 = int.parse(isipendudukkabkot[index = 8].pr3);
              int pr10 = int.parse(isipendudukkabkot[index = 9].pr3);
              int pr11 = int.parse(isipendudukkabkot[index = 10].pr3);
              int pr12 = int.parse(isipendudukkabkot[index = 11].pr3);
              int pr13 = int.parse(isipendudukkabkot[index = 12].pr3);
              int pr14 = int.parse(isipendudukkabkot[index = 13].pr3);
              int pr15 = int.parse(isipendudukkabkot[index = 14].pr3);
              int pr16 = int.parse(isipendudukkabkot[index = 15].pr3);
              int pr17 = int.parse(isipendudukkabkot[index = 16].pr3);
              int pr18 = int.parse(isipendudukkabkot[index = 17].pr3);
              int pr19 = int.parse(isipendudukkabkot[index = 18].pr3);
              int pr20 = int.parse(isipendudukkabkot[index = 19].pr3);
              int pr21 = int.parse(isipendudukkabkot[index = 20].pr3);
              int pr22 = int.parse(isipendudukkabkot[index = 21].pr3);
              int pr23 = int.parse(isipendudukkabkot[index = 22].pr3);
              int pr24 = int.parse(isipendudukkabkot[index = 23].pr3);
              int pr25 = int.parse(isipendudukkabkot[index = 24].pr3);
              int pr26 = int.parse(isipendudukkabkot[index = 25].pr3);
              int pr27 = int.parse(isipendudukkabkot[index = 26].pr3);
              int pr28 = int.parse(isipendudukkabkot[index = 27].pr3);
              int pr29 = int.parse(isipendudukkabkot[index = 28].pr3);
              int pr30 = int.parse(isipendudukkabkot[index = 29].pr3);
              int pr31 = int.parse(isipendudukkabkot[index = 30].pr3);
              int pr32 = int.parse(isipendudukkabkot[index = 31].pr3);
              int pr33 = int.parse(isipendudukkabkot[index = 32].pr3);
              int pr34 = int.parse(isipendudukkabkot[index = 33].pr3);
              int pr35 = int.parse(isipendudukkabkot[index = 34].pr3);
              int prTotal = int.parse(isipendudukkabkot[index = 35].pr3);
