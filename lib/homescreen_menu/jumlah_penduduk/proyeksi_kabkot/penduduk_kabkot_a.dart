...
class JumlahPendudukKabkotA extends StatefulWidget {
  const JumlahPendudukKabkotA({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKabkotA> createState() => _JumlahPendudukKabkotAState();
}

RepositoryJumlahPendudukKabkot jumlahPendudukKabkot =
    RepositoryJumlahPendudukKabkot();

class _JumlahPendudukKabkotAState extends State<JumlahPendudukKabkotA> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkabkot[index = 0].lk1);
              int lk2 = int.parse(isipendudukkabkot[index = 1].lk1);
              int lk3 = int.parse(isipendudukkabkot[index = 2].lk1);
              int lk4 = int.parse(isipendudukkabkot[index = 3].lk1);
              int lk5 = int.parse(isipendudukkabkot[index = 4].lk1);
              int lk6 = int.parse(isipendudukkabkot[index = 5].lk1);
              int lk7 = int.parse(isipendudukkabkot[index = 6].lk1);
              int lk8 = int.parse(isipendudukkabkot[index = 7].lk1);
              int lk9 = int.parse(isipendudukkabkot[index = 8].lk1);
              int lk10 = int.parse(isipendudukkabkot[index = 9].lk1);
              int lk11 = int.parse(isipendudukkabkot[index = 10].lk1);
              int lk12 = int.parse(isipendudukkabkot[index = 11].lk1);
              int lk13 = int.parse(isipendudukkabkot[index = 12].lk1);
              int lk14 = int.parse(isipendudukkabkot[index = 13].lk1);
              int lk15 = int.parse(isipendudukkabkot[index = 14].lk1);
              int lk16 = int.parse(isipendudukkabkot[index = 15].lk1);
              int lk17 = int.parse(isipendudukkabkot[index = 16].lk1);
              int lk18 = int.parse(isipendudukkabkot[index = 17].lk1);
              int lk19 = int.parse(isipendudukkabkot[index = 18].lk1);
              int lk20 = int.parse(isipendudukkabkot[index = 19].lk1);
              int lk21 = int.parse(isipendudukkabkot[index = 20].lk1);
              int lk22 = int.parse(isipendudukkabkot[index = 21].lk1);
              int lk23 = int.parse(isipendudukkabkot[index = 22].lk1);
              int lk24 = int.parse(isipendudukkabkot[index = 23].lk1);
              int lk25 = int.parse(isipendudukkabkot[index = 24].lk1);
              int lk26 = int.parse(isipendudukkabkot[index = 25].lk1);
              int lk27 = int.parse(isipendudukkabkot[index = 26].lk1);
              int lk28 = int.parse(isipendudukkabkot[index = 27].lk1);
              int lk29 = int.parse(isipendudukkabkot[index = 28].lk1);
              int lk30 = int.parse(isipendudukkabkot[index = 29].lk1);
              int lk31 = int.parse(isipendudukkabkot[index = 30].lk1);
              int lk32 = int.parse(isipendudukkabkot[index = 31].lk1);
              int lk33 = int.parse(isipendudukkabkot[index = 32].lk1);
              int lk34 = int.parse(isipendudukkabkot[index = 33].lk1);
              int lk35 = int.parse(isipendudukkabkot[index = 34].lk1);
              int lkTotal = int.parse(isipendudukkabkot[index = 35].lk1);

              int pr1 = int.parse(isipendudukkabkot[index = 0].pr1);
              int pr2 = int.parse(isipendudukkabkot[index = 1].pr1);
              int pr3 = int.parse(isipendudukkabkot[index = 2].pr1);
              int pr4 = int.parse(isipendudukkabkot[index = 3].pr1);
              int pr5 = int.parse(isipendudukkabkot[index = 4].pr1);
              int pr6 = int.parse(isipendudukkabkot[index = 5].pr1);
              int pr7 = int.parse(isipendudukkabkot[index = 6].pr1);
              int pr8 = int.parse(isipendudukkabkot[index = 7].pr1);
              int pr9 = int.parse(isipendudukkabkot[index = 8].pr1);
              int pr10 = int.parse(isipendudukkabkot[index = 9].pr1);
              int pr11 = int.parse(isipendudukkabkot[index = 10].pr1);
              int pr12 = int.parse(isipendudukkabkot[index = 11].pr1);
              int pr13 = int.parse(isipendudukkabkot[index = 12].pr1);
              int pr14 = int.parse(isipendudukkabkot[index = 13].pr1);
              int pr15 = int.parse(isipendudukkabkot[index = 14].pr1);
              int pr16 = int.parse(isipendudukkabkot[index = 15].pr1);
              int pr17 = int.parse(isipendudukkabkot[index = 16].pr1);
              int pr18 = int.parse(isipendudukkabkot[index = 17].pr1);
              int pr19 = int.parse(isipendudukkabkot[index = 18].pr1);
              int pr20 = int.parse(isipendudukkabkot[index = 19].pr1);
              int pr21 = int.parse(isipendudukkabkot[index = 20].pr1);
              int pr22 = int.parse(isipendudukkabkot[index = 21].pr1);
              int pr23 = int.parse(isipendudukkabkot[index = 22].pr1);
              int pr24 = int.parse(isipendudukkabkot[index = 23].pr1);
              int pr25 = int.parse(isipendudukkabkot[index = 24].pr1);
              int pr26 = int.parse(isipendudukkabkot[index = 25].pr1);
              int pr27 = int.parse(isipendudukkabkot[index = 26].pr1);
              int pr28 = int.parse(isipendudukkabkot[index = 27].pr1);
              int pr29 = int.parse(isipendudukkabkot[index = 28].pr1);
              int pr30 = int.parse(isipendudukkabkot[index = 29].pr1);
              int pr31 = int.parse(isipendudukkabkot[index = 30].pr1);
              int pr32 = int.parse(isipendudukkabkot[index = 31].pr1);
              int pr33 = int.parse(isipendudukkabkot[index = 32].pr1);
              int pr34 = int.parse(isipendudukkabkot[index = 33].pr1);
              int pr35 = int.parse(isipendudukkabkot[index = 34].pr1);
              int prTotal = int.parse(isipendudukkabkot[index = 35].pr1);
