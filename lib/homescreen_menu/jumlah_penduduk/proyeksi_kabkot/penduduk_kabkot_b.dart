...
class JumlahPendudukKabkotB extends StatefulWidget {
  const JumlahPendudukKabkotB({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKabkotB> createState() => _JumlahPendudukKabkotBState();
}

RepositoryJumlahPendudukKabkot jumlahPendudukKabkot =
    RepositoryJumlahPendudukKabkot();

class _JumlahPendudukKabkotBState extends State<JumlahPendudukKabkotB> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkabkot[index = 0].lk2);
              int lk2 = int.parse(isipendudukkabkot[index = 1].lk2);
              int lk3 = int.parse(isipendudukkabkot[index = 2].lk2);
              int lk4 = int.parse(isipendudukkabkot[index = 3].lk2);
              int lk5 = int.parse(isipendudukkabkot[index = 4].lk2);
              int lk6 = int.parse(isipendudukkabkot[index = 5].lk2);
              int lk7 = int.parse(isipendudukkabkot[index = 6].lk2);
              int lk8 = int.parse(isipendudukkabkot[index = 7].lk2);
              int lk9 = int.parse(isipendudukkabkot[index = 8].lk2);
              int lk10 = int.parse(isipendudukkabkot[index = 9].lk2);
              int lk11 = int.parse(isipendudukkabkot[index = 10].lk2);
              int lk12 = int.parse(isipendudukkabkot[index = 11].lk2);
              int lk13 = int.parse(isipendudukkabkot[index = 12].lk2);
              int lk14 = int.parse(isipendudukkabkot[index = 13].lk2);
              int lk15 = int.parse(isipendudukkabkot[index = 14].lk2);
              int lk16 = int.parse(isipendudukkabkot[index = 15].lk2);
              int lk17 = int.parse(isipendudukkabkot[index = 16].lk2);
              int lk18 = int.parse(isipendudukkabkot[index = 17].lk2);
              int lk19 = int.parse(isipendudukkabkot[index = 18].lk2);
              int lk20 = int.parse(isipendudukkabkot[index = 19].lk2);
              int lk21 = int.parse(isipendudukkabkot[index = 20].lk2);
              int lk22 = int.parse(isipendudukkabkot[index = 21].lk2);
              int lk23 = int.parse(isipendudukkabkot[index = 22].lk2);
              int lk24 = int.parse(isipendudukkabkot[index = 23].lk2);
              int lk25 = int.parse(isipendudukkabkot[index = 24].lk2);
              int lk26 = int.parse(isipendudukkabkot[index = 25].lk2);
              int lk27 = int.parse(isipendudukkabkot[index = 26].lk2);
              int lk28 = int.parse(isipendudukkabkot[index = 27].lk2);
              int lk29 = int.parse(isipendudukkabkot[index = 28].lk2);
              int lk30 = int.parse(isipendudukkabkot[index = 29].lk2);
              int lk31 = int.parse(isipendudukkabkot[index = 30].lk2);
              int lk32 = int.parse(isipendudukkabkot[index = 31].lk2);
              int lk33 = int.parse(isipendudukkabkot[index = 32].lk2);
              int lk34 = int.parse(isipendudukkabkot[index = 33].lk2);
              int lk35 = int.parse(isipendudukkabkot[index = 34].lk2);
              int lkTotal = int.parse(isipendudukkabkot[index = 35].lk2);

              int pr1 = int.parse(isipendudukkabkot[index = 0].pr2);
              int pr2 = int.parse(isipendudukkabkot[index = 1].pr2);
              int pr3 = int.parse(isipendudukkabkot[index = 2].pr2);
              int pr4 = int.parse(isipendudukkabkot[index = 3].pr2);
              int pr5 = int.parse(isipendudukkabkot[index = 4].pr2);
              int pr6 = int.parse(isipendudukkabkot[index = 5].pr2);
              int pr7 = int.parse(isipendudukkabkot[index = 6].pr2);
              int pr8 = int.parse(isipendudukkabkot[index = 7].pr2);
              int pr9 = int.parse(isipendudukkabkot[index = 8].pr2);
              int pr10 = int.parse(isipendudukkabkot[index = 9].pr2);
              int pr11 = int.parse(isipendudukkabkot[index = 10].pr2);
              int pr12 = int.parse(isipendudukkabkot[index = 11].pr2);
              int pr13 = int.parse(isipendudukkabkot[index = 12].pr2);
              int pr14 = int.parse(isipendudukkabkot[index = 13].pr2);
              int pr15 = int.parse(isipendudukkabkot[index = 14].pr2);
              int pr16 = int.parse(isipendudukkabkot[index = 15].pr2);
              int pr17 = int.parse(isipendudukkabkot[index = 16].pr2);
              int pr18 = int.parse(isipendudukkabkot[index = 17].pr2);
              int pr19 = int.parse(isipendudukkabkot[index = 18].pr2);
              int pr20 = int.parse(isipendudukkabkot[index = 19].pr2);
              int pr21 = int.parse(isipendudukkabkot[index = 20].pr2);
              int pr22 = int.parse(isipendudukkabkot[index = 21].pr2);
              int pr23 = int.parse(isipendudukkabkot[index = 22].pr2);
              int pr24 = int.parse(isipendudukkabkot[index = 23].pr2);
              int pr25 = int.parse(isipendudukkabkot[index = 24].pr2);
              int pr26 = int.parse(isipendudukkabkot[index = 25].pr2);
              int pr27 = int.parse(isipendudukkabkot[index = 26].pr2);
              int pr28 = int.parse(isipendudukkabkot[index = 27].pr2);
              int pr29 = int.parse(isipendudukkabkot[index = 28].pr2);
              int pr30 = int.parse(isipendudukkabkot[index = 29].pr2);
              int pr31 = int.parse(isipendudukkabkot[index = 30].pr2);
              int pr32 = int.parse(isipendudukkabkot[index = 31].pr2);
              int pr33 = int.parse(isipendudukkabkot[index = 32].pr2);
              int pr34 = int.parse(isipendudukkabkot[index = 33].pr2);
              int pr35 = int.parse(isipendudukkabkot[index = 34].pr2);
              int prTotal = int.parse(isipendudukkabkot[index = 35].pr2);
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: const Text(
                              " Sumber Data : Hasil Sensus Penduduk 2020",
                              style: TextStyle(
