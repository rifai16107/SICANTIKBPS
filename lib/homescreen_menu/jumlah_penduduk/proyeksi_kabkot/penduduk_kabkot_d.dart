...
class JumlahPendudukKabkotD extends StatefulWidget {
  const JumlahPendudukKabkotD({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKabkotD> createState() => _JumlahPendudukKabkotDState();
}

RepositoryJumlahPendudukKabkot jumlahPendudukKabkot =
    RepositoryJumlahPendudukKabkot();

class _JumlahPendudukKabkotDState extends State<JumlahPendudukKabkotD> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkabkot[index = 0].lk4);
              int lk2 = int.parse(isipendudukkabkot[index = 1].lk4);
              int lk3 = int.parse(isipendudukkabkot[index = 2].lk4);
              int lk4 = int.parse(isipendudukkabkot[index = 3].lk4);
              int lk5 = int.parse(isipendudukkabkot[index = 4].lk4);
              int lk6 = int.parse(isipendudukkabkot[index = 5].lk4);
              int lk7 = int.parse(isipendudukkabkot[index = 6].lk4);
              int lk8 = int.parse(isipendudukkabkot[index = 7].lk4);
              int lk9 = int.parse(isipendudukkabkot[index = 8].lk4);
              int lk10 = int.parse(isipendudukkabkot[index = 9].lk4);
              int lk11 = int.parse(isipendudukkabkot[index = 10].lk4);
              int lk12 = int.parse(isipendudukkabkot[index = 11].lk4);
              int lk13 = int.parse(isipendudukkabkot[index = 12].lk4);
              int lk14 = int.parse(isipendudukkabkot[index = 13].lk4);
              int lk15 = int.parse(isipendudukkabkot[index = 14].lk4);
              int lk16 = int.parse(isipendudukkabkot[index = 15].lk4);
              int lk17 = int.parse(isipendudukkabkot[index = 16].lk4);
              int lk18 = int.parse(isipendudukkabkot[index = 17].lk4);
              int lk19 = int.parse(isipendudukkabkot[index = 18].lk4);
              int lk20 = int.parse(isipendudukkabkot[index = 19].lk4);
              int lk21 = int.parse(isipendudukkabkot[index = 20].lk4);
              int lk22 = int.parse(isipendudukkabkot[index = 21].lk4);
              int lk23 = int.parse(isipendudukkabkot[index = 22].lk4);
              int lk24 = int.parse(isipendudukkabkot[index = 23].lk4);
              int lk25 = int.parse(isipendudukkabkot[index = 24].lk4);
              int lk26 = int.parse(isipendudukkabkot[index = 25].lk4);
              int lk27 = int.parse(isipendudukkabkot[index = 26].lk4);
              int lk28 = int.parse(isipendudukkabkot[index = 27].lk4);
              int lk29 = int.parse(isipendudukkabkot[index = 28].lk4);
              int lk30 = int.parse(isipendudukkabkot[index = 29].lk4);
              int lk31 = int.parse(isipendudukkabkot[index = 30].lk4);
              int lk32 = int.parse(isipendudukkabkot[index = 31].lk4);
              int lk33 = int.parse(isipendudukkabkot[index = 32].lk4);
              int lk34 = int.parse(isipendudukkabkot[index = 33].lk4);
              int lk35 = int.parse(isipendudukkabkot[index = 34].lk4);
              int lkTotal = int.parse(isipendudukkabkot[index = 35].lk4);

              int pr1 = int.parse(isipendudukkabkot[index = 0].pr4);
              int pr2 = int.parse(isipendudukkabkot[index = 1].pr4);
              int pr3 = int.parse(isipendudukkabkot[index = 2].pr4);
              int pr4 = int.parse(isipendudukkabkot[index = 3].pr4);
              int pr5 = int.parse(isipendudukkabkot[index = 4].pr4);
              int pr6 = int.parse(isipendudukkabkot[index = 5].pr4);
              int pr7 = int.parse(isipendudukkabkot[index = 6].pr4);
              int pr8 = int.parse(isipendudukkabkot[index = 7].pr4);
              int pr9 = int.parse(isipendudukkabkot[index = 8].pr4);
              int pr10 = int.parse(isipendudukkabkot[index = 9].pr4);
              int pr11 = int.parse(isipendudukkabkot[index = 10].pr4);
              int pr12 = int.parse(isipendudukkabkot[index = 11].pr4);
              int pr13 = int.parse(isipendudukkabkot[index = 12].pr4);
              int pr14 = int.parse(isipendudukkabkot[index = 13].pr4);
              int pr15 = int.parse(isipendudukkabkot[index = 14].pr4);
              int pr16 = int.parse(isipendudukkabkot[index = 15].pr4);
              int pr17 = int.parse(isipendudukkabkot[index = 16].pr4);
              int pr18 = int.parse(isipendudukkabkot[index = 17].pr4);
              int pr19 = int.parse(isipendudukkabkot[index = 18].pr4);
              int pr20 = int.parse(isipendudukkabkot[index = 19].pr4);
              int pr21 = int.parse(isipendudukkabkot[index = 20].pr4);
              int pr22 = int.parse(isipendudukkabkot[index = 21].pr4);
              int pr23 = int.parse(isipendudukkabkot[index = 22].pr4);
              int pr24 = int.parse(isipendudukkabkot[index = 23].pr4);
              int pr25 = int.parse(isipendudukkabkot[index = 24].pr4);
              int pr26 = int.parse(isipendudukkabkot[index = 25].pr4);
              int pr27 = int.parse(isipendudukkabkot[index = 26].pr4);
              int pr28 = int.parse(isipendudukkabkot[index = 27].pr4);
              int pr29 = int.parse(isipendudukkabkot[index = 28].pr4);
              int pr30 = int.parse(isipendudukkabkot[index = 29].pr4);
              int pr31 = int.parse(isipendudukkabkot[index = 30].pr4);
              int pr32 = int.parse(isipendudukkabkot[index = 31].pr4);
              int pr33 = int.parse(isipendudukkabkot[index = 32].pr4);
              int pr34 = int.parse(isipendudukkabkot[index = 33].pr4);
              int pr35 = int.parse(isipendudukkabkot[index = 34].pr4);
              int prTotal = int.parse(isipendudukkabkot[index = 35].pr4);
