...
class JumlahPendudukKecamatanD extends StatefulWidget {
  const JumlahPendudukKecamatanD({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKecamatanD> createState() =>
      _JumlahPendudukKecamatanDState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _JumlahPendudukKecamatanDState extends State<JumlahPendudukKecamatanD> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lk4);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lk4);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lk4);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lk4);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lk4);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lk4);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lk4);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lk4);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lk4);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lk4);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lk4);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lk4);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lk4);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lk4);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lk4);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lk4);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lk4);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lk4);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lk4);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lk4);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lk4);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lk4);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lk4);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lk4);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lk4);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].pr4);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].pr4);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].pr4);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].pr4);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].pr4);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].pr4);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].pr4);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].pr4);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].pr4);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].pr4);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].pr4);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].pr4);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].pr4);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].pr4);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].pr4);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].pr4);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].pr4);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].pr4);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].pr4);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].pr4);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].pr4);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].pr4);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].pr4);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].pr4);
