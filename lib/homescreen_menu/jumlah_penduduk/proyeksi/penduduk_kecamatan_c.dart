...
class JumlahPendudukKecamatanC extends StatefulWidget {
  const JumlahPendudukKecamatanC({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKecamatanC> createState() =>
      _JumlahPendudukKecamatanCState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _JumlahPendudukKecamatanCState extends State<JumlahPendudukKecamatanC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lk3);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lk3);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lk3);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lk3);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lk3);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lk3);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lk3);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lk3);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lk3);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lk3);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lk3);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lk3);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lk3);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lk3);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lk3);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lk3);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lk3);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lk3);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lk3);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lk3);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lk3);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lk3);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lk3);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lk3);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lk3);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].pr3);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].pr3);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].pr3);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].pr3);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].pr3);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].pr3);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].pr3);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].pr3);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].pr3);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].pr3);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].pr3);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].pr3);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].pr3);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].pr3);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].pr3);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].pr3);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].pr3);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].pr3);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].pr3);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].pr3);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].pr3);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].pr3);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].pr3);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].pr3);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].pr3);
