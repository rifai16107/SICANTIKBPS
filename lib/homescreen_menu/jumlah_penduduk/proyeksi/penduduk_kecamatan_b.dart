...
class JumlahPendudukKecamatanB extends StatefulWidget {
  const JumlahPendudukKecamatanB({Key? key}) : super(key: key);

  @override
  State<JumlahPendudukKecamatanB> createState() =>
      _JumlahPendudukKecamatanBState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _JumlahPendudukKecamatanBState extends State<JumlahPendudukKecamatanB> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lk2);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lk2);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lk2);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lk2);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lk2);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lk2);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lk2);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lk2);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lk2);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lk2);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lk2);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lk2);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lk2);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lk2);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lk2);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lk2);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lk2);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lk2);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lk2);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lk2);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lk2);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lk2);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lk2);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lk2);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lk2);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].pr2);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].pr2);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].pr2);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].pr2);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].pr2);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].pr2);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].pr2);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].pr2);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].pr2);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].pr2);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].pr2);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].pr2);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].pr2);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].pr2);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].pr2);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].pr2);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].pr2);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].pr2);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].pr2);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].pr2);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].pr2);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].pr2);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].pr2);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].pr2);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].pr2);
