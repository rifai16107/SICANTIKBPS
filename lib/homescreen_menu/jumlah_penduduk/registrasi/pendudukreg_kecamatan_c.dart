...
class PendudukRegKecamatanC extends StatefulWidget {
  const PendudukRegKecamatanC({Key? key}) : super(key: key);

  @override
  State<PendudukRegKecamatanC> createState() => _PendudukRegKecamatanCState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _PendudukRegKecamatanCState extends State<PendudukRegKecamatanC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lkreg3);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lkreg3);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lkreg3);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lkreg3);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lkreg3);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lkreg3);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lkreg3);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lkreg3);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lkreg3);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lkreg3);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lkreg3);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lkreg3);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lkreg3);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lkreg3);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lkreg3);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lkreg3);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lkreg3);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lkreg3);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lkreg3);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lkreg3);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lkreg3);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lkreg3);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lkreg3);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lkreg3);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lkreg3);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].prreg3);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].prreg3);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].prreg3);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].prreg3);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].prreg3);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].prreg3);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].prreg3);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].prreg3);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].prreg3);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].prreg3);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].prreg3);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].prreg3);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].prreg3);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].prreg3);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].prreg3);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].prreg3);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].prreg3);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].prreg3);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].prreg3);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].prreg3);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].prreg3);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].prreg3);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].prreg3);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].prreg3);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].prreg3);
