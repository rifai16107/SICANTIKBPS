...
class PendudukRegKecamatanA extends StatefulWidget {
  const PendudukRegKecamatanA({Key? key}) : super(key: key);

  @override
  State<PendudukRegKecamatanA> createState() => _PendudukRegKecamatanAState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _PendudukRegKecamatanAState extends State<PendudukRegKecamatanA> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lkreg1);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lkreg1);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lkreg1);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lkreg1);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lkreg1);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lkreg1);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lkreg1);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lkreg1);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lkreg1);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lkreg1);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lkreg1);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lkreg1);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lkreg1);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lkreg1);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lkreg1);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lkreg1);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lkreg1);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lkreg1);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lkreg1);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lkreg1);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lkreg1);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lkreg1);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lkreg1);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lkreg1);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lkreg1);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].prreg1);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].prreg1);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].prreg1);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].prreg1);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].prreg1);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].prreg1);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].prreg1);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].prreg1);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].prreg1);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].prreg1);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].prreg1);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].prreg1);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].prreg1);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].prreg1);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].prreg1);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].prreg1);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].prreg1);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].prreg1);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].prreg1);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].prreg1);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].prreg1);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].prreg1);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].prreg1);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].prreg1);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].prreg1);
