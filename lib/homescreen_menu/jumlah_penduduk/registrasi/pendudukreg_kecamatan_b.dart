...
class PendudukRegKecamatanB extends StatefulWidget {
  const PendudukRegKecamatanB({Key? key}) : super(key: key);

  @override
  State<PendudukRegKecamatanB> createState() => _PendudukRegKecamatanBState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _PendudukRegKecamatanBState extends State<PendudukRegKecamatanB> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lkreg2);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lkreg2);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lkreg2);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lkreg2);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lkreg2);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lkreg2);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lkreg2);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lkreg2);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lkreg2);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lkreg2);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lkreg2);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lkreg2);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lkreg2);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lkreg2);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lkreg2);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lkreg2);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lkreg2);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lkreg2);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lkreg2);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lkreg2);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lkreg2);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lkreg2);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lkreg2);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lkreg2);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lkreg2);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].prreg2);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].prreg2);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].prreg2);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].prreg2);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].prreg2);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].prreg2);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].prreg2);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].prreg2);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].prreg2);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].prreg2);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].prreg2);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].prreg2);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].prreg2);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].prreg2);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].prreg2);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].prreg2);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].prreg2);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].prreg2);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].prreg2);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].prreg2);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].prreg2);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].prreg2);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].prreg2);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].prreg2);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].prreg2);
