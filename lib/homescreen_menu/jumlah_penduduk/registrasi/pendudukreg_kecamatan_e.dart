...
class PendudukRegKecamatanE extends StatefulWidget {
  const PendudukRegKecamatanE({Key? key}) : super(key: key);

  @override
  State<PendudukRegKecamatanE> createState() => _PendudukRegKecamatanEState();
}

RepositoryJumlahPendudukKecamatan jumlahPendudukKecamatan =
    RepositoryJumlahPendudukKecamatan();

class _PendudukRegKecamatanEState extends State<PendudukRegKecamatanE> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int lk1 = int.parse(isipendudukkecamatan[index = 0].lkreg);
              int lk2 = int.parse(isipendudukkecamatan[index = 1].lkreg);
              int lk3 = int.parse(isipendudukkecamatan[index = 2].lkreg);
              int lk4 = int.parse(isipendudukkecamatan[index = 3].lkreg);
              int lk5 = int.parse(isipendudukkecamatan[index = 4].lkreg);
              int lk6 = int.parse(isipendudukkecamatan[index = 5].lkreg);
              int lk7 = int.parse(isipendudukkecamatan[index = 6].lkreg);
              int lk8 = int.parse(isipendudukkecamatan[index = 7].lkreg);
              int lk9 = int.parse(isipendudukkecamatan[index = 8].lkreg);
              int lk10 = int.parse(isipendudukkecamatan[index = 9].lkreg);
              int lk11 = int.parse(isipendudukkecamatan[index = 10].lkreg);
              int lk12 = int.parse(isipendudukkecamatan[index = 11].lkreg);
              int lk13 = int.parse(isipendudukkecamatan[index = 12].lkreg);
              int lk14 = int.parse(isipendudukkecamatan[index = 13].lkreg);
              int lk15 = int.parse(isipendudukkecamatan[index = 14].lkreg);
              int lk16 = int.parse(isipendudukkecamatan[index = 15].lkreg);
              int lk17 = int.parse(isipendudukkecamatan[index = 16].lkreg);
              int lk18 = int.parse(isipendudukkecamatan[index = 17].lkreg);
              int lk19 = int.parse(isipendudukkecamatan[index = 18].lkreg);
              int lk20 = int.parse(isipendudukkecamatan[index = 19].lkreg);
              int lk21 = int.parse(isipendudukkecamatan[index = 20].lkreg);
              int lk22 = int.parse(isipendudukkecamatan[index = 21].lkreg);
              int lk23 = int.parse(isipendudukkecamatan[index = 22].lkreg);
              int lk24 = int.parse(isipendudukkecamatan[index = 23].lkreg);
              int lkTotal = int.parse(isipendudukkecamatan[index = 24].lkreg);

              int pr1 = int.parse(isipendudukkecamatan[index = 0].prreg);
              int pr2 = int.parse(isipendudukkecamatan[index = 1].prreg);
              int pr3 = int.parse(isipendudukkecamatan[index = 2].prreg);
              int pr4 = int.parse(isipendudukkecamatan[index = 3].prreg);
              int pr5 = int.parse(isipendudukkecamatan[index = 4].prreg);
              int pr6 = int.parse(isipendudukkecamatan[index = 5].prreg);
              int pr7 = int.parse(isipendudukkecamatan[index = 6].prreg);
              int pr8 = int.parse(isipendudukkecamatan[index = 7].prreg);
              int pr9 = int.parse(isipendudukkecamatan[index = 8].prreg);
              int pr10 = int.parse(isipendudukkecamatan[index = 9].prreg);
              int pr11 = int.parse(isipendudukkecamatan[index = 10].prreg);
              int pr12 = int.parse(isipendudukkecamatan[index = 11].prreg);
              int pr13 = int.parse(isipendudukkecamatan[index = 12].prreg);
              int pr14 = int.parse(isipendudukkecamatan[index = 13].prreg);
              int pr15 = int.parse(isipendudukkecamatan[index = 14].prreg);
              int pr16 = int.parse(isipendudukkecamatan[index = 15].prreg);
              int pr17 = int.parse(isipendudukkecamatan[index = 16].prreg);
              int pr18 = int.parse(isipendudukkecamatan[index = 17].prreg);
              int pr19 = int.parse(isipendudukkecamatan[index = 18].prreg);
              int pr20 = int.parse(isipendudukkecamatan[index = 19].prreg);
              int pr21 = int.parse(isipendudukkecamatan[index = 20].prreg);
              int pr22 = int.parse(isipendudukkecamatan[index = 21].prreg);
              int pr23 = int.parse(isipendudukkecamatan[index = 22].prreg);
              int pr24 = int.parse(isipendudukkecamatan[index = 23].prreg);
              int prTotal = int.parse(isipendudukkecamatan[index = 24].prreg);
