...
class pendidikanCilacap extends StatefulWidget {
  const pendidikanCilacap({Key? key}) : super(key: key);

  @override
  State<pendidikanCilacap> createState() => _pendidikanCilacapState();
}

RepositoryApmApk repositoryapmapk = RepositoryApmApk();

class _pendidikanCilacapState extends State<pendidikanCilacap> {
  @override
