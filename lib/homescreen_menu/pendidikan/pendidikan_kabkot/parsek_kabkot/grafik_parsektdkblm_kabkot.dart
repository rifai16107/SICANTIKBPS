...
class RepositoryPendidikanKabkotParsektdkblm {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return (cokk['data'] as List)
            .map((isipendidikan) =>
                ModelPendidikanKabkotParsektdkblm.fromJson(isipendidikan))
            .toList();
      }
    } catch (isipendidikan) {
      // ignore: avoid_print
...
class ModelPendidikanKabkotParsektdkblm {
  final int id;
  final String wilayah;
  final String tdkbelum_n5;
  final String tahun;

  ModelPendidikanKabkotParsektdkblm(
      {required this.id,
      required this.wilayah,
      required this.tdkbelum_n5,
      required this.tahun});

  factory ModelPendidikanKabkotParsektdkblm.fromJson(Map<String, dynamic> json) {
    return ModelPendidikanKabkotParsektdkblm(
      id: json['id'],
...
class GrafikPendidikanKabkotParsektdkblm extends StatefulWidget {
  const GrafikPendidikanKabkotParsektdkblm({Key? key}) : super(key: key);

  @override
  _GrafikPendidikanKabkotParsektdkblmState createState() =>
      _GrafikPendidikanKabkotParsektdkblmState();
}

class _GrafikPendidikanKabkotParsektdkblmState
    extends State<GrafikPendidikanKabkotParsektdkblm> {
  RepositoryPendidikanKabkotParsektdkblm repositorypendidikan =
      RepositoryPendidikanKabkotParsektdkblm();
  int key = 0;
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double tdkbelum_1 = double.parse(isipendidikan[index = 0].tdkbelum_n5);
              double tdkbelum_2 = double.parse(isipendidikan[index = 1].tdkbelum_n5);
              double tdkbelum_3 = double.parse(isipendidikan[index = 2].tdkbelum_n5);
              double tdkbelum_4 = double.parse(isipendidikan[index = 3].tdkbelum_n5);
              double tdkbelum_5 = double.parse(isipendidikan[index = 4].tdkbelum_n5);
              double tdkbelum_6 = double.parse(isipendidikan[index = 5].tdkbelum_n5);
              double tdkbelum_7 = double.parse(isipendidikan[index = 6].tdkbelum_n5);
              double tdkbelum_8 = double.parse(isipendidikan[index = 7].tdkbelum_n5);
              double tdkbelum_9 = double.parse(isipendidikan[index = 8].tdkbelum_n5);
              double tdkbelum_10 =
              ...
              data = [
                _ChartData(
                    wilayah1, tdkbelum_1, const Color.fromARGB(255, 207, 154, 38)),
                _ChartData(
                    wilayah2, tdkbelum_2, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah3, tdkbelum_3, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah4, tdkbelum_4, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah5, tdkbelum_5, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah6, tdkbelum_6, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah7, tdkbelum_7, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah8, tdkbelum_8, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah9, tdkbelum_9, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah10, tdkbelum_10, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah11, tdkbelum_11, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah12, tdkbelum_12, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah13, tdkbelum_13, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah14, tdkbelum_14, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah15, tdkbelum_15, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah16, tdkbelum_16, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah17, tdkbelum_17, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah18, tdkbelum_18, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah19, tdkbelum_19, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah20, tdkbelum_20, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah21, tdkbelum_21, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah22, tdkbelum_22, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah23, tdkbelum_23, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah24, tdkbelum_24, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah25, tdkbelum_25, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah26, tdkbelum_26, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah27, tdkbelum_27, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah28, tdkbelum_28, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah29, tdkbelum_29, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah30, tdkbelum_30, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah31, tdkbelum_31, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah32, tdkbelum_32, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah33, tdkbelum_33, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah34, tdkbelum_34, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(
                    wilayah35, tdkbelum_35, const Color.fromRGBO(9, 0, 136, 1)),
                _ChartData(wilayah36, tdkbelum_36,
              ...
              return SizedBox(
                ...
                child: SfCartesianChart(
                    title: ChartTitle(
                        text:
                            'Persentase Penduduk Usia 5+ yang Berstatus Tidak/Belum Pernah Sekolah Menurut Kabupaten/Kota di Jawa Tengah Tahun $thn5',
                    ...
                    primaryYAxis: NumericAxis(
                        title: AxisTitle(
                            text: 'Tidak/Belum Pernah Sekolah (persen)',
                            textStyle: const TextStyle(
                              color: Color.fromARGB(255, 10, 10, 10),
                              fontFamily: 'Roboto',
                              fontStyle: FontStyle.italic,
                    ...
                    series: <CartesianSeries>[
                      BarSeries<_ChartData, String>(
                        ...
                        name: 'Tidak/Belum Pernah Sekolah (persen)',
