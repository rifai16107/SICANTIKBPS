        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //APM
              double sekolahma_1 =
                  double.parse(isipendidikan[index = 0].sekolahma_n2);
              double sekolahma_2 =
                  double.parse(isipendidikan[index = 1].sekolahma_n2);
              double sekolahma_3 =
                  double.parse(isipendidikan[index = 2].sekolahma_n2);
              double sekolahma_4 =
                  double.parse(isipendidikan[index = 3].sekolahma_n2);
              double sekolahma_5 =
                  double.parse(isipendidikan[index = 4].sekolahma_n2);
              double sekolahma_6 =
                  double.parse(isipendidikan[index = 5].sekolahma_n2);
              double sekolahma_7 =
                  double.parse(isipendidikan[index = 6].sekolahma_n2);
              double sekolahma_8 =
                  double.parse(isipendidikan[index = 7].sekolahma_n2);
              double sekolahma_9 =
                  double.parse(isipendidikan[index = 8].sekolahma_n2);
              double sekolahma_10 =
                  double.parse(isipendidikan[index = 9].sekolahma_n2);
              double sekolahma_11 =
                  double.parse(isipendidikan[index = 10].sekolahma_n2);
              double sekolahma_12 =
                  double.parse(isipendidikan[index = 11].sekolahma_n2);
              double sekolahma_13 =
                  double.parse(isipendidikan[index = 12].sekolahma_n2);
              double sekolahma_14 =
                  double.parse(isipendidikan[index = 13].sekolahma_n2);
              double sekolahma_15 =
                  double.parse(isipendidikan[index = 14].sekolahma_n2);
              double sekolahma_16 =
                  double.parse(isipendidikan[index = 15].sekolahma_n2);
              double sekolahma_17 =
                  double.parse(isipendidikan[index = 16].sekolahma_n2);
              double sekolahma_18 =
                  double.parse(isipendidikan[index = 17].sekolahma_n2);
              double sekolahma_19 =
                  double.parse(isipendidikan[index = 18].sekolahma_n2);
              double sekolahma_20 =
                  double.parse(isipendidikan[index = 19].sekolahma_n2);
              double sekolahma_21 =
                  double.parse(isipendidikan[index = 20].sekolahma_n2);
              double sekolahma_22 =
                  double.parse(isipendidikan[index = 21].sekolahma_n2);
              double sekolahma_23 =
                  double.parse(isipendidikan[index = 22].sekolahma_n2);
              double sekolahma_24 =
                  double.parse(isipendidikan[index = 23].sekolahma_n2);
              double sekolahma_25 =
                  double.parse(isipendidikan[index = 24].sekolahma_n2);
              double sekolahma_26 =
                  double.parse(isipendidikan[index = 25].sekolahma_n2);
              double sekolahma_27 =
                  double.parse(isipendidikan[index = 26].sekolahma_n2);
              double sekolahma_28 =
                  double.parse(isipendidikan[index = 27].sekolahma_n2);
              double sekolahma_29 =
                  double.parse(isipendidikan[index = 28].sekolahma_n2);
              double sekolahma_30 =
                  double.parse(isipendidikan[index = 29].sekolahma_n2);
              double sekolahma_31 =
                  double.parse(isipendidikan[index = 30].sekolahma_n2);
              double sekolahma_32 =
                  double.parse(isipendidikan[index = 31].sekolahma_n2);
              double sekolahma_33 =
                  double.parse(isipendidikan[index = 32].sekolahma_n2);
              double sekolahma_34 =
                  double.parse(isipendidikan[index = 33].sekolahma_n2);
              double sekolahma_35 =
                  double.parse(isipendidikan[index = 34].sekolahma_n2);
              double sekolahma_36 =
                  double.parse(isipendidikan[index = 35].sekolahma_n2);

              double guruma_1 =
                  double.parse(isipendidikan[index = 0].guruma_n2);
              double guruma_2 =
                  double.parse(isipendidikan[index = 1].guruma_n2);
              double guruma_3 =
                  double.parse(isipendidikan[index = 2].guruma_n2);
              double guruma_4 =
                  double.parse(isipendidikan[index = 3].guruma_n2);
              double guruma_5 =
                  double.parse(isipendidikan[index = 4].guruma_n2);
              double guruma_6 =
                  double.parse(isipendidikan[index = 5].guruma_n2);
              double guruma_7 =
                  double.parse(isipendidikan[index = 6].guruma_n2);
              double guruma_8 =
                  double.parse(isipendidikan[index = 7].guruma_n2);
              double guruma_9 =
                  double.parse(isipendidikan[index = 8].guruma_n2);
              double guruma_10 =
                  double.parse(isipendidikan[index = 9].guruma_n2);
              double guruma_11 =
                  double.parse(isipendidikan[index = 10].guruma_n2);
              double guruma_12 =
                  double.parse(isipendidikan[index = 11].guruma_n2);
              double guruma_13 =
                  double.parse(isipendidikan[index = 12].guruma_n2);
              double guruma_14 =
                  double.parse(isipendidikan[index = 13].guruma_n2);
              double guruma_15 =
                  double.parse(isipendidikan[index = 14].guruma_n2);
              double guruma_16 =
                  double.parse(isipendidikan[index = 15].guruma_n2);
              double guruma_17 =
                  double.parse(isipendidikan[index = 16].guruma_n2);
              double guruma_18 =
                  double.parse(isipendidikan[index = 17].guruma_n2);
              double guruma_19 =
                  double.parse(isipendidikan[index = 18].guruma_n2);
              double guruma_20 =
                  double.parse(isipendidikan[index = 19].guruma_n2);
              double guruma_21 =
                  double.parse(isipendidikan[index = 20].guruma_n2);
              double guruma_22 =
                  double.parse(isipendidikan[index = 21].guruma_n2);
              double guruma_23 =
                  double.parse(isipendidikan[index = 22].guruma_n2);
              double guruma_24 =
                  double.parse(isipendidikan[index = 23].guruma_n2);
              double guruma_25 =
                  double.parse(isipendidikan[index = 24].guruma_n2);
              double guruma_26 =
                  double.parse(isipendidikan[index = 25].guruma_n2);
              double guruma_27 =
                  double.parse(isipendidikan[index = 26].guruma_n2);
              double guruma_28 =
                  double.parse(isipendidikan[index = 27].guruma_n2);
              double guruma_29 =
                  double.parse(isipendidikan[index = 28].guruma_n2);
              double guruma_30 =
                  double.parse(isipendidikan[index = 29].guruma_n2);
              double guruma_31 =
                  double.parse(isipendidikan[index = 30].guruma_n2);
              double guruma_32 =
                  double.parse(isipendidikan[index = 31].guruma_n2);
              double guruma_33 =
                  double.parse(isipendidikan[index = 32].guruma_n2);
              double guruma_34 =
                  double.parse(isipendidikan[index = 33].guruma_n2);
              double guruma_35 =
                  double.parse(isipendidikan[index = 34].guruma_n2);
              double guruma_36 =
                  double.parse(isipendidikan[index = 35].guruma_n2);

              double muridma_1 =
                  double.parse(isipendidikan[index = 0].muridma_n2);
              double muridma_2 =
                  double.parse(isipendidikan[index = 1].muridma_n2);
              double muridma_3 =
                  double.parse(isipendidikan[index = 2].muridma_n2);
              double muridma_4 =
                  double.parse(isipendidikan[index = 3].muridma_n2);
              double muridma_5 =
                  double.parse(isipendidikan[index = 4].muridma_n2);
              double muridma_6 =
                  double.parse(isipendidikan[index = 5].muridma_n2);
              double muridma_7 =
                  double.parse(isipendidikan[index = 6].muridma_n2);
              double muridma_8 =
                  double.parse(isipendidikan[index = 7].muridma_n2);
              double muridma_9 =
                  double.parse(isipendidikan[index = 8].muridma_n2);
              double muridma_10 =
                  double.parse(isipendidikan[index = 9].muridma_n2);
              double muridma_11 =
                  double.parse(isipendidikan[index = 10].muridma_n2);
              double muridma_12 =
                  double.parse(isipendidikan[index = 11].muridma_n2);
              double muridma_13 =
                  double.parse(isipendidikan[index = 12].muridma_n2);
              double muridma_14 =
                  double.parse(isipendidikan[index = 13].muridma_n2);
              double muridma_15 =
                  double.parse(isipendidikan[index = 14].muridma_n2);
              double muridma_16 =
                  double.parse(isipendidikan[index = 15].muridma_n2);
              double muridma_17 =
                  double.parse(isipendidikan[index = 16].muridma_n2);
              double muridma_18 =
                  double.parse(isipendidikan[index = 17].muridma_n2);
              double muridma_19 =
                  double.parse(isipendidikan[index = 18].muridma_n2);
              double muridma_20 =
                  double.parse(isipendidikan[index = 19].muridma_n2);
              double muridma_21 =
                  double.parse(isipendidikan[index = 20].muridma_n2);
              double muridma_22 =
                  double.parse(isipendidikan[index = 21].muridma_n2);
              double muridma_23 =
                  double.parse(isipendidikan[index = 22].muridma_n2);
              double muridma_24 =
                  double.parse(isipendidikan[index = 23].muridma_n2);
              double muridma_25 =
                  double.parse(isipendidikan[index = 24].muridma_n2);
              double muridma_26 =
                  double.parse(isipendidikan[index = 25].muridma_n2);
              double muridma_27 =
                  double.parse(isipendidikan[index = 26].muridma_n2);
              double muridma_28 =
                  double.parse(isipendidikan[index = 27].muridma_n2);
              double muridma_29 =
                  double.parse(isipendidikan[index = 28].muridma_n2);
              double muridma_30 =
                  double.parse(isipendidikan[index = 29].muridma_n2);
              double muridma_31 =
                  double.parse(isipendidikan[index = 30].muridma_n2);
              double muridma_32 =
                  double.parse(isipendidikan[index = 31].muridma_n2);
              double muridma_33 =
                  double.parse(isipendidikan[index = 32].muridma_n2);
              double muridma_34 =
                  double.parse(isipendidikan[index = 33].muridma_n2);
              double muridma_35 =
                  double.parse(isipendidikan[index = 34].muridma_n2);
              double muridma_36 =
                  double.parse(isipendidikan[index = 35].muridma_n2);
