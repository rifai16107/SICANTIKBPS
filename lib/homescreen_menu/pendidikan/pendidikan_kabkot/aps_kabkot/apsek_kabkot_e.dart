          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //APM
                double aps712_1 =
                    double.parse(isipendidikan[index = 0].aps712_n5);
                double aps712_2 =
                    double.parse(isipendidikan[index = 1].aps712_n5);
                double aps712_3 =
                    double.parse(isipendidikan[index = 2].aps712_n5);
                double aps712_4 =
                    double.parse(isipendidikan[index = 3].aps712_n5);
                double aps712_5 =
                    double.parse(isipendidikan[index = 4].aps712_n5);
                double aps712_6 =
                    double.parse(isipendidikan[index = 5].aps712_n5);
                double aps712_7 =
                    double.parse(isipendidikan[index = 6].aps712_n5);
                double aps712_8 =
                    double.parse(isipendidikan[index = 7].aps712_n5);
                double aps712_9 =
                    double.parse(isipendidikan[index = 8].aps712_n5);
                double aps712_10 =
