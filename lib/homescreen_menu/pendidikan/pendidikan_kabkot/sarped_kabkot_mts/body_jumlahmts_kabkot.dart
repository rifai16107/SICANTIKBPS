import 'package:bps_cilacap/homescreen_menu/pendidikan/pendidikan_kabkot/sarped_kabkot_mts/jumlahmts_kabkot_a.dart';
import 'package:bps_cilacap/homescreen_menu/pendidikan/pendidikan_kabkot/sarped_kabkot_mts/jumlahmts_kabkot_b.dart';
import 'package:bps_cilacap/homescreen_menu/pendidikan/pendidikan_kabkot/sarped_kabkot_mts/jumlahmts_kabkot_c.dart';
...
class BodySeriesJumlahmtsKabkot extends StatefulWidget {
  const BodySeriesJumlahmtsKabkot({super.key});

  @override
  State<BodySeriesJumlahmtsKabkot> createState() =>
      _BodySeriesJumlahmtsKabkotState();
}

class _BodySeriesJumlahmtsKabkotState extends State<BodySeriesJumlahmtsKabkot> {
  RepositoryPendidikanKabkotJumlahmts repositoryapmapk =
              ...
              return DefaultTabController(
                ...
                child: Scaffold(
                  ...
                  body: const TabBarView(children: [
                    PendidikanKabkotJumlahmtsA(),
                    PendidikanKabkotJumlahmtsB(),
                    PendidikanKabkotJumlahmtsC(),
                  ]),
                ),
              );
            },
