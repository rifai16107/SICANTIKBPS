        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //APM
              double sekolahmts_1 =
                  double.parse(isipendidikan[index = 0].sekolahmts_n2);
              double sekolahmts_2 =
                  double.parse(isipendidikan[index = 1].sekolahmts_n2);
              double sekolahmts_3 =
                  double.parse(isipendidikan[index = 2].sekolahmts_n2);
              double sekolahmts_4 =
                  double.parse(isipendidikan[index = 3].sekolahmts_n2);
              double sekolahmts_5 =
                  double.parse(isipendidikan[index = 4].sekolahmts_n2);
              double sekolahmts_6 =
                  double.parse(isipendidikan[index = 5].sekolahmts_n2);
              double sekolahmts_7 =
                  double.parse(isipendidikan[index = 6].sekolahmts_n2);
              double sekolahmts_8 =
                  double.parse(isipendidikan[index = 7].sekolahmts_n2);
              double sekolahmts_9 =
                  double.parse(isipendidikan[index = 8].sekolahmts_n2);
              double sekolahmts_10 =
                  double.parse(isipendidikan[index = 9].sekolahmts_n2);
              double sekolahmts_11 =
                  double.parse(isipendidikan[index = 10].sekolahmts_n2);
              double sekolahmts_12 =
                  double.parse(isipendidikan[index = 11].sekolahmts_n2);
              double sekolahmts_13 =
                  double.parse(isipendidikan[index = 12].sekolahmts_n2);
              double sekolahmts_14 =
                  double.parse(isipendidikan[index = 13].sekolahmts_n2);
              double sekolahmts_15 =
                  double.parse(isipendidikan[index = 14].sekolahmts_n2);
              double sekolahmts_16 =
                  double.parse(isipendidikan[index = 15].sekolahmts_n2);
              double sekolahmts_17 =
                  double.parse(isipendidikan[index = 16].sekolahmts_n2);
              double sekolahmts_18 =
                  double.parse(isipendidikan[index = 17].sekolahmts_n2);
              double sekolahmts_19 =
                  double.parse(isipendidikan[index = 18].sekolahmts_n2);
              double sekolahmts_20 =
                  double.parse(isipendidikan[index = 19].sekolahmts_n2);
              double sekolahmts_21 =
                  double.parse(isipendidikan[index = 20].sekolahmts_n2);
              double sekolahmts_22 =
                  double.parse(isipendidikan[index = 21].sekolahmts_n2);
              double sekolahmts_23 =
                  double.parse(isipendidikan[index = 22].sekolahmts_n2);
              double sekolahmts_24 =
                  double.parse(isipendidikan[index = 23].sekolahmts_n2);
              double sekolahmts_25 =
                  double.parse(isipendidikan[index = 24].sekolahmts_n2);
              double sekolahmts_26 =
                  double.parse(isipendidikan[index = 25].sekolahmts_n2);
              double sekolahmts_27 =
                  double.parse(isipendidikan[index = 26].sekolahmts_n2);
              double sekolahmts_28 =
                  double.parse(isipendidikan[index = 27].sekolahmts_n2);
              double sekolahmts_29 =
                  double.parse(isipendidikan[index = 28].sekolahmts_n2);
              double sekolahmts_30 =
                  double.parse(isipendidikan[index = 29].sekolahmts_n2);
              double sekolahmts_31 =
                  double.parse(isipendidikan[index = 30].sekolahmts_n2);
              double sekolahmts_32 =
                  double.parse(isipendidikan[index = 31].sekolahmts_n2);
              double sekolahmts_33 =
                  double.parse(isipendidikan[index = 32].sekolahmts_n2);
              double sekolahmts_34 =
                  double.parse(isipendidikan[index = 33].sekolahmts_n2);
              double sekolahmts_35 =
                  double.parse(isipendidikan[index = 34].sekolahmts_n2);
              double sekolahmts_36 =
                  double.parse(isipendidikan[index = 35].sekolahmts_n2);

              double gurumts_1 =
                  double.parse(isipendidikan[index = 0].gurumts_n2);
              double gurumts_2 =
                  double.parse(isipendidikan[index = 1].gurumts_n2);
              double gurumts_3 =
                  double.parse(isipendidikan[index = 2].gurumts_n2);
              double gurumts_4 =
                  double.parse(isipendidikan[index = 3].gurumts_n2);
              double gurumts_5 =
                  double.parse(isipendidikan[index = 4].gurumts_n2);
              double gurumts_6 =
                  double.parse(isipendidikan[index = 5].gurumts_n2);
              double gurumts_7 =
                  double.parse(isipendidikan[index = 6].gurumts_n2);
              double gurumts_8 =
                  double.parse(isipendidikan[index = 7].gurumts_n2);
              double gurumts_9 =
                  double.parse(isipendidikan[index = 8].gurumts_n2);
              double gurumts_10 =
                  double.parse(isipendidikan[index = 9].gurumts_n2);
              double gurumts_11 =
                  double.parse(isipendidikan[index = 10].gurumts_n2);
              double gurumts_12 =
                  double.parse(isipendidikan[index = 11].gurumts_n2);
              double gurumts_13 =
                  double.parse(isipendidikan[index = 12].gurumts_n2);
              double gurumts_14 =
                  double.parse(isipendidikan[index = 13].gurumts_n2);
              double gurumts_15 =
                  double.parse(isipendidikan[index = 14].gurumts_n2);
              double gurumts_16 =
                  double.parse(isipendidikan[index = 15].gurumts_n2);
              double gurumts_17 =
                  double.parse(isipendidikan[index = 16].gurumts_n2);
              double gurumts_18 =
                  double.parse(isipendidikan[index = 17].gurumts_n2);
              double gurumts_19 =
                  double.parse(isipendidikan[index = 18].gurumts_n2);
              double gurumts_20 =
                  double.parse(isipendidikan[index = 19].gurumts_n2);
              double gurumts_21 =
                  double.parse(isipendidikan[index = 20].gurumts_n2);
              double gurumts_22 =
                  double.parse(isipendidikan[index = 21].gurumts_n2);
              double gurumts_23 =
                  double.parse(isipendidikan[index = 22].gurumts_n2);
              double gurumts_24 =
                  double.parse(isipendidikan[index = 23].gurumts_n2);
              double gurumts_25 =
                  double.parse(isipendidikan[index = 24].gurumts_n2);
              double gurumts_26 =
                  double.parse(isipendidikan[index = 25].gurumts_n2);
              double gurumts_27 =
                  double.parse(isipendidikan[index = 26].gurumts_n2);
              double gurumts_28 =
                  double.parse(isipendidikan[index = 27].gurumts_n2);
              double gurumts_29 =
                  double.parse(isipendidikan[index = 28].gurumts_n2);
              double gurumts_30 =
                  double.parse(isipendidikan[index = 29].gurumts_n2);
              double gurumts_31 =
                  double.parse(isipendidikan[index = 30].gurumts_n2);
              double gurumts_32 =
                  double.parse(isipendidikan[index = 31].gurumts_n2);
              double gurumts_33 =
                  double.parse(isipendidikan[index = 32].gurumts_n2);
              double gurumts_34 =
                  double.parse(isipendidikan[index = 33].gurumts_n2);
              double gurumts_35 =
                  double.parse(isipendidikan[index = 34].gurumts_n2);
              double gurumts_36 =
                  double.parse(isipendidikan[index = 35].gurumts_n2);

              double muridmts_1 =
                  double.parse(isipendidikan[index = 0].muridmts_n2);
              double muridmts_2 =
                  double.parse(isipendidikan[index = 1].muridmts_n2);
              double muridmts_3 =
                  double.parse(isipendidikan[index = 2].muridmts_n2);
              double muridmts_4 =
                  double.parse(isipendidikan[index = 3].muridmts_n2);
              double muridmts_5 =
                  double.parse(isipendidikan[index = 4].muridmts_n2);
              double muridmts_6 =
                  double.parse(isipendidikan[index = 5].muridmts_n2);
              double muridmts_7 =
                  double.parse(isipendidikan[index = 6].muridmts_n2);
              double muridmts_8 =
                  double.parse(isipendidikan[index = 7].muridmts_n2);
              double muridmts_9 =
                  double.parse(isipendidikan[index = 8].muridmts_n2);
              double muridmts_10 =
                  double.parse(isipendidikan[index = 9].muridmts_n2);
              double muridmts_11 =
                  double.parse(isipendidikan[index = 10].muridmts_n2);
              double muridmts_12 =
                  double.parse(isipendidikan[index = 11].muridmts_n2);
              double muridmts_13 =
                  double.parse(isipendidikan[index = 12].muridmts_n2);
              double muridmts_14 =
                  double.parse(isipendidikan[index = 13].muridmts_n2);
              double muridmts_15 =
                  double.parse(isipendidikan[index = 14].muridmts_n2);
              double muridmts_16 =
                  double.parse(isipendidikan[index = 15].muridmts_n2);
              double muridmts_17 =
                  double.parse(isipendidikan[index = 16].muridmts_n2);
              double muridmts_18 =
                  double.parse(isipendidikan[index = 17].muridmts_n2);
              double muridmts_19 =
                  double.parse(isipendidikan[index = 18].muridmts_n2);
              double muridmts_20 =
                  double.parse(isipendidikan[index = 19].muridmts_n2);
              double muridmts_21 =
                  double.parse(isipendidikan[index = 20].muridmts_n2);
              double muridmts_22 =
                  double.parse(isipendidikan[index = 21].muridmts_n2);
              double muridmts_23 =
                  double.parse(isipendidikan[index = 22].muridmts_n2);
              double muridmts_24 =
                  double.parse(isipendidikan[index = 23].muridmts_n2);
              double muridmts_25 =
                  double.parse(isipendidikan[index = 24].muridmts_n2);
              double muridmts_26 =
                  double.parse(isipendidikan[index = 25].muridmts_n2);
              double muridmts_27 =
                  double.parse(isipendidikan[index = 26].muridmts_n2);
              double muridmts_28 =
                  double.parse(isipendidikan[index = 27].muridmts_n2);
              double muridmts_29 =
                  double.parse(isipendidikan[index = 28].muridmts_n2);
              double muridmts_30 =
                  double.parse(isipendidikan[index = 29].muridmts_n2);
              double muridmts_31 =
                  double.parse(isipendidikan[index = 30].muridmts_n2);
              double muridmts_32 =
                  double.parse(isipendidikan[index = 31].muridmts_n2);
              double muridmts_33 =
                  double.parse(isipendidikan[index = 32].muridmts_n2);
              double muridmts_34 =
                  double.parse(isipendidikan[index = 33].muridmts_n2);
              double muridmts_35 =
                  double.parse(isipendidikan[index = 34].muridmts_n2);
              double muridmts_36 =
                  double.parse(isipendidikan[index = 35].muridmts_n2);
