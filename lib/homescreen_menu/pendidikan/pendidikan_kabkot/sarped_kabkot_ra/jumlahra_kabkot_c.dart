...
class ModelPendidikanKabkotJumlahra {
  ...
  final String sekolahra_n3;
  final String gurura_n3;
  final String muridra_n3;
  final String tahun;

  ModelPendidikanKabkotJumlahra(
      {required this.id,
      required this.wilayah,
      required this.sekolahra_n3,
      required this.gurura_n3,
      required this.muridra_n3,
      required this.tahun});
  ...
  factory ModelPendidikanKabkotJumlahra.fromJson(Map<String, dynamic> json) {
    return ModelPendidikanKabkotJumlahra(
      ...
      sekolahra_n3: json['sekolahra_n3'],
      gurura_n3: json['gurura_n3'],
      muridra_n3: json['muridra_n3'],
      tahun: json['tahun'],
    );
  }
}

class PendidikanKabkotJumlahraC extends StatefulWidget {
  const PendidikanKabkotJumlahraC({Key? key}) : super(key: key);

  @override
  State<PendidikanKabkotJumlahraC> createState() =>
      _PendidikanKabkotJumlahraCState();
}

RepositoryPendidikanKabkotJumlahra repositorypendidikan =
    RepositoryPendidikanKabkotJumlahra();

class _PendidikanKabkotJumlahraCState extends State<PendidikanKabkotJumlahraC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //APM
              double sekolahra_1 =
                  double.parse(isipendidikan[index = 0].sekolahra_n3);
              double sekolahra_2 =
                  double.parse(isipendidikan[index = 1].sekolahra_n3);
              double sekolahra_3 =
                  double.parse(isipendidikan[index = 2].sekolahra_n3);
              double sekolahra_4 =
                  double.parse(isipendidikan[index = 3].sekolahra_n3);
              double sekolahra_5 =
                  double.parse(isipendidikan[index = 4].sekolahra_n3);
              double sekolahra_6 =
                  double.parse(isipendidikan[index = 5].sekolahra_n3);
              double sekolahra_7 =
                  double.parse(isipendidikan[index = 6].sekolahra_n3);
              double sekolahra_8 =
                  double.parse(isipendidikan[index = 7].sekolahra_n3);
              double sekolahra_9 =
                  double.parse(isipendidikan[index = 8].sekolahra_n3);
              double sekolahra_10 =
                  double.parse(isipendidikan[index = 9].sekolahra_n3);
              double sekolahra_11 =
                  double.parse(isipendidikan[index = 10].sekolahra_n3);
              double sekolahra_12 =
                  double.parse(isipendidikan[index = 11].sekolahra_n3);
              double sekolahra_13 =
                  double.parse(isipendidikan[index = 12].sekolahra_n3);
              double sekolahra_14 =
                  double.parse(isipendidikan[index = 13].sekolahra_n3);
              double sekolahra_15 =
                  double.parse(isipendidikan[index = 14].sekolahra_n3);
              double sekolahra_16 =
                  double.parse(isipendidikan[index = 15].sekolahra_n3);
              double sekolahra_17 =
                  double.parse(isipendidikan[index = 16].sekolahra_n3);
              double sekolahra_18 =
                  double.parse(isipendidikan[index = 17].sekolahra_n3);
              double sekolahra_19 =
                  double.parse(isipendidikan[index = 18].sekolahra_n3);
              double sekolahra_20 =
                  double.parse(isipendidikan[index = 19].sekolahra_n3);
              double sekolahra_21 =
                  double.parse(isipendidikan[index = 20].sekolahra_n3);
              double sekolahra_22 =
                  double.parse(isipendidikan[index = 21].sekolahra_n3);
              double sekolahra_23 =
                  double.parse(isipendidikan[index = 22].sekolahra_n3);
              double sekolahra_24 =
                  double.parse(isipendidikan[index = 23].sekolahra_n3);
              double sekolahra_25 =
                  double.parse(isipendidikan[index = 24].sekolahra_n3);
              double sekolahra_26 =
                  double.parse(isipendidikan[index = 25].sekolahra_n3);
              double sekolahra_27 =
                  double.parse(isipendidikan[index = 26].sekolahra_n3);
              double sekolahra_28 =
                  double.parse(isipendidikan[index = 27].sekolahra_n3);
              double sekolahra_29 =
                  double.parse(isipendidikan[index = 28].sekolahra_n3);
              double sekolahra_30 =
                  double.parse(isipendidikan[index = 29].sekolahra_n3);
              double sekolahra_31 =
                  double.parse(isipendidikan[index = 30].sekolahra_n3);
              double sekolahra_32 =
                  double.parse(isipendidikan[index = 31].sekolahra_n3);
              double sekolahra_33 =
                  double.parse(isipendidikan[index = 32].sekolahra_n3);
              double sekolahra_34 =
                  double.parse(isipendidikan[index = 33].sekolahra_n3);
              double sekolahra_35 =
                  double.parse(isipendidikan[index = 34].sekolahra_n3);
              double sekolahra_36 =
                  double.parse(isipendidikan[index = 35].sekolahra_n3);

              double gurura_1 =
                  double.parse(isipendidikan[index = 0].gurura_n3);
              double gurura_2 =
                  double.parse(isipendidikan[index = 1].gurura_n3);
              double gurura_3 =
                  double.parse(isipendidikan[index = 2].gurura_n3);
              double gurura_4 =
                  double.parse(isipendidikan[index = 3].gurura_n3);
              double gurura_5 =
                  double.parse(isipendidikan[index = 4].gurura_n3);
              double gurura_6 =
                  double.parse(isipendidikan[index = 5].gurura_n3);
              double gurura_7 =
                  double.parse(isipendidikan[index = 6].gurura_n3);
              double gurura_8 =
                  double.parse(isipendidikan[index = 7].gurura_n3);
              double gurura_9 =
                  double.parse(isipendidikan[index = 8].gurura_n3);
              double gurura_10 =
                  double.parse(isipendidikan[index = 9].gurura_n3);
              double gurura_11 =
                  double.parse(isipendidikan[index = 10].gurura_n3);
              double gurura_12 =
                  double.parse(isipendidikan[index = 11].gurura_n3);
              double gurura_13 =
                  double.parse(isipendidikan[index = 12].gurura_n3);
              double gurura_14 =
                  double.parse(isipendidikan[index = 13].gurura_n3);
              double gurura_15 =
                  double.parse(isipendidikan[index = 14].gurura_n3);
              double gurura_16 =
                  double.parse(isipendidikan[index = 15].gurura_n3);
              double gurura_17 =
                  double.parse(isipendidikan[index = 16].gurura_n3);
              double gurura_18 =
                  double.parse(isipendidikan[index = 17].gurura_n3);
              double gurura_19 =
                  double.parse(isipendidikan[index = 18].gurura_n3);
              double gurura_20 =
                  double.parse(isipendidikan[index = 19].gurura_n3);
              double gurura_21 =
                  double.parse(isipendidikan[index = 20].gurura_n3);
              double gurura_22 =
                  double.parse(isipendidikan[index = 21].gurura_n3);
              double gurura_23 =
                  double.parse(isipendidikan[index = 22].gurura_n3);
              double gurura_24 =
                  double.parse(isipendidikan[index = 23].gurura_n3);
              double gurura_25 =
                  double.parse(isipendidikan[index = 24].gurura_n3);
              double gurura_26 =
                  double.parse(isipendidikan[index = 25].gurura_n3);
              double gurura_27 =
                  double.parse(isipendidikan[index = 26].gurura_n3);
              double gurura_28 =
                  double.parse(isipendidikan[index = 27].gurura_n3);
              double gurura_29 =
                  double.parse(isipendidikan[index = 28].gurura_n3);
              double gurura_30 =
                  double.parse(isipendidikan[index = 29].gurura_n3);
              double gurura_31 =
                  double.parse(isipendidikan[index = 30].gurura_n3);
              double gurura_32 =
                  double.parse(isipendidikan[index = 31].gurura_n3);
              double gurura_33 =
                  double.parse(isipendidikan[index = 32].gurura_n3);
              double gurura_34 =
                  double.parse(isipendidikan[index = 33].gurura_n3);
              double gurura_35 =
                  double.parse(isipendidikan[index = 34].gurura_n3);
              double gurura_36 =
                  double.parse(isipendidikan[index = 35].gurura_n3);

              double muridra_1 =
                  double.parse(isipendidikan[index = 0].muridra_n3);
              double muridra_2 =
                  double.parse(isipendidikan[index = 1].muridra_n3);
              double muridra_3 =
                  double.parse(isipendidikan[index = 2].muridra_n3);
              double muridra_4 =
                  double.parse(isipendidikan[index = 3].muridra_n3);
              double muridra_5 =
                  double.parse(isipendidikan[index = 4].muridra_n3);
              double muridra_6 =
                  double.parse(isipendidikan[index = 5].muridra_n3);
              double muridra_7 =
                  double.parse(isipendidikan[index = 6].muridra_n3);
              double muridra_8 =
                  double.parse(isipendidikan[index = 7].muridra_n3);
              double muridra_9 =
                  double.parse(isipendidikan[index = 8].muridra_n3);
              double muridra_10 =
                  double.parse(isipendidikan[index = 9].muridra_n3);
              double muridra_11 =
                  double.parse(isipendidikan[index = 10].muridra_n3);
              double muridra_12 =
                  double.parse(isipendidikan[index = 11].muridra_n3);
              double muridra_13 =
                  double.parse(isipendidikan[index = 12].muridra_n3);
              double muridra_14 =
                  double.parse(isipendidikan[index = 13].muridra_n3);
              double muridra_15 =
                  double.parse(isipendidikan[index = 14].muridra_n3);
              double muridra_16 =
                  double.parse(isipendidikan[index = 15].muridra_n3);
              double muridra_17 =
                  double.parse(isipendidikan[index = 16].muridra_n3);
              double muridra_18 =
                  double.parse(isipendidikan[index = 17].muridra_n3);
              double muridra_19 =
                  double.parse(isipendidikan[index = 18].muridra_n3);
              double muridra_20 =
                  double.parse(isipendidikan[index = 19].muridra_n3);
              double muridra_21 =
                  double.parse(isipendidikan[index = 20].muridra_n3);
              double muridra_22 =
                  double.parse(isipendidikan[index = 21].muridra_n3);
              double muridra_23 =
                  double.parse(isipendidikan[index = 22].muridra_n3);
              double muridra_24 =
                  double.parse(isipendidikan[index = 23].muridra_n3);
              double muridra_25 =
                  double.parse(isipendidikan[index = 24].muridra_n3);
              double muridra_26 =
                  double.parse(isipendidikan[index = 25].muridra_n3);
              double muridra_27 =
                  double.parse(isipendidikan[index = 26].muridra_n3);
              double muridra_28 =
                  double.parse(isipendidikan[index = 27].muridra_n3);
              double muridra_29 =
                  double.parse(isipendidikan[index = 28].muridra_n3);
              double muridra_30 =
                  double.parse(isipendidikan[index = 29].muridra_n3);
              double muridra_31 =
                  double.parse(isipendidikan[index = 30].muridra_n3);
              double muridra_32 =
                  double.parse(isipendidikan[index = 31].muridra_n3);
              double muridra_33 =
                  double.parse(isipendidikan[index = 32].muridra_n3);
              double muridra_34 =
                  double.parse(isipendidikan[index = 33].muridra_n3);
              double muridra_35 =
                  double.parse(isipendidikan[index = 34].muridra_n3);
              double muridra_36 =
                  double.parse(isipendidikan[index = 35].muridra_n3);
