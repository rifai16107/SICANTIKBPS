        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //APM
              double sekolahpt_1 =
                  double.parse(isipendidikan[index = 0].ptagama_n1);
              double sekolahpt_2 =
                  double.parse(isipendidikan[index = 1].ptagama_n1);
              double sekolahpt_3 =
                  double.parse(isipendidikan[index = 2].ptagama_n1);
              double sekolahpt_4 =
                  double.parse(isipendidikan[index = 3].ptagama_n1);
              double sekolahpt_5 =
                  double.parse(isipendidikan[index = 4].ptagama_n1);
              double sekolahpt_6 =
                  double.parse(isipendidikan[index = 5].ptagama_n1);
              double sekolahpt_7 =
                  double.parse(isipendidikan[index = 6].ptagama_n1);
              double sekolahpt_8 =
                  double.parse(isipendidikan[index = 7].ptagama_n1);
              double sekolahpt_9 =
                  double.parse(isipendidikan[index = 8].ptagama_n1);
              double sekolahpt_10 =
                  double.parse(isipendidikan[index = 9].ptagama_n1);
              double sekolahpt_11 =
                  double.parse(isipendidikan[index = 10].ptagama_n1);
              double sekolahpt_12 =
                  double.parse(isipendidikan[index = 11].ptagama_n1);
              double sekolahpt_13 =
                  double.parse(isipendidikan[index = 12].ptagama_n1);
              double sekolahpt_14 =
                  double.parse(isipendidikan[index = 13].ptagama_n1);
              double sekolahpt_15 =
                  double.parse(isipendidikan[index = 14].ptagama_n1);
              double sekolahpt_16 =
                  double.parse(isipendidikan[index = 15].ptagama_n1);
              double sekolahpt_17 =
                  double.parse(isipendidikan[index = 16].ptagama_n1);
              double sekolahpt_18 =
                  double.parse(isipendidikan[index = 17].ptagama_n1);
              double sekolahpt_19 =
                  double.parse(isipendidikan[index = 18].ptagama_n1);
              double sekolahpt_20 =
                  double.parse(isipendidikan[index = 19].ptagama_n1);
              double sekolahpt_21 =
                  double.parse(isipendidikan[index = 20].ptagama_n1);
              double sekolahpt_22 =
                  double.parse(isipendidikan[index = 21].ptagama_n1);
              double sekolahpt_23 =
                  double.parse(isipendidikan[index = 22].ptagama_n1);
              double sekolahpt_24 =
                  double.parse(isipendidikan[index = 23].ptagama_n1);
              double sekolahpt_25 =
                  double.parse(isipendidikan[index = 24].ptagama_n1);
              double sekolahpt_26 =
                  double.parse(isipendidikan[index = 25].ptagama_n1);
              double sekolahpt_27 =
                  double.parse(isipendidikan[index = 26].ptagama_n1);
              double sekolahpt_28 =
                  double.parse(isipendidikan[index = 27].ptagama_n1);
              double sekolahpt_29 =
                  double.parse(isipendidikan[index = 28].ptagama_n1);
              double sekolahpt_30 =
                  double.parse(isipendidikan[index = 29].ptagama_n1);
              double sekolahpt_31 =
                  double.parse(isipendidikan[index = 30].ptagama_n1);
              double sekolahpt_32 =
                  double.parse(isipendidikan[index = 31].ptagama_n1);
              double sekolahpt_33 =
                  double.parse(isipendidikan[index = 32].ptagama_n1);
              double sekolahpt_34 =
                  double.parse(isipendidikan[index = 33].ptagama_n1);
              double sekolahpt_35 =
                  double.parse(isipendidikan[index = 34].ptagama_n1);
              double sekolahpt_36 =
                  double.parse(isipendidikan[index = 35].ptagama_n1);

              double gurupt_1 =
                  double.parse(isipendidikan[index = 0].dosenagama_n1);
              double gurupt_2 =
                  double.parse(isipendidikan[index = 1].dosenagama_n1);
              double gurupt_3 =
                  double.parse(isipendidikan[index = 2].dosenagama_n1);
              double gurupt_4 =
                  double.parse(isipendidikan[index = 3].dosenagama_n1);
              double gurupt_5 =
                  double.parse(isipendidikan[index = 4].dosenagama_n1);
              double gurupt_6 =
                  double.parse(isipendidikan[index = 5].dosenagama_n1);
              double gurupt_7 =
                  double.parse(isipendidikan[index = 6].dosenagama_n1);
              double gurupt_8 =
                  double.parse(isipendidikan[index = 7].dosenagama_n1);
              double gurupt_9 =
                  double.parse(isipendidikan[index = 8].dosenagama_n1);
              double gurupt_10 =
                  double.parse(isipendidikan[index = 9].dosenagama_n1);
              double gurupt_11 =
                  double.parse(isipendidikan[index = 10].dosenagama_n1);
              double gurupt_12 =
                  double.parse(isipendidikan[index = 11].dosenagama_n1);
              double gurupt_13 =
                  double.parse(isipendidikan[index = 12].dosenagama_n1);
              double gurupt_14 =
                  double.parse(isipendidikan[index = 13].dosenagama_n1);
              double gurupt_15 =
                  double.parse(isipendidikan[index = 14].dosenagama_n1);
              double gurupt_16 =
                  double.parse(isipendidikan[index = 15].dosenagama_n1);
              double gurupt_17 =
                  double.parse(isipendidikan[index = 16].dosenagama_n1);
              double gurupt_18 =
                  double.parse(isipendidikan[index = 17].dosenagama_n1);
              double gurupt_19 =
                  double.parse(isipendidikan[index = 18].dosenagama_n1);
              double gurupt_20 =
                  double.parse(isipendidikan[index = 19].dosenagama_n1);
              double gurupt_21 =
                  double.parse(isipendidikan[index = 20].dosenagama_n1);
              double gurupt_22 =
                  double.parse(isipendidikan[index = 21].dosenagama_n1);
              double gurupt_23 =
                  double.parse(isipendidikan[index = 22].dosenagama_n1);
              double gurupt_24 =
                  double.parse(isipendidikan[index = 23].dosenagama_n1);
              double gurupt_25 =
                  double.parse(isipendidikan[index = 24].dosenagama_n1);
              double gurupt_26 =
                  double.parse(isipendidikan[index = 25].dosenagama_n1);
              double gurupt_27 =
                  double.parse(isipendidikan[index = 26].dosenagama_n1);
              double gurupt_28 =
                  double.parse(isipendidikan[index = 27].dosenagama_n1);
              double gurupt_29 =
                  double.parse(isipendidikan[index = 28].dosenagama_n1);
              double gurupt_30 =
                  double.parse(isipendidikan[index = 29].dosenagama_n1);
              double gurupt_31 =
                  double.parse(isipendidikan[index = 30].dosenagama_n1);
              double gurupt_32 =
                  double.parse(isipendidikan[index = 31].dosenagama_n1);
              double gurupt_33 =
                  double.parse(isipendidikan[index = 32].dosenagama_n1);
              double gurupt_34 =
                  double.parse(isipendidikan[index = 33].dosenagama_n1);
              double gurupt_35 =
                  double.parse(isipendidikan[index = 34].dosenagama_n1);
              double gurupt_36 =
                  double.parse(isipendidikan[index = 35].dosenagama_n1);

              double muridpt_1 =
                  double.parse(isipendidikan[index = 0].mhsagama_n1);
              double muridpt_2 =
                  double.parse(isipendidikan[index = 1].mhsagama_n1);
              double muridpt_3 =
                  double.parse(isipendidikan[index = 2].mhsagama_n1);
              double muridpt_4 =
                  double.parse(isipendidikan[index = 3].mhsagama_n1);
              double muridpt_5 =
                  double.parse(isipendidikan[index = 4].mhsagama_n1);
              double muridpt_6 =
                  double.parse(isipendidikan[index = 5].mhsagama_n1);
              double muridpt_7 =
                  double.parse(isipendidikan[index = 6].mhsagama_n1);
              double muridpt_8 =
                  double.parse(isipendidikan[index = 7].mhsagama_n1);
              double muridpt_9 =
                  double.parse(isipendidikan[index = 8].mhsagama_n1);
              double muridpt_10 =
                  double.parse(isipendidikan[index = 9].mhsagama_n1);
              double muridpt_11 =
                  double.parse(isipendidikan[index = 10].mhsagama_n1);
              double muridpt_12 =
                  double.parse(isipendidikan[index = 11].mhsagama_n1);
              double muridpt_13 =
                  double.parse(isipendidikan[index = 12].mhsagama_n1);
              double muridpt_14 =
                  double.parse(isipendidikan[index = 13].mhsagama_n1);
              double muridpt_15 =
                  double.parse(isipendidikan[index = 14].mhsagama_n1);
              double muridpt_16 =
                  double.parse(isipendidikan[index = 15].mhsagama_n1);
              double muridpt_17 =
                  double.parse(isipendidikan[index = 16].mhsagama_n1);
              double muridpt_18 =
                  double.parse(isipendidikan[index = 17].mhsagama_n1);
              double muridpt_19 =
                  double.parse(isipendidikan[index = 18].mhsagama_n1);
              double muridpt_20 =
                  double.parse(isipendidikan[index = 19].mhsagama_n1);
              double muridpt_21 =
                  double.parse(isipendidikan[index = 20].mhsagama_n1);
              double muridpt_22 =
                  double.parse(isipendidikan[index = 21].mhsagama_n1);
              double muridpt_23 =
                  double.parse(isipendidikan[index = 22].mhsagama_n1);
              double muridpt_24 =
                  double.parse(isipendidikan[index = 23].mhsagama_n1);
              double muridpt_25 =
                  double.parse(isipendidikan[index = 24].mhsagama_n1);
              double muridpt_26 =
                  double.parse(isipendidikan[index = 25].mhsagama_n1);
              double muridpt_27 =
                  double.parse(isipendidikan[index = 26].mhsagama_n1);
              double muridpt_28 =
                  double.parse(isipendidikan[index = 27].mhsagama_n1);
              double muridpt_29 =
                  double.parse(isipendidikan[index = 28].mhsagama_n1);
              double muridpt_30 =
                  double.parse(isipendidikan[index = 29].mhsagama_n1);
              double muridpt_31 =
                  double.parse(isipendidikan[index = 30].mhsagama_n1);
              double muridpt_32 =
                  double.parse(isipendidikan[index = 31].mhsagama_n1);
              double muridpt_33 =
                  double.parse(isipendidikan[index = 32].mhsagama_n1);
              double muridpt_34 =
                  double.parse(isipendidikan[index = 33].mhsagama_n1);
              double muridpt_35 =
                  double.parse(isipendidikan[index = 34].mhsagama_n1);
              double muridpt_36 =
                  double.parse(isipendidikan[index = 35].mhsagama_n1);
