        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //series y2, tahun n-1
              double inflasi12 =
                  double.parse(isiseriesinflasi[index = 12].inflasi);
              double inflasi13 =
                  double.parse(isiseriesinflasi[index = 13].inflasi);
              double inflasi14 =
                  double.parse(isiseriesinflasi[index = 14].inflasi);
              double inflasi15 =
                  double.parse(isiseriesinflasi[index = 15].inflasi);
              double inflasi16 =
                  double.parse(isiseriesinflasi[index = 16].inflasi);
              double inflasi17 =
                  double.parse(isiseriesinflasi[index = 17].inflasi);
              double inflasi18 =
                  double.parse(isiseriesinflasi[index = 18].inflasi);
              double inflasi19 =
                  double.parse(isiseriesinflasi[index = 19].inflasi);
              double inflasi20 =
                  double.parse(isiseriesinflasi[index = 20].inflasi);
              double inflasi21 =
                  double.parse(isiseriesinflasi[index = 21].inflasi);
              double inflasi22 =
                  double.parse(isiseriesinflasi[index = 22].inflasi);
              double inflasi23 =
                  double.parse(isiseriesinflasi[index = 23].inflasi);

              String thn1 = isiseriesinflasi[index = 12].tahun;

              //series y1, tahun n-2
              double inflasi0 =
                  double.parse(isiseriesinflasi[index = 0].inflasi);
              double inflasi1 =
                  double.parse(isiseriesinflasi[index = 1].inflasi);
              double inflasi2 =
                  double.parse(isiseriesinflasi[index = 2].inflasi);
              double inflasi3 =
                  double.parse(isiseriesinflasi[index = 3].inflasi);
              double inflasi4 =
                  double.parse(isiseriesinflasi[index = 4].inflasi);
              double inflasi5 =
                  double.parse(isiseriesinflasi[index = 5].inflasi);
              double inflasi6 =
                  double.parse(isiseriesinflasi[index = 6].inflasi);
              double inflasi7 =
                  double.parse(isiseriesinflasi[index = 7].inflasi);
              double inflasi8 =
                  double.parse(isiseriesinflasi[index = 8].inflasi);
              double inflasi9 =
                  double.parse(isiseriesinflasi[index = 9].inflasi);
              double inflasi10 =
                  double.parse(isiseriesinflasi[index = 10].inflasi);
              double inflasi11 =
                  double.parse(isiseriesinflasi[index = 11].inflasi);
              ...
              if (cekbulan12 != '-') {
                double inflasi24 =
                    double.parse(isiseriesinflasi[index = 24].inflasi);
                double inflasi25 =
                    double.parse(isiseriesinflasi[index = 25].inflasi);
                double inflasi26 =
                    double.parse(isiseriesinflasi[index = 26].inflasi);
                double inflasi27 =
                    double.parse(isiseriesinflasi[index = 27].inflasi);
                double inflasi28 =
                    double.parse(isiseriesinflasi[index = 28].inflasi);
                double inflasi29 =
                    double.parse(isiseriesinflasi[index = 29].inflasi);
                double inflasi30 =
                    double.parse(isiseriesinflasi[index = 30].inflasi);
                double inflasi31 =
                    double.parse(isiseriesinflasi[index = 31].inflasi);
                double inflasi32 =
                    double.parse(isiseriesinflasi[index = 32].inflasi);
                double inflasi33 =
                    double.parse(isiseriesinflasi[index = 33].inflasi);
                double inflasi34 =
                    double.parse(isiseriesinflasi[index = 34].inflasi);
                double inflasi35 =
                    double.parse(isiseriesinflasi[index = 35].inflasi);
                data1 = [
