...
class InflasiKotaA extends StatefulWidget {
  const InflasiKotaA({super.key});

  @override
  State<InflasiKotaA> createState() => _InflasiKotaAState();
}
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String nama8 = isiinflasikota[index = 7].nama;
                //3 kab baru
                String nama9 = isiinflasikota[index = 24].nama;
                String nama10 = isiinflasikota[index = 25].nama;
                String nama11 = isiinflasikota[index = 26].nama;
                ...
                double mtom8 = double.parse(isiinflasikota[index = 7].mtom);
                //3 kab baru
                double mtom9 = double.parse(isiinflasikota[index = 24].mtom);
                double mtom10 = double.parse(isiinflasikota[index = 25].mtom);
                double mtom11 = double.parse(isiinflasikota[index = 26].mtom);
                ...
                double ytod8 = double.parse(isiinflasikota[index = 7].ytod);
                //3 kab baru
                double ytod9 = double.parse(isiinflasikota[index = 24].ytod);
                double ytod10 = double.parse(isiinflasikota[index = 25].ytod);
                double ytod11 = double.parse(isiinflasikota[index = 26].ytod);
                ...
                double yony8 = double.parse(isiinflasikota[index = 7].ytoy);
                //3 kab baru
                double yony9 = double.parse(isiinflasikota[index = 24].ytoy);
                double yony10 = double.parse(isiinflasikota[index = 25].ytoy);
                double yony11 = double.parse(isiinflasikota[index = 26].ytoy);
