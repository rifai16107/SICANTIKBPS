        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isiaklpu[index = 4].jumlah);

              double taniPR = double.parse(isiaklpu[index = 9].pertanian);
              double industriPR = double.parse(isiaklpu[index = 9].industri);
              double jasaPR = double.parse(isiaklpu[index = 9].jasa);
              double totalPR = double.parse(isiaklpu[index = 9].jumlah);

              double taniLKPR = double.parse(isiaklpu[index = 14].pertanian);
              double industriLKPR = double.parse(isiaklpu[index = 14].industri);
              double jasaLKPR = double.parse(isiaklpu[index = 14].jasa);
              double totalLKPR = double.parse(isiaklpu[index = 14].jumlah);
