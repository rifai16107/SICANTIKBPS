        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isiaklpu[index = 2].jumlah);

              double taniPR = double.parse(isiaklpu[index = 7].pertanian);
              double industriPR = double.parse(isiaklpu[index = 7].industri);
              double jasaPR = double.parse(isiaklpu[index = 7].jasa);
              double totalPR = double.parse(isiaklpu[index = 7].jumlah);

              double taniLKPR = double.parse(isiaklpu[index = 12].pertanian);
              double industriLKPR = double.parse(isiaklpu[index = 12].industri);
              double jasaLKPR = double.parse(isiaklpu[index = 12].jasa);
              double totalLKPR = double.parse(isiaklpu[index = 12].jumlah);
