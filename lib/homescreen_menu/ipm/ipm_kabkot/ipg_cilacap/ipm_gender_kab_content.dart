            ...
            if (snapshot.hasData) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  double ipmlf_lk1 =
                      double.parse(isiipm[index = 5].ipm_lfsp2020);
                  double ipmlf_lk2 =
                      double.parse(isiipm[index = 6].ipm_lfsp2020);
                  double ipmlf_lk3 =
                      double.parse(isiipm[index = 7].ipm_lfsp2020);
                  double ipmlf_lk4 =
                      double.parse(isiipm[index = 8].ipm_lfsp2020);
                  double ipmlf_lk5 =
                      double.parse(isiipm[index = 9].ipm_lfsp2020);
                  //Perempuan
                  double uhh_pr1 =
                      double.parse(isiipm[index = 10].uhh_lfsp2020);
                  double uhh_pr2 =
                      double.parse(isiipm[index = 11].uhh_lfsp2020);
                  double uhh_pr3 =
                      double.parse(isiipm[index = 12].uhh_lfsp2020);
                  double uhh_pr4 =
                      double.parse(isiipm[index = 13].uhh_lfsp2020);
                  double uhh_pr5 =
                      double.parse(isiipm[index = 14].uhh_lfsp2020);
                  ...
                  double ipmlf_pr1 =
                      double.parse(isiipm[index = 10].ipm_lfsp2020);
                  double ipmlf_pr2 =
                      double.parse(isiipm[index = 11].ipm_lfsp2020);
                  double ipmlf_pr3 =
                      double.parse(isiipm[index = 12].ipm_lfsp2020);
                  double ipmlf_pr4 =
                      double.parse(isiipm[index = 13].ipm_lfsp2020);
                  double ipmlf_pr5 =
                      double.parse(isiipm[index = 14].ipm_lfsp2020);
