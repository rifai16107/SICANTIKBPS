        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String tahunN2 = isiipgkabkot[index = 0].tahun.substring(5, 9);
              String tahunN3 = isiipgkabkot[index = 0].tahun.substring(10, 14);
              String tahunN4 = isiipgkabkot[index = 0].tahun.substring(15, 19);
              String tahunN5 = isiipgkabkot[index = 0].tahun.substring(20, 24);
