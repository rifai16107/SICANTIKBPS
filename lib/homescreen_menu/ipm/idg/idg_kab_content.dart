            ...
            if (snapshot.hasData) {
              ...
              return PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  double pendapatan1 =
                      double.parse(isiidg[index = 0].pendapatan);
                  double pendapatan2 =
                      double.parse(isiidg[index = 1].pendapatan);
                  double pendapatan3 =
                      double.parse(isiidg[index = 2].pendapatan);
                  double pendapatan4 =
                      double.parse(isiidg[index = 3].pendapatan);
                  double pendapatan5 =
                      double.parse(isiidg[index = 4].pendapatan);

                  double profesional1 =
                      double.parse(isiidg[index = 0].profesional);
                  double profesional2 =
                      double.parse(isiidg[index = 1].profesional);
                  double profesional3 =
                      double.parse(isiidg[index = 2].profesional);
                  double profesional4 =
                      double.parse(isiidg[index = 3].profesional);
                  double profesional5 =
                      double.parse(isiidg[index = 4].profesional);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context,
              CustomPageRoute(
                  child: const BodyGrafikIdg(), direction: AxisDirection.left));
        },
        mini: true,
