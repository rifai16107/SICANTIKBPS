...
import 'package:bps_cilacap/homescreen_menu/pdrb/pdrb_clp/pdrb_lu/body_grafik_pdrb_adhk.dart';
import 'package:bps_cilacap/tabel/tabel_pdrb_adhk_mlu_tanpa_migas.dart';
import 'package:flutter/material.dart';

class PdrbAdhkLapUsTanpaMigas extends StatefulWidget {
  const PdrbAdhkLapUsTanpaMigas({super.key});

  @override
  State<PdrbAdhkLapUsTanpaMigas> createState() =>
      _PdrbAdhkLapUsTanpaMigasState();
}

class _PdrbAdhkLapUsTanpaMigasState extends State<PdrbAdhkLapUsTanpaMigas> {
  @override
              ...
              Column(
                children: <Widget>[
                  Container(
                      ...
                      child: const Text(
                        "PDRB Kabupaten Cilacap ADHK Menurut Lapangan Usaha -Tanpa Migas (Trilyun Rp)",
                        style: TextStyle(fontWeight: FontWeight.bold),
