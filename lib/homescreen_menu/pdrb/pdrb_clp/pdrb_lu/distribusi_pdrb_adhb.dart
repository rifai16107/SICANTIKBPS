...
import 'package:bps_cilacap/homescreen_menu/pdrb/pdrb_clp/pdrb_lu/body_grafik_distpdrb_adhb.dart';
            ...
            Column(
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  width: screenWidth,
                  child: Column(
                    children: [Flexible(child: TabelDistPdrbMigas())],
                  ),
                ),
              ],
            ),
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(
              context,
              CustomPageRoute(
                child: const BodyGrafikDistPdrbMigas(),
