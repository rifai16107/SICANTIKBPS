...
class LajuadhkLuTrw1 extends StatefulWidget {
  const LajuadhkLuTrw1({Key? key}) : super(key: key);

  @override
  State<LajuadhkLuTrw1> createState() => _LajuadhkLuTrw1State();
}

RepositoryLajuadhkLuTrw repositoryLajuadhk = RepositoryLajuadhkLuTrw();

class _LajuadhkLuTrw1State extends State<LajuadhkLuTrw1> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //pdrb trw
              String primer_qq_trw1 = isipdrb[index = 15].qq_trw1;
              String sekunder_qq_trw1 = isipdrb[index = 16].qq_trw1;
              String tersier_qq_trw1 = isipdrb[index = 17].qq_trw1;
              String total_qq_trw1 = isipdrb[index = 18].qq_trw1;

              String primer_qq_trw2 = isipdrb[index = 15].qq_trw2;
              String sekunder_qq_trw2 = isipdrb[index = 16].qq_trw2;
              String tersier_qq_trw2 = isipdrb[index = 17].qq_trw2;
              String total_qq_trw2 = isipdrb[index = 18].qq_trw2;

              String primer_qq_trw3 = isipdrb[index = 15].qq_trw3;
              String sekunder_qq_trw3 = isipdrb[index = 16].qq_trw3;
              String tersier_qq_trw3 = isipdrb[index = 17].qq_trw3;
              String total_qq_trw3 = isipdrb[index = 18].qq_trw3;

              String primer_qq_trw4 = isipdrb[index = 15].qq_trw4;
              String sekunder_qq_trw4 = isipdrb[index = 16].qq_trw4;
              String tersier_qq_trw4 = isipdrb[index = 17].qq_trw4;
              String total_qq_trw4 = isipdrb[index = 18].qq_trw4;

              String primer_qq_total = isipdrb[index = 15].qq_total;
              String sekunder_qq_total = isipdrb[index = 16].qq_total;
              String tersier_qq_total = isipdrb[index = 17].qq_total;
              String qq_total = isipdrb[index = 18].qq_total;
