...
class LajuadhkyyLuTrw1 extends StatefulWidget {
  const LajuadhkyyLuTrw1({Key? key}) : super(key: key);

  @override
  State<LajuadhkyyLuTrw1> createState() => _LajuadhkyyLuTrw1State();
}

RepositoryLajuadhkLuTrw repositoryLajuadhk = RepositoryLajuadhkLuTrw();

class _LajuadhkyyLuTrw1State extends State<LajuadhkyyLuTrw1> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //pdrb trw
                String primer_yy_trw1 = isipdrb[index = 15].yy_trw1;
                String sekunder_yy_trw1 = isipdrb[index = 16].yy_trw1;
                String tersier_yy_trw1 = isipdrb[index = 17].yy_trw1;
                String total_yy_trw1 = isipdrb[index = 18].yy_trw1;

                String primer_yy_trw2 = isipdrb[index = 15].yy_trw2;
                String sekunder_yy_trw2 = isipdrb[index = 16].yy_trw2;
                String tersier_yy_trw2 = isipdrb[index = 17].yy_trw2;
                String total_yy_trw2 = isipdrb[index = 18].yy_trw2;

                String primer_yy_trw3 = isipdrb[index = 15].yy_trw3;
                String sekunder_yy_trw3 = isipdrb[index = 16].yy_trw3;
                String tersier_yy_trw3 = isipdrb[index = 17].yy_trw3;
                String total_yy_trw3 = isipdrb[index = 18].yy_trw3;

                String primer_yy_trw4 = isipdrb[index = 15].yy_trw4;
                String sekunder_yy_trw4 = isipdrb[index = 16].yy_trw4;
                String tersier_yy_trw4 = isipdrb[index = 17].yy_trw4;
                String total_yy_trw4 = isipdrb[index = 18].yy_trw4;

                String primer_yy_total = isipdrb[index = 15].yy_total;
                String sekunder_yy_total = isipdrb[index = 16].yy_total;
                String tersier_yy_total = isipdrb[index = 17].yy_total;
                String yy_total = isipdrb[index = 18].yy_total;
