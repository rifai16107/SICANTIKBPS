...
class ModelPdrbTrwLu {
  ...
  factory ModelPdrbTrwLu.fromJson(Map<String, dynamic> json) {
    return ModelPdrbTrwLu(
      id: json['id'],
...
class PdrbLuTrwB extends StatefulWidget {
  const PdrbLuTrwB({Key? key}) : super(key: key);

  @override
  State<PdrbLuTrwB> createState() => _PdrbLuTrwBState();
}

RepositoryPdrbLuTrw repositorypdrb = RepositoryPdrbLuTrw();

class _PdrbLuTrwBState extends State<PdrbLuTrwB> {
  @override
