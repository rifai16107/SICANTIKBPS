...
class LajuadhkqqPengelTrw1 extends StatefulWidget {
  const LajuadhkqqPengelTrw1({Key? key}) : super(key: key);

  @override
  State<LajuadhkqqPengelTrw1> createState() => _LajuadhkqqPengelTrw1State();
}

RepositoryLajuadhkPengelTrw repositoryLajuadhk = RepositoryLajuadhkPengelTrw();

class _LajuadhkqqPengelTrw1State extends State<LajuadhkqqPengelTrw1> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //pdrb trw
              String konsruta_qq_trw1 = isipdrb[index = 0].qq_trw1;
              String konspem_qq_trw1 = isipdrb[index = 1].qq_trw1;
              String pmtb_qq_trw1 = isipdrb[index = 2].qq_trw1;
              String lainnya_qq_trw1 = isipdrb[index = 3].qq_trw1;
              String total_qq_trw1 = isipdrb[index = 4].qq_trw1;

              String konsruta_qq_trw2 = isipdrb[index = 0].qq_trw2;
              String konspem_qq_trw2 = isipdrb[index = 1].qq_trw2;
              String pmtb_qq_trw2 = isipdrb[index = 2].qq_trw2;
              String lainnya_qq_trw2 = isipdrb[index = 3].qq_trw2;
              String total_qq_trw2 = isipdrb[index = 4].qq_trw2;

              String konsruta_qq_trw3 = isipdrb[index = 0].qq_trw3;
              String konspem_qq_trw3 = isipdrb[index = 1].qq_trw3;
              String pmtb_qq_trw3 = isipdrb[index = 2].qq_trw3;
              String lainnya_qq_trw3 = isipdrb[index = 3].qq_trw3;
              String total_qq_trw3 = isipdrb[index = 4].qq_trw3;

              String konsruta_qq_trw4 = isipdrb[index = 0].qq_trw4;
              String konspem_qq_trw4 = isipdrb[index = 1].qq_trw4;
              String pmtb_qq_trw4 = isipdrb[index = 2].qq_trw4;
              String lainnya_qq_trw4 = isipdrb[index = 3].qq_trw4;
              String total_qq_trw4 = isipdrb[index = 4].qq_trw4;

              String konsruta_qq_total = isipdrb[index = 0].qq_total;
              String konspem_qq_total = isipdrb[index = 1].qq_total;
              String pmtb_qq_total = isipdrb[index = 2].qq_total;
              String lainnya_qq_total = isipdrb[index = 3].qq_total;
              String total_qq_total = isipdrb[index = 4].qq_total;
