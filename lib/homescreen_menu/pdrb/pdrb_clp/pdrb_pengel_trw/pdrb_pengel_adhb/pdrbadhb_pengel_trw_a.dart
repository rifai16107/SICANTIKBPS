...
class PdrbadhbPengelTrwA extends StatefulWidget {
  const PdrbadhbPengelTrwA({Key? key}) : super(key: key);

  @override
  State<PdrbadhbPengelTrwA> createState() => _PdrbadhbPengelTrwAState();
}

RepositoryPdrbadhbPengelTrw repositorypdrb = RepositoryPdrbadhbPengelTrw();

class _PdrbadhbPengelTrwAState extends State<PdrbadhbPengelTrwA> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                //pdrb trw
                String konsruta_trw1 = isipdrb[index = 15].trw1;
                String konspem_trw1 = isipdrb[index = 16].trw1;
                String pmtb_trw1 = isipdrb[index = 17].trw1;
                String lainnya_trw1 = isipdrb[index = 18].trw1;
                String total_trw1 = isipdrb[index = 19].trw1;

                String konsruta_trw2 = isipdrb[index = 15].trw2;
                String konspem_trw2 = isipdrb[index = 16].trw2;
                String pmtb_trw2 = isipdrb[index = 17].trw2;
                String lainnya_trw2 = isipdrb[index = 18].trw2;
                String total_trw2 = isipdrb[index = 19].trw2;

                String konsruta_trw3 = isipdrb[index = 15].trw3;
                String konspem_trw3 = isipdrb[index = 16].trw3;
                String pmtb_trw3 = isipdrb[index = 17].trw3;
                String lainnya_trw3 = isipdrb[index = 18].trw3;
                String total_trw3 = isipdrb[index = 19].trw3;

                String konsruta_trw4 = isipdrb[index = 15].trw4;
                String konspem_trw4 = isipdrb[index = 16].trw4;
                String pmtb_trw4 = isipdrb[index = 17].trw4;
                String lainnya_trw4 = isipdrb[index = 18].trw4;
                String total_trw4 = isipdrb[index = 19].trw4;

                String konsruta_total = isipdrb[index = 15].total;
                String konspem_total = isipdrb[index = 16].total;
                String pmtb_total = isipdrb[index = 17].total;
                String lainnya_total = isipdrb[index = 18].total;
