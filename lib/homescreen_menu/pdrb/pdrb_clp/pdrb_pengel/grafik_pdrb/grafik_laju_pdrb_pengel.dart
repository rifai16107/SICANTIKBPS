        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              //Laju 2019
              double LajukonsRuta_19 = double.parse(
                isipdrb[index = 9].kons_ruta,
              );
              double LajukonsLnprt_19 = double.parse(
                isipdrb[index = 9].kons_lnprt,
              );
              double LajukonsPem_19 = double.parse(isipdrb[index = 9].kons_pem);
              double Lajupmtb_19 = double.parse(isipdrb[index = 9].pmtb);
              double Lajuinventori_19 = double.parse(
              ...
              //Laju 2020
              double LajukonsRuta_20 = double.parse(
                isipdrb[index = 8].kons_ruta,
              );
              double LajukonsLnprt_20 = double.parse(
                isipdrb[index = 8].kons_lnprt,
              );
              double LajukonsPem_20 = double.parse(isipdrb[index = 8].kons_pem);
              double Lajupmtb_20 = double.parse(isipdrb[index = 8].pmtb);
              double Lajuinventori_20 = double.parse(
              ...
              //Laju 2021
              double LajukonsRuta_21 = double.parse(
                isipdrb[index = 7].kons_ruta,
              );
              double LajukonsLnprt_21 = double.parse(
                isipdrb[index = 7].kons_lnprt,
              );
              double LajukonsPem_21 = double.parse(isipdrb[index = 7].kons_pem);
              double Lajupmtb_21 = double.parse(isipdrb[index = 7].pmtb);
              double Lajuinventori_21 = double.parse(
              ...
              //Laju 2022
              double LajukonsRuta_22 = double.parse(
                isipdrb[index = 6].kons_ruta,
              );
              double LajukonsLnprt_22 = double.parse(
              ...
              double Lajuinventori_22 = double.parse(
              ...
              //Laju 2023
              double LajukonsRuta_23 = double.parse(
                isipdrb[index = 5].kons_ruta,
              );
              double LajukonsLnprt_23 = double.parse(
              ...
              double Lajuinventori_23 = double.parse(
