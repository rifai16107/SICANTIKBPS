...
class LajuPdrbAdhkB extends StatefulWidget {
  const LajuPdrbAdhkB({Key? key}) : super(key: key);

  @override
  State<LajuPdrbAdhkB> createState() => _LajuPdrbAdhkBState();
}

RepositoryPdrbPengelDislain repositorypdrb = RepositoryPdrbPengelDislain();

class _LajuPdrbAdhkBState extends State<LajuPdrbAdhkB> {
  @override
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                //laju pdrb komp pengeluaran adhk 2020 (n-3)
                ...
                //laju pdrb komp pengeluaran adhk 2021 (n-2)
