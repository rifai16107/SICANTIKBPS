...
class GrafikPdrbadhbKabkot extends StatefulWidget {
  const GrafikPdrbadhbKabkot({Key? key}) : super(key: key);

  @override
  _GrafikPdrbadhbKabkotState createState() => _GrafikPdrbadhbKabkotState();
}

class _GrafikPdrbadhbKabkotState extends State<GrafikPdrbadhbKabkot> {
            ...
            itemBuilder: (context, index) {
              ...
              return SizedBox(
                ...
                child: SfCartesianChart(
                    ...
                    title: ChartTitle(
                        text:
                            'PDRB Atas Dasar Harga Berlaku Kabupaten/Kota Di Jawa Tengah Tahun $th1 (Milyar Rupiah)',
