            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double pdrb1_1 = double.parse(
                  isipdrbkabkot[index = 0].pdrb_adhk2,
                );
                double pdrb1_2 = double.parse(
                  isipdrbkabkot[index = 1].pdrb_adhk2,
                );
                double pdrb1_3 = double.parse(
                  isipdrbkabkot[index = 2].pdrb_adhk2,
                );
                double pdrb1_4 = double.parse(
                  isipdrbkabkot[index = 3].pdrb_adhk2,
                );
                double pdrb1_5 = double.parse(
                  isipdrbkabkot[index = 4].pdrb_adhk2,
                );
                double pdrb1_6 = double.parse(
                  isipdrbkabkot[index = 5].pdrb_adhk2,
                );
                double pdrb1_7 = double.parse(
                  isipdrbkabkot[index = 6].pdrb_adhk2,
                );
                double pdrb1_8 = double.parse(
                  isipdrbkabkot[index = 7].pdrb_adhk2,
                );
                double pdrb1_9 = double.parse(
                  isipdrbkabkot[index = 8].pdrb_adhk2,
                );
                double pdrb1_10 = double.parse(
                  isipdrbkabkot[index = 9].pdrb_adhk2,
                );
                double pdrb1_11 = double.parse(
                  isipdrbkabkot[index = 10].pdrb_adhk2,
                );
                double pdrb1_12 = double.parse(
                  isipdrbkabkot[index = 11].pdrb_adhk2,
                );
                double pdrb1_13 = double.parse(
                  isipdrbkabkot[index = 12].pdrb_adhk2,
                );
                double pdrb1_14 = double.parse(
                  isipdrbkabkot[index = 13].pdrb_adhk2,
                );
                double pdrb1_15 = double.parse(
                  isipdrbkabkot[index = 14].pdrb_adhk2,
                );
                double pdrb1_16 = double.parse(
                  isipdrbkabkot[index = 15].pdrb_adhk2,
                );
                double pdrb1_17 = double.parse(
                  isipdrbkabkot[index = 16].pdrb_adhk2,
                );
                double pdrb1_18 = double.parse(
                  isipdrbkabkot[index = 17].pdrb_adhk2,
                );
                double pdrb1_19 = double.parse(
                  isipdrbkabkot[index = 18].pdrb_adhk2,
                );
                double pdrb1_20 = double.parse(
                  isipdrbkabkot[index = 19].pdrb_adhk2,
                );
                double pdrb1_21 = double.parse(
                  isipdrbkabkot[index = 20].pdrb_adhk2,
                );
                double pdrb1_22 = double.parse(
                  isipdrbkabkot[index = 21].pdrb_adhk2,
                );
                double pdrb1_23 = double.parse(
                  isipdrbkabkot[index = 22].pdrb_adhk2,
                );
                double pdrb1_24 = double.parse(
                  isipdrbkabkot[index = 23].pdrb_adhk2,
                );
                double pdrb1_25 = double.parse(
                  isipdrbkabkot[index = 24].pdrb_adhk2,
                );
                double pdrb1_26 = double.parse(
                  isipdrbkabkot[index = 25].pdrb_adhk2,
                );
                double pdrb1_27 = double.parse(
                  isipdrbkabkot[index = 26].pdrb_adhk2,
                );
                double pdrb1_28 = double.parse(
                  isipdrbkabkot[index = 27].pdrb_adhk2,
                );
                double pdrb1_29 = double.parse(
                  isipdrbkabkot[index = 28].pdrb_adhk2,
                );
                double pdrb1_30 = double.parse(
                  isipdrbkabkot[index = 29].pdrb_adhk2,
                );
                double pdrb1_31 = double.parse(
                  isipdrbkabkot[index = 30].pdrb_adhk2,
                );
                double pdrb1_32 = double.parse(
                  isipdrbkabkot[index = 31].pdrb_adhk2,
                );
                double pdrb1_33 = double.parse(
                  isipdrbkabkot[index = 32].pdrb_adhk2,
                );
                double pdrb1_34 = double.parse(
                  isipdrbkabkot[index = 33].pdrb_adhk2,
                );
                double pdrb1_35 = double.parse(
                  isipdrbkabkot[index = 34].pdrb_adhk2,
                );

                double pdrb2_1 = double.parse(
                  isipdrbkabkot[index = 0].pdrb_adhk3,
                );
                double pdrb2_2 = double.parse(
                  isipdrbkabkot[index = 1].pdrb_adhk3,
                );
                double pdrb2_3 = double.parse(
                  isipdrbkabkot[index = 2].pdrb_adhk3,
                );
                double pdrb2_4 = double.parse(
                  isipdrbkabkot[index = 3].pdrb_adhk3,
                );
                double pdrb2_5 = double.parse(
                  isipdrbkabkot[index = 4].pdrb_adhk3,
                );
                double pdrb2_6 = double.parse(
                  isipdrbkabkot[index = 5].pdrb_adhk3,
                );
                double pdrb2_7 = double.parse(
                  isipdrbkabkot[index = 6].pdrb_adhk3,
                );
                double pdrb2_8 = double.parse(
                  isipdrbkabkot[index = 7].pdrb_adhk3,
                );
                double pdrb2_9 = double.parse(
                  isipdrbkabkot[index = 8].pdrb_adhk3,
                );
                double pdrb2_10 = double.parse(
                  isipdrbkabkot[index = 9].pdrb_adhk3,
                );
                double pdrb2_11 = double.parse(
                  isipdrbkabkot[index = 10].pdrb_adhk3,
                );
                double pdrb2_12 = double.parse(
                  isipdrbkabkot[index = 11].pdrb_adhk3,
                );
                double pdrb2_13 = double.parse(
                  isipdrbkabkot[index = 12].pdrb_adhk3,
                );
                double pdrb2_14 = double.parse(
                  isipdrbkabkot[index = 13].pdrb_adhk3,
                );
                double pdrb2_15 = double.parse(
                  isipdrbkabkot[index = 14].pdrb_adhk3,
                );
                double pdrb2_16 = double.parse(
                  isipdrbkabkot[index = 15].pdrb_adhk3,
                );
                double pdrb2_17 = double.parse(
                  isipdrbkabkot[index = 16].pdrb_adhk3,
                );
                double pdrb2_18 = double.parse(
                  isipdrbkabkot[index = 17].pdrb_adhk3,
                );
                double pdrb2_19 = double.parse(
                  isipdrbkabkot[index = 18].pdrb_adhk3,
                );
                double pdrb2_20 = double.parse(
                  isipdrbkabkot[index = 19].pdrb_adhk3,
                );
                double pdrb2_21 = double.parse(
                  isipdrbkabkot[index = 20].pdrb_adhk3,
                );
                double pdrb2_22 = double.parse(
                  isipdrbkabkot[index = 21].pdrb_adhk3,
                );
                double pdrb2_23 = double.parse(
                  isipdrbkabkot[index = 22].pdrb_adhk3,
                );
                double pdrb2_24 = double.parse(
                  isipdrbkabkot[index = 23].pdrb_adhk3,
                );
                double pdrb2_25 = double.parse(
                  isipdrbkabkot[index = 24].pdrb_adhk3,
                );
                double pdrb2_26 = double.parse(
                  isipdrbkabkot[index = 25].pdrb_adhk3,
                );
                double pdrb2_27 = double.parse(
                  isipdrbkabkot[index = 26].pdrb_adhk3,
                );
                double pdrb2_28 = double.parse(
                  isipdrbkabkot[index = 27].pdrb_adhk3,
                );
                double pdrb2_29 = double.parse(
                  isipdrbkabkot[index = 28].pdrb_adhk3,
                );
                double pdrb2_30 = double.parse(
                  isipdrbkabkot[index = 29].pdrb_adhk3,
                );
                double pdrb2_31 = double.parse(
                  isipdrbkabkot[index = 30].pdrb_adhk3,
                );
                double pdrb2_32 = double.parse(
                  isipdrbkabkot[index = 31].pdrb_adhk3,
                );
                double pdrb2_33 = double.parse(
                  isipdrbkabkot[index = 32].pdrb_adhk3,
                );
                double pdrb2_34 = double.parse(
                  isipdrbkabkot[index = 33].pdrb_adhk3,
                );
                double pdrb2_35 = double.parse(
                  isipdrbkabkot[index = 34].pdrb_adhk3,
                );
