...
void main() => runApp(const TrwadhbKabkotC());

class TrwadhbKabkotC extends StatelessWidget {
  const TrwadhbKabkotC({super.key});
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/trwadhb-kabkot');
