...
void main() => runApp(const TrwadhkKabkotA());

class TrwadhkKabkotA extends StatelessWidget {
  const TrwadhkKabkotA({super.key});
...
Future<List<Data>> fetchData() async {
  var url = Uri.parse('https://bps-3301-asap.my.id/api/trwadhk-kabkot');
