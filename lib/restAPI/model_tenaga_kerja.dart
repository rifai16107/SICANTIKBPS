...
class TenagaKerja {
  ...
  final String tpaktotal;
  final String tpttotal;
  final String tkktotal;
  final String tpak;
  final String tkk;
  final String tpt;
  final String gender;
  ...
  const TenagaKerja(
      ...
      required this.tpaktotal,
      required this.tpttotal,
      required this.tkktotal,
  ...
  factory TenagaKerja.fromJson(Map<String, dynamic> json) {
    return TenagaKerja(
        ...
        tpaktotal: json['tpaktotal'],
        tpttotal: json['tpttotal'],
        tkktotal: json['tkktotal'],
        gender: json['gender'],
        tpak: json['tpak'],
        tkk: json['tkk'],
        tpt: json['tpt'],
