        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double bkjPr = double.parse(isitenagakerja[index = 6].bekerja);
              double pgrPr =
                  double.parse(isitenagakerja[index = 6].pengangguran);
              double bakPr =
                  double.parse(isitenagakerja[index = 6].bkn_angkatan_kerja);
              double sklPr = double.parse(isitenagakerja[index = 6].sekolah);
              double rutaPr = double.parse(isitenagakerja[index = 6].urus_ruta);
              double lainPr = double.parse(isitenagakerja[index = 6].lainnya);
              double tpakPr = double.parse(isitenagakerja[index = 6].tpak);
              double tkkPr = double.parse(isitenagakerja[index = 6].tkk);
              double tptPr = double.parse(isitenagakerja[index = 6].tpt);

              double akLk =
                  double.parse(isitenagakerja[index = 1].angkatan_kerja);
              double bkjLk = double.parse(isitenagakerja[index = 1].bekerja);
              double pgrLk =
                  double.parse(isitenagakerja[index = 1].pengangguran);
              double bakLk =
                  double.parse(isitenagakerja[index = 1].bkn_angkatan_kerja);
              double sklLk = double.parse(isitenagakerja[index = 1].sekolah);
              double rutaLk = double.parse(isitenagakerja[index = 1].urus_ruta);
              double lainLk = double.parse(isitenagakerja[index = 1].lainnya);
              double tpakLk = double.parse(isitenagakerja[index = 1].tpak);
              double tkkLk = double.parse(isitenagakerja[index = 1].tkk);
              double tptLk = double.parse(isitenagakerja[index = 1].tpt);
              double tpakgab =
                  double.parse(isitenagakerja[index = 1].tpaktotal);
              double tkkgab = double.parse(isitenagakerja[index = 1].tkktotal);
              double tptgab = double.parse(isitenagakerja[index = 1].tpttotal);
              return SizedBox(
                height: 2000,
                child: Column(
                  children: [
