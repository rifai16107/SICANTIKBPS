        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double tpakgab =
                  double.parse(isitenagakerja[index = 0].tpaktotal);
              double tkkgab = double.parse(isitenagakerja[index = 0].tkktotal);
              double tptgab = double.parse(isitenagakerja[index = 0].tpttotal);
              return SizedBox(
                height: 2000,
                child: Column(
                  children: [
