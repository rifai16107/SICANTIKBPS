        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double bkjPr = double.parse(isitenagakerja[index = 8].bekerja);
              double pgrPr =
                  double.parse(isitenagakerja[index = 8].pengangguran);
              double bakPr =
                  double.parse(isitenagakerja[index = 8].bkn_angkatan_kerja);
              double sklPr = double.parse(isitenagakerja[index = 8].sekolah);
              double rutaPr = double.parse(isitenagakerja[index = 8].urus_ruta);
              double lainPr = double.parse(isitenagakerja[index = 8].lainnya);
              double tpakPr = double.parse(isitenagakerja[index = 8].tpak);
              double tkkPr = double.parse(isitenagakerja[index = 8].tkk);
              double tptPr = double.parse(isitenagakerja[index = 8].tpt);

              double akLk =
                  double.parse(isitenagakerja[index = 3].angkatan_kerja);
              double bkjLk = double.parse(isitenagakerja[index = 3].bekerja);
              double pgrLk =
                  double.parse(isitenagakerja[index = 3].pengangguran);
              double bakLk =
                  double.parse(isitenagakerja[index = 3].bkn_angkatan_kerja);
              double sklLk = double.parse(isitenagakerja[index = 3].sekolah);
              double rutaLk = double.parse(isitenagakerja[index = 3].urus_ruta);
              double lainLk = double.parse(isitenagakerja[index = 3].lainnya);
              double tpakLk = double.parse(isitenagakerja[index = 3].tpak);
              double tkkLk = double.parse(isitenagakerja[index = 3].tkk);
              double tptLk = double.parse(isitenagakerja[index = 3].tpt);
              double tpakgab =
                  double.parse(isitenagakerja[index = 3].tpaktotal);
              double tkkgab = double.parse(isitenagakerja[index = 3].tkktotal);
              double tptgab = double.parse(isitenagakerja[index = 3].tpttotal);
              return SizedBox(
                height: 2000,
                child: Column(
                  children: [
