        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double tpakgab =
                  double.parse(isitenagakerja[index = 4].tpaktotal);
              double tkkgab = double.parse(isitenagakerja[index = 4].tkktotal);
              double tptgab = double.parse(isitenagakerja[index = 4].tpttotal);
