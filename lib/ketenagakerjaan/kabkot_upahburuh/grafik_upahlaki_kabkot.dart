...
class GrafikUpahlkkabkot extends StatefulWidget {
  const GrafikUpahlkkabkot({Key? key}) : super(key: key);

  @override
  _GrafikUpahlkkabkotState createState() => _GrafikUpahlkkabkotState();
}

class _GrafikUpahlkkabkotState extends State<GrafikUpahlkkabkot> {
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double upah3 = double.parse(isinaker[index = 2].lk_n5) / 1000;
              double upah4 = double.parse(isinaker[index = 3].lk_n5) / 1000;
              double upah5 = double.parse(isinaker[index = 4].lk_n5) / 1000;
              double upah6 = double.parse(isinaker[index = 5].lk_n5) / 1000;
              double upah7 = double.parse(isinaker[index = 6].lk_n5) / 1000;
              double upah8 = double.parse(isinaker[index = 7].lk_n5) / 1000;
              double upah9 = double.parse(isinaker[index = 8].lk_n5) / 1000;
              double upah10 = double.parse(isinaker[index = 9].lk_n5) / 1000;
              double upah11 = double.parse(isinaker[index = 10].lk_n5) / 1000;
              double upah12 = double.parse(isinaker[index = 11].lk_n5) / 1000;
              double upah13 = double.parse(isinaker[index = 12].lk_n5) / 1000;
              double upah14 = double.parse(isinaker[index = 13].lk_n5) / 1000;
              double upah15 = double.parse(isinaker[index = 14].lk_n5) / 1000;
              double upah16 = double.parse(isinaker[index = 15].lk_n5) / 1000;
              double upah17 = double.parse(isinaker[index = 16].lk_n5) / 1000;
              double upah18 = double.parse(isinaker[index = 17].lk_n5) / 1000;
              double upah19 = double.parse(isinaker[index = 18].lk_n5) / 1000;
              double upah20 = double.parse(isinaker[index = 19].lk_n5) / 1000;
              double upah21 = double.parse(isinaker[index = 20].lk_n5) / 1000;
              double upah22 = double.parse(isinaker[index = 21].lk_n5) / 1000;
              double upah23 = double.parse(isinaker[index = 22].lk_n5) / 1000;
              double upah24 = double.parse(isinaker[index = 23].lk_n5) / 1000;
              double upah25 = double.parse(isinaker[index = 24].lk_n5) / 1000;
              double upah26 = double.parse(isinaker[index = 25].lk_n5) / 1000;
              double upah27 = double.parse(isinaker[index = 26].lk_n5) / 1000;
              double upah28 = double.parse(isinaker[index = 27].lk_n5) / 1000;
              double upah29 = double.parse(isinaker[index = 28].lk_n5) / 1000;
              double upah30 = double.parse(isinaker[index = 29].lk_n5) / 1000;
              double upah31 = double.parse(isinaker[index = 30].lk_n5) / 1000;
              double upah32 = double.parse(isinaker[index = 31].lk_n5) / 1000;
