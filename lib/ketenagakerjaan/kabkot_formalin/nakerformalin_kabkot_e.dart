...
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/body_grafik_nakerformal_kabkota.dart';
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/body_grafik_nakerinformal_kabkota.dart';
...
class NakerkabkotFormalinE extends StatefulWidget {
  const NakerkabkotFormalinE({Key? key}) : super(key: key);

  @override
  State<NakerkabkotFormalinE> createState() => _NakerkabkotFormalinEState();
}
          ...
          if (snapshot.hasData) {
            ...
            return PageView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double formal_1 = double.parse(isinaker[index = 0].formal_n5);
                double formal_2 = double.parse(isinaker[index = 1].formal_n5);
                double formal_3 = double.parse(isinaker[index = 2].formal_n5);
                double formal_4 = double.parse(isinaker[index = 3].formal_n5);
                double formal_5 = double.parse(isinaker[index = 4].formal_n5);
                double formal_6 = double.parse(isinaker[index = 5].formal_n5);
                double formal_7 = double.parse(isinaker[index = 6].formal_n5);
                double formal_8 = double.parse(isinaker[index = 7].formal_n5);
                double formal_9 = double.parse(isinaker[index = 8].formal_n5);
                double formal_10 = double.parse(isinaker[index = 9].formal_n5);
                double formal_11 = double.parse(isinaker[index = 10].formal_n5);
                double formal_12 = double.parse(isinaker[index = 11].formal_n5);
                double formal_13 = double.parse(isinaker[index = 12].formal_n5);
                double formal_14 = double.parse(isinaker[index = 13].formal_n5);
                double formal_15 = double.parse(isinaker[index = 14].formal_n5);
                double formal_16 = double.parse(isinaker[index = 15].formal_n5);
                double formal_17 = double.parse(isinaker[index = 16].formal_n5);
                double formal_18 = double.parse(isinaker[index = 17].formal_n5);
                double formal_19 = double.parse(isinaker[index = 18].formal_n5);
                double formal_20 = double.parse(isinaker[index = 19].formal_n5);
                double formal_21 = double.parse(isinaker[index = 20].formal_n5);
                double formal_22 = double.parse(isinaker[index = 21].formal_n5);
                double formal_23 = double.parse(isinaker[index = 22].formal_n5);
                double formal_24 = double.parse(isinaker[index = 23].formal_n5);
                double formal_25 = double.parse(isinaker[index = 24].formal_n5);
                double formal_26 = double.parse(isinaker[index = 25].formal_n5);
                double formal_27 = double.parse(isinaker[index = 26].formal_n5);
                double formal_28 = double.parse(isinaker[index = 27].formal_n5);
                double formal_29 = double.parse(isinaker[index = 28].formal_n5);
                double formal_30 = double.parse(isinaker[index = 29].formal_n5);
                double formal_31 = double.parse(isinaker[index = 30].formal_n5);
                double formal_32 = double.parse(isinaker[index = 31].formal_n5);
                double formal_33 = double.parse(isinaker[index = 32].formal_n5);
                double formal_34 = double.parse(isinaker[index = 33].formal_n5);
