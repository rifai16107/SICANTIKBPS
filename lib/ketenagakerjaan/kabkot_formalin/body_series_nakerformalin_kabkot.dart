...
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/nakerformalin_kabkot_a.dart';
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/nakerformalin_kabkot_b.dart';
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/nakerformalin_kabkot_c.dart';
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/nakerformalin_kabkot_d.dart';
import 'package:bps_cilacap/ketenagakerjaan/kabkot_formalin/nakerformalin_kabkot_e.dart';
...
class BodySeriesNakerkabkotFormalin extends StatefulWidget {
  const BodySeriesNakerkabkotFormalin({super.key});

  @override
  State<BodySeriesNakerkabkotFormalin> createState() =>
      _BodySeriesNakerkabkotFormalinState();
}

class _BodySeriesNakerkabkotFormalinState
    extends State<BodySeriesNakerkabkotFormalin> {
