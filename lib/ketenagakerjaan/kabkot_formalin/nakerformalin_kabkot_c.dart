...
class ModelNakerKabkotFormalin {
  ...
  final String formal_n3;
  final String informal_n3;
  final String tahun;

  ModelNakerKabkotFormalin(
      {required this.id,
      required this.wilayah,
      required this.formal_n3,
      required this.informal_n3,
      required this.tahun});
  ...
  factory ModelNakerKabkotFormalin.fromJson(Map<String, dynamic> json) {
    return ModelNakerKabkotFormalin(
      ...
      formal_n3: json['formal_n3'],
      informal_n3: json['informal_n3'],
      tahun: json['tahun'],
    );
  }
}

class NakerkabkotFormalinC extends StatefulWidget {
  const NakerkabkotFormalinC({Key? key}) : super(key: key);

  @override
  State<NakerkabkotFormalinC> createState() => _NakerkabkotFormalinCState();
}

RepositoryNakerKabkotFormalin repositorynaker = RepositoryNakerKabkotFormalin();

class _NakerkabkotFormalinCState extends State<NakerkabkotFormalinC> {
  @override
        ...
        if (snapshot.hasData) {
          ...
          return PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double formal_1 = double.parse(isinaker[index = 0].formal_n3);
              double formal_2 = double.parse(isinaker[index = 1].formal_n3);
              double formal_3 = double.parse(isinaker[index = 2].formal_n3);
              double formal_4 = double.parse(isinaker[index = 3].formal_n3);
              double formal_5 = double.parse(isinaker[index = 4].formal_n3);
              double formal_6 = double.parse(isinaker[index = 5].formal_n3);
              double formal_7 = double.parse(isinaker[index = 6].formal_n3);
              double formal_8 = double.parse(isinaker[index = 7].formal_n3);
              double formal_9 = double.parse(isinaker[index = 8].formal_n3);
              double formal_10 = double.parse(isinaker[index = 9].formal_n3);
              double formal_11 = double.parse(isinaker[index = 10].formal_n3);
              double formal_12 = double.parse(isinaker[index = 11].formal_n3);
              double formal_13 = double.parse(isinaker[index = 12].formal_n3);
              double formal_14 = double.parse(isinaker[index = 13].formal_n3);
              double formal_15 = double.parse(isinaker[index = 14].formal_n3);
              double formal_16 = double.parse(isinaker[index = 15].formal_n3);
              double formal_17 = double.parse(isinaker[index = 16].formal_n3);
              double formal_18 = double.parse(isinaker[index = 17].formal_n3);
              double formal_19 = double.parse(isinaker[index = 18].formal_n3);
              double formal_20 = double.parse(isinaker[index = 19].formal_n3);
              double formal_21 = double.parse(isinaker[index = 20].formal_n3);
              double formal_22 = double.parse(isinaker[index = 21].formal_n3);
              double formal_23 = double.parse(isinaker[index = 22].formal_n3);
              double formal_24 = double.parse(isinaker[index = 23].formal_n3);
              double formal_25 = double.parse(isinaker[index = 24].formal_n3);
              double formal_26 = double.parse(isinaker[index = 25].formal_n3);
              double formal_27 = double.parse(isinaker[index = 26].formal_n3);
              double formal_28 = double.parse(isinaker[index = 27].formal_n3);
              double formal_29 = double.parse(isinaker[index = 28].formal_n3);
              double formal_30 = double.parse(isinaker[index = 29].formal_n3);
              double formal_31 = double.parse(isinaker[index = 30].formal_n3);
              double formal_32 = double.parse(isinaker[index = 31].formal_n3);
              double formal_33 = double.parse(isinaker[index = 32].formal_n3);
              double formal_34 = double.parse(isinaker[index = 33].formal_n3);
              double formal_35 = double.parse(isinaker[index = 34].formal_n3);
              double formal_36 = double.parse(isinaker[index = 35].formal_n3);

              double informal_1 = double.parse(isinaker[index = 0].informal_n3);
              double informal_2 = double.parse(isinaker[index = 1].informal_n3);
              double informal_3 = double.parse(isinaker[index = 2].informal_n3);
              double informal_4 = double.parse(isinaker[index = 3].informal_n3);
              double informal_5 = double.parse(isinaker[index = 4].informal_n3);
              double informal_6 = double.parse(isinaker[index = 5].informal_n3);
              double informal_7 = double.parse(isinaker[index = 6].informal_n3);
              double informal_8 = double.parse(isinaker[index = 7].informal_n3);
              double informal_9 = double.parse(isinaker[index = 8].informal_n3);
              double informal_10 =
                  double.parse(isinaker[index = 9].informal_n3);
              double informal_11 =
                  double.parse(isinaker[index = 10].informal_n3);
              double informal_12 =
                  double.parse(isinaker[index = 11].informal_n3);
              double informal_13 =
                  double.parse(isinaker[index = 12].informal_n3);
              double informal_14 =
                  double.parse(isinaker[index = 13].informal_n3);
              double informal_15 =
                  double.parse(isinaker[index = 14].informal_n3);
              double informal_16 =
                  double.parse(isinaker[index = 15].informal_n3);
              double informal_17 =
                  double.parse(isinaker[index = 16].informal_n3);
              double informal_18 =
                  double.parse(isinaker[index = 17].informal_n3);
              double informal_19 =
                  double.parse(isinaker[index = 18].informal_n3);
              double informal_20 =
                  double.parse(isinaker[index = 19].informal_n3);
              double informal_21 =
                  double.parse(isinaker[index = 20].informal_n3);
              double informal_22 =
                  double.parse(isinaker[index = 21].informal_n3);
              double informal_23 =
                  double.parse(isinaker[index = 22].informal_n3);
              double informal_24 =
                  double.parse(isinaker[index = 23].informal_n3);
              double informal_25 =
                  double.parse(isinaker[index = 24].informal_n3);
              double informal_26 =
                  double.parse(isinaker[index = 25].informal_n3);
              double informal_27 =
                  double.parse(isinaker[index = 26].informal_n3);
              double informal_28 =
                  double.parse(isinaker[index = 27].informal_n3);
              double informal_29 =
                  double.parse(isinaker[index = 28].informal_n3);
              double informal_30 =
                  double.parse(isinaker[index = 29].informal_n3);
              double informal_31 =
                  double.parse(isinaker[index = 30].informal_n3);
              double informal_32 =
                  double.parse(isinaker[index = 31].informal_n3);
              double informal_33 =
                  double.parse(isinaker[index = 32].informal_n3);
              double informal_34 =
                  double.parse(isinaker[index = 33].informal_n3);
              double informal_35 =
                  double.parse(isinaker[index = 34].informal_n3);
              double informal_36 =
                  double.parse(isinaker[index = 35].informal_n3);
