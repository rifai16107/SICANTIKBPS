...
void main() => runApp(const NakerkabkotBakE());

class NakerkabkotBakE extends StatelessWidget {
  const NakerkabkotBakE({super.key});
                      ...
                      return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.sekolah_n5), 0)),
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.urusruta_n5), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.lainnya_n5), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
