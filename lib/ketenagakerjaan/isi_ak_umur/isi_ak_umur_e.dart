        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLk = double.parse(isitenagakerja[index = 0].total);
              ...
              double totalPr = double.parse(isitenagakerja[index = 5].total);

              double bocahLkPr = double.parse(isitenagakerja[index = 10].a);
              double mudaLkPr = double.parse(isitenagakerja[index = 10].b);
              double tuaLkPr = double.parse(isitenagakerja[index = 10].c);
              double totalLkPr = double.parse(isitenagakerja[index = 10].total);
