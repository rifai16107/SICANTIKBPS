        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLk = double.parse(isitenagakerja[index = 1].total);
              ...
              double totalPr = double.parse(isitenagakerja[index = 6].total);

              double bocahLkPr = double.parse(isitenagakerja[index = 11].a);
              double mudaLkPr = double.parse(isitenagakerja[index = 11].b);
              double tuaLkPr = double.parse(isitenagakerja[index = 11].c);
              double totalLkPr = double.parse(isitenagakerja[index = 11].total);
