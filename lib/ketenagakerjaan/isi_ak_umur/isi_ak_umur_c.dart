        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLk = double.parse(isitenagakerja[index = 2].total);
              ...
              double totalPr = double.parse(isitenagakerja[index = 7].total);

              double bocahLkPr = double.parse(isitenagakerja[index = 12].a);
              double mudaLkPr = double.parse(isitenagakerja[index = 12].b);
              double tuaLkPr = double.parse(isitenagakerja[index = 12].c);
              double totalLkPr = double.parse(isitenagakerja[index = 12].total);
