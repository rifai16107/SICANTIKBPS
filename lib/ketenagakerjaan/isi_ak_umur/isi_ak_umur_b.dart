        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLk = double.parse(isitenagakerja[index = 3].total);
              ...
              double totalPr = double.parse(isitenagakerja[index = 8].total);

              double bocahLkPr = double.parse(isitenagakerja[index = 13].a);
              double mudaLkPr = double.parse(isitenagakerja[index = 13].b);
              double tuaLkPr = double.parse(isitenagakerja[index = 13].c);
              double totalLkPr = double.parse(isitenagakerja[index = 13].total);
