...
void main() => runApp(const NakerkabkotKegiatanD());

class NakerkabkotKegiatanD extends StatelessWidget {
  const NakerkabkotKegiatanD({super.key});
...
class Data {
  ...
  final String bekerja_n4;
  final String penganggur_n4;
  ...
  Data(
      ...
      required this.bekerja_n4,
      required this.penganggur_n4,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      bekerja_n4: json['bekerja_n4'],
      penganggur_n4: json['penganggur_n4'],
                      ...
                      return DataRow(
                          ...
                          cells: [
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.bekerja_n4), 0)),
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    double.tryParse(data.penganggur_n4), 0)),
                                style: const TextStyle(
                                  color: Color.fromARGB(255, 17, 17, 17),
                                  fontWeight: FontWeight.normal,
                                  fontSize: 12,
                            ...
                            DataCell(
                              Text(
                                (Format.convertTo(
                                    (double.tryParse(data.bekerja_n4)! +
                                        double.tryParse(data.penganggur_n4)! +
                                        double.tryParse(data.sekolah_n4)! +
                                        double.tryParse(data.urusruta_n4)! +
                                        double.tryParse(data.lainnya_n4)!),
                                    0)),
