        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int akPr = int.parse(isitenagakerja[index = 6].angkatan_kerja);
              int bkjPr = int.parse(isitenagakerja[index = 6].bekerja);
              int pgrPr = int.parse(isitenagakerja[index = 6].pengangguran);
              int bakPr =
                  int.parse(isitenagakerja[index = 6].bkn_angkatan_kerja);
              int sklPr = int.parse(isitenagakerja[index = 6].sekolah);
              int rutaPr = int.parse(isitenagakerja[index = 6].urus_ruta);
              int lainPr = int.parse(isitenagakerja[index = 6].lainnya);
              int jumlahPr = int.parse(isitenagakerja[index = 6].jumlah);

              int akLk = int.parse(isitenagakerja[index = 1].angkatan_kerja);
              int bkjLk = int.parse(isitenagakerja[index = 1].bekerja);
              int pgrLk = int.parse(isitenagakerja[index = 1].pengangguran);
              int bakLk =
                  int.parse(isitenagakerja[index = 1].bkn_angkatan_kerja);
              int sklLk = int.parse(isitenagakerja[index = 1].sekolah);
              int rutaLk = int.parse(isitenagakerja[index = 1].urus_ruta);
              int lainLk = int.parse(isitenagakerja[index = 1].lainnya);
              int jumlahLk = int.parse(isitenagakerja[index = 1].jumlah);

              double JmlBekerja =
                  double.parse(isitenagakerja[index = 6].bekerja) +
                      double.parse(isitenagakerja[index = 1].bekerja);
