        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int akPr = int.parse(isitenagakerja[index = 9].angkatan_kerja);
              int bkjPr = int.parse(isitenagakerja[index = 9].bekerja);
              int pgrPr = int.parse(isitenagakerja[index = 9].pengangguran);
              int bakPr =
                  int.parse(isitenagakerja[index = 9].bkn_angkatan_kerja);
              int sklPr = int.parse(isitenagakerja[index = 9].sekolah);
              int rutaPr = int.parse(isitenagakerja[index = 9].urus_ruta);
              int lainPr = int.parse(isitenagakerja[index = 9].lainnya);
              int jumlahPr = int.parse(isitenagakerja[index = 9].jumlah);

              int akLk = int.parse(isitenagakerja[index = 4].angkatan_kerja);
              int bkjLk = int.parse(isitenagakerja[index = 4].bekerja);
              int pgrLk = int.parse(isitenagakerja[index = 4].pengangguran);
              int bakLk =
                  int.parse(isitenagakerja[index = 4].bkn_angkatan_kerja);
              int sklLk = int.parse(isitenagakerja[index = 4].sekolah);
              int rutaLk = int.parse(isitenagakerja[index = 4].urus_ruta);
              int lainLk = int.parse(isitenagakerja[index = 4].lainnya);
              int jumlahLk = int.parse(isitenagakerja[index = 4].jumlah);

              double JmlBekerja =
                  double.parse(isitenagakerja[index = 9].bekerja) +
                      double.parse(isitenagakerja[index = 4].bekerja);
