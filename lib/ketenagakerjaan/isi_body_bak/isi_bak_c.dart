        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              int akPr = int.parse(isitenagakerja[index = 7].angkatan_kerja);
              int bkjPr = int.parse(isitenagakerja[index = 7].bekerja);
              int pgrPr = int.parse(isitenagakerja[index = 7].pengangguran);
              int bakPr =
                  int.parse(isitenagakerja[index = 7].bkn_angkatan_kerja);
              int sklPr = int.parse(isitenagakerja[index = 7].sekolah);
              int rutaPr = int.parse(isitenagakerja[index = 7].urus_ruta);
              int lainPr = int.parse(isitenagakerja[index = 7].lainnya);
              int jumlahPr = int.parse(isitenagakerja[index = 7].jumlah);

              int akLk = int.parse(isitenagakerja[index = 2].angkatan_kerja);
              int bkjLk = int.parse(isitenagakerja[index = 2].bekerja);
              int pgrLk = int.parse(isitenagakerja[index = 2].pengangguran);
              int bakLk =
                  int.parse(isitenagakerja[index = 2].bkn_angkatan_kerja);
              int sklLk = int.parse(isitenagakerja[index = 2].sekolah);
              int rutaLk = int.parse(isitenagakerja[index = 2].urus_ruta);
              int lainLk = int.parse(isitenagakerja[index = 2].lainnya);
              int jumlahLk = int.parse(isitenagakerja[index = 2].jumlah);

              double JmlBekerja =
                  double.parse(isitenagakerja[index = 7].bekerja) +
                      double.parse(isitenagakerja[index = 2].bekerja);
