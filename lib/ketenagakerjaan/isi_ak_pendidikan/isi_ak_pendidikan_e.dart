        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isipddkpend[index = 0].jumlah);
              ...
              double totalPR = double.parse(isipddkpend[index = 5].jumlah);

              double sdLKPR = double.parse(isipddkpend[index = 10].sd);
              double smpLKPR = double.parse(isipddkpend[index = 10].smp);
              double smaLKPR = double.parse(isipddkpend[index = 10].sma);
              double ptLKPR =
                  double.parse(isipddkpend[index = 10].perguruan_tinggi);
              double totalLKPR = double.parse(isipddkpend[index = 10].jumlah);
