        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isipddkpend[index = 3].jumlah);
              ...
              double totalPR = double.parse(isipddkpend[index = 8].jumlah);

              double sdLKPR = double.parse(isipddkpend[index = 13].sd);
              double smpLKPR = double.parse(isipddkpend[index = 13].smp);
              double smaLKPR = double.parse(isipddkpend[index = 13].sma);
              double ptLKPR =
                  double.parse(isipddkpend[index = 13].perguruan_tinggi);
              double totalLKPR = double.parse(isipddkpend[index = 13].jumlah);
