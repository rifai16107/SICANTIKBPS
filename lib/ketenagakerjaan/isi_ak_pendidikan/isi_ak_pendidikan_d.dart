        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isipddkpend[index = 1].jumlah);
              ...
              double totalPR = double.parse(isipddkpend[index = 6].jumlah);

              double sdLKPR = double.parse(isipddkpend[index = 11].sd);
              double smpLKPR = double.parse(isipddkpend[index = 11].smp);
              double smaLKPR = double.parse(isipddkpend[index = 11].sma);
              double ptLKPR =
                  double.parse(isipddkpend[index = 11].perguruan_tinggi);
              double totalLKPR = double.parse(isipddkpend[index = 11].jumlah);
