                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(lk1.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(lk2.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(lk3.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(lk4.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(lk5.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                ],
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(pr1.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(pr2.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(pr3.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(pr4.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                  Flexible(
                                    ...
                                    child: SizedBox(
                                      height: screenHeight * 0.05,
                                      child: Center(
                                        child: Text(pr5.toStringAsFixed(2)),
                                      ),
                                    ),
                                  ),
                                ],
                                              ...
                                              dataLabelSettings:
                                                  const DataLabelSettings(
                                                      ...
                                                      textStyle: TextStyle(
                                                          fontSize: 10)),
                                              name: 'TPT Laki-Laki',
                                              color: const Color.fromARGB(255, 206, 196, 56),
                                            ),
                                            ColumnSeries<_ChartData, String>(
                                              dataSource: data,
                                              xValueMapper:
                                              ...
                                              dataLabelSettings:
                                                  const DataLabelSettings(
                                                      ...
                                                      textStyle: TextStyle(
                                                          fontSize: 10)),
                                              name: 'TPT Lk+Pr',
                                              color: const Color.fromARGB(255, 147, 138, 236),
                                            ),
                                          ]),
                                    )  
                                      ],
