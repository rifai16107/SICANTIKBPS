        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isiaklpu[index = 1].jumlah);

              double taniPR = double.parse(isiaklpu[index = 6].pertanian);
              double industriPR = double.parse(isiaklpu[index = 6].industri);
              double jasaPR = double.parse(isiaklpu[index = 6].jasa);
              double totalPR = double.parse(isiaklpu[index = 6].jumlah);

              double taniLKPR = double.parse(isiaklpu[index = 11].pertanian);
              double industriLKPR = double.parse(isiaklpu[index = 11].industri);
              double jasaLKPR = double.parse(isiaklpu[index = 11].jasa);
              double totalLKPR = double.parse(isiaklpu[index = 11].jumlah);
