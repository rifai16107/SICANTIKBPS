        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              double totalLK = double.parse(isiaklpu[index = 0].jumlah);

              double taniPR = double.parse(isiaklpu[index = 5].pertanian);
              double industriPR = double.parse(isiaklpu[index = 5].industri);
              double jasaPR = double.parse(isiaklpu[index = 5].jasa);
              double totalPR = double.parse(isiaklpu[index = 5].jumlah);

              double taniLKPR = double.parse(isiaklpu[index = 10].pertanian);
              double industriLKPR = double.parse(isiaklpu[index = 10].industri);
              double jasaLKPR = double.parse(isiaklpu[index = 10].jasa);
              double totalLKPR = double.parse(isiaklpu[index = 10].jumlah);
