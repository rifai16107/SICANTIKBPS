...
import 'package:bps_cilacap/sensus_data/body_sensus_milenial.dart';
import 'package:flutter/material.dart';

class SensusMilenial extends StatefulWidget {
  const SensusMilenial({super.key});

  @override
  State<SensusMilenial> createState() => _SensusMilenialState();
}
        ...
        child: Column(
          children: [
            Flexible(
              child: SizedBox(
                height: screenHeight,
                child: const BodySensusMilenial(),
              ),
            ),
          ],
        ),
