...
import 'package:bps_cilacap/sensus_data/body_sensus_dominan_spk.dart';
import 'package:flutter/material.dart';

class SensusDominanSpk extends StatefulWidget {
  const SensusDominanSpk({super.key});

  @override
  State<SensusDominanSpk> createState() => _SensusDominanSpkState();
}

class _SensusDominanSpkState extends State<SensusDominanSpk> {
  @override
        ...
        child: Column(
          children: [
            Flexible(
              child: SizedBox(
                height: screenHeight,
                child: const BodySensusDominanSpk(),
              ),
            ),
          ],
        ),
